...
//        typedef sofa::component::constraint::lagrangian::model::BilateralInteractionLagrangianConstraint< DataTypes > MouseConstraint;
...
protected:
    ...
    sofa::component::constraint::lagrangian::model::BilateralInteractionLagrangianConstraint<defaulttype::Vec3Types>::SPtr m_constraint;
