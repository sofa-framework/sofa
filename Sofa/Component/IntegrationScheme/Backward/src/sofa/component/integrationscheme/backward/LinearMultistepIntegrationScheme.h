...
class SOFA_COMPONENT_INTEGRATIONSCHEME_BACKWARD_API LinearMultistepIntegrationScheme :
    public sofa::simulation::integrationscheme::VelocityBasedImplicitIntegrationScheme
{
public:
    SOFA_CLASS(LinearMultistepIntegrationScheme, sofa::simulation::integrationscheme::VelocityBasedImplicitIntegrationScheme);
