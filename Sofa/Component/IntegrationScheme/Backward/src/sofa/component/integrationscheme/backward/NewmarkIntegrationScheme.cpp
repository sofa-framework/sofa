...
void NewmarkIntegrationScheme::computeCurrentPositionIntegrationError(sofa::simulation::common::VectorOperations & vop, sofa::core::MultiVecDerivId& result, const sofa::core::MultiVecCoordId& position, const sofa::core::MultiVecDerivId& velocity, const sofa::core::MultiVecDerivId& acceleration)
{
    SOFA_UNUSED(velocity);
...
void NewmarkIntegrationScheme::computeCurrentVelocityIntegrationError(sofa::simulation::common::VectorOperations & vop, const sofa::core::MultiVecDerivId& result, const sofa::core::MultiVecDerivId& velocity, const sofa::core::MultiVecDerivId& acceleration)
{
    sofa::core::behavior::MultiVecDeriv res(&vop, result );
