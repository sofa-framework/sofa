...
struct EulerImplicitDynamic_test : public component::integrationscheme::testing::IntegrationSchemeSpringTest
{
    ...
    void createScene(double K, double m, double l0, double rm = 0, double rk=0)
    {
        ...
        simpleapi::createObject(m_si.root, "EulerImplicitIntegrationScheme", {
