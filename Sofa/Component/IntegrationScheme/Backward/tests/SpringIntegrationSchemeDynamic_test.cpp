...
struct SpringIntegrationSchemeDynamic_test : public NumericTest<typename _DataTypes::Real>
{
    ...
    void loadScene(std::string sceneName)
    {
        ...
        const std::string fileName = std::string(SOFACOMPONENTINTEGRATIONSCHEMEBACKWARD_TEST_SCENES_DIR) + "/" + sceneName;
...
TYPED_TEST_SUITE(SpringIntegrationSchemeDynamic_test, DataTypes);

// Test case EulerImplicit Integration Scheme
TYPED_TEST( SpringIntegrationSchemeDynamic_test , EulerImplicitIntegrationSchemeDynamicTest )
{
