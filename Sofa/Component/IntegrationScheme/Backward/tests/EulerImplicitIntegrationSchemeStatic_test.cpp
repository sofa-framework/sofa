...
#include <sofa/component/integrationscheme/testing/EigenTestUtilities.h>
...
struct EulerImplicit_test_2_particles_to_equilibrium : public BaseSimulationTest, NumericTest<SReal>
{
    EulerImplicit_test_2_particles_to_equilibrium()
    {
        ...
        simpleapi::createObject(root, "EulerImplicitIntegrationScheme", {});
        ...
        x0 = component::integrationscheme::testing::getVector( root, core::vec_id::write_access::position ); //cerr<<"EulerImplicit_test, initial positions : " << x0.transpose() << endl;
        v0 = component::integrationscheme::testing::getVector( root, core::vec_id::write_access::velocity );
        ...
        do {
            ...
            x1 = component::integrationscheme::testing::getVector( root, core::vec_id::read_access::position ); //cerr<<"EulerImplicit_test, new positions : " << x1.transpose() << endl;
            v1 = component::integrationscheme::testing::getVector( root, core::vec_id::read_access::velocity );
