...
#include <sofa/component/integrationscheme/testing/MassSpringSystemCreation.h>

namespace sofa::component::integrationscheme::testing
{

struct IntegrationSchemeSpringTest : public BaseSimulationTest
{
    SceneInstance m_si{};
    ...
    inline void prepareScene(double K, double m, double l0)
    {
        ...
        simpleapi::createObject(m_si.root, "CGLinearSolver", {
            { "iterations", simpleapi::str(10)},
            { "tolerance", simpleapi::str(0)},
            { "threshold", simpleapi::str(0)},
            });
