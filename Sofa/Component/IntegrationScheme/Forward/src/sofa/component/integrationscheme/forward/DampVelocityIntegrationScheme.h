...
*/
class SOFA_COMPONENT_INTEGRATIONSCHEME_FORWARD_API DampVelocityIntegrationScheme : public simulation::integrationscheme::ExplicitIntegrationScheme
{
public:
    SOFA_CLASS(DampVelocityIntegrationScheme, simulation::integrationscheme::ExplicitIntegrationScheme);
