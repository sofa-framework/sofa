 ...
 *
 */
class SOFA_COMPONENT_INTEGRATIONSCHEME_FORWARD_API CentralDifferenceIntegrationScheme : public simulation::integrationscheme::ExplicitIntegrationScheme
{
public:
    SOFA_CLASS(CentralDifferenceIntegrationScheme, simulation::integrationscheme::ExplicitIntegrationScheme);
protected:
