...
class SOFA_COMPONENT_INTEGRATIONSCHEME_FORWARD_API RungeKutta4IntegrationScheme : public simulation::integrationscheme::ExplicitIntegrationScheme
{
public:
    SOFA_CLASS(RungeKutta4IntegrationScheme, simulation::integrationscheme::ExplicitIntegrationScheme);
