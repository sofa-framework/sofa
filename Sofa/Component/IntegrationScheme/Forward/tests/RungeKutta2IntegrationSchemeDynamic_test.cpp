...
struct RungeKutta2IntegrationSchemeDynamic_test : public component::integrationscheme::testing::IntegrationSchemeSpringTest
{
    ...
    void createScene(double K, double m, double l0)
    {
        ...
        simpleapi::createObject(m_si.root, "RungeKutta2IntegrationScheme", {
            { }
        });
...
TYPED_TEST_SUITE(RungeKutta2IntegrationSchemeDynamic_test, DataTypes);

// Test case: h=0.1 k=100 m =10 rm=0.1 rk=0.1
TYPED_TEST( RungeKutta2IntegrationSchemeDynamic_test , rungeKutta2ExplicitSolverDynamicTest_medium_dt)
{
...
TYPED_TEST( RungeKutta2IntegrationSchemeDynamic_test , rungeKutta2ExplicitSolverDynamicTest_high_dt)
{
...
TYPED_TEST( RungeKutta2IntegrationSchemeDynamic_test , rungeKutta2ExplicitSolverDynamicTest_small_dt)
{
