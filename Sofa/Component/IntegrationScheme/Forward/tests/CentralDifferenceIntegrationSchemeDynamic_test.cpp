...
#include <sofa/component/integrationscheme/testing/IntegrationSchemeSpringTest.h>
...
struct CentralDifferenceIntegrationSchemeDynamic_test : public component::integrationscheme::testing::IntegrationSchemeSpringTest
{
    ...
    void createScene(double K, double m, double l0,double rm)
    {
        ...
        simpleapi::createObject(m_si.root, "CentralDifferenceIntegrationScheme", {
...
TYPED_TEST_SUITE(CentralDifferenceIntegrationSchemeDynamic_test, DataTypes);

// Test case: h=0.01 k=100 m =10 rm=0.1 rk=0.1
TYPED_TEST( CentralDifferenceIntegrationSchemeDynamic_test , centralDifferenceExplicitSolverDynamicTest_medium_dt_without_damping)
{
...
TYPED_TEST( CentralDifferenceIntegrationSchemeDynamic_test , rungeKutta2ExplicitSolverDynamicTest_high_dt_with_damping)
{
...
TYPED_TEST( CentralDifferenceIntegrationSchemeDynamic_test , rungeKutta2ExplicitSolverDynamicTest_small_dt_with_damping)
{
