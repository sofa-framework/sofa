...
struct EulerExplicitDynamic_test : public component::integrationscheme::testing::IntegrationSchemeSpringTest
{
    ...
    void createScene(double K, double m, double l0)
    {
        ...
        simpleapi::createObject(m_si.root, "EulerExplicitIntegrationScheme", {
            { }
        });
    }
