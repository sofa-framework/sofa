        ...
        sofa::type::Vec<6,SReal> includedBox)
{
    ...
    const component::odesolver::backward::EulerImplicitIntegrationScheme::SPtr solver = modeling::addNew<component::odesolver::backward::EulerImplicitIntegrationScheme>(SquareNode,"EulerImplicitIntegrationScheme");
