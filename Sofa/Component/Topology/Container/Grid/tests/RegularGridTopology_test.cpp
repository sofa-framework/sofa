...
bool RegularGridTopology_test::regularGridCreation()
{
    ...
    EXPECT_EQ(regGrid3->d_p0.getValue(), Vec3(0.0f, 0.0f, 0.0f));
    ...
    EXPECT_EQ(regGrid2->d_p0.getValue(), Vec3(0.0f, 0.0f, 0.0f));
    ...
    EXPECT_EQ(regGrid1->d_p0.getValue(), Vec3(0.0f, 0.0f, 0.0f));
