...
MeshTopology::MeshTopology()
    : seqPoints(initData("position","List of point positions"))
    , seqEdges(initData("edges","List of edge indices"))
    , seqTriangles(initData("triangles","List of triangle indices"))
    , seqQuads(initData("quads","List of quad indices"))
    , seqTetrahedra(initData("tetrahedra","List of tetrahedron indices"))
    , seqHexahedra(initData("hexahedra","List of hexahedron indices"))
    , seqUVs(initData("uv","List of uv coordinates"))
    , nbPoints(0)
    , validTetrahedra(false), validHexahedra(false)
    , revision(0)
    , _drawEdges(initData( false, "drawEdges","if true, draw the topology Edges"))
    , _drawTriangles(initData( false, "drawTriangles","if true, draw the topology Triangles"))
    , _drawQuads(initData( false, "drawQuads","if true, draw the topology Quads"))
    , _drawTetra(initData( false, "drawTetrahedra","if true, draw the topology Tetrahedra"))
    , _drawHexa(initData( false, "drawHexahedra","if true, draw the topology hexahedra"))
{
