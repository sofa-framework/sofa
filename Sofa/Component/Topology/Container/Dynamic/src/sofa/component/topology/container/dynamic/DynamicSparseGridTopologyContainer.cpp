...
DynamicSparseGridTopologyContainer::DynamicSparseGridTopologyContainer()
    ...
    , resolution ( initData( Vec3i ( 0, 0, 0 ), "resolution", "voxel grid resolution" ) )
    , valuesIndexedInRegularGrid( initData( sofa::type::vector<unsigned char>(), "valuesIndexedInRegularGrid", "values indexed in the Regular Grid" ) )
    , valuesIndexedInTopology( initData( "valuesIndexedInTopology", "values indexed in the topology"))
    , idxInRegularGrid( initData( sofa::type::vector<BaseMeshTopology::HexaID>(), "idxInRegularGrid", "indices in the Regular Grid" ) )
    , idInRegularGrid2IndexInTopo( initData( std::map< unsigned int, BaseMeshTopology::HexaID> (), "idInRegularGrid2IndexInTopo", "map between id in the Regular Grid and index in the topology" ) )
    , voxelSize( initData( type::Vector3(1,1,1), "voxelSize", "Size of the Voxels"))
{
