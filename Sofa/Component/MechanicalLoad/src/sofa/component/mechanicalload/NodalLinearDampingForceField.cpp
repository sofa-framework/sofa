...
void registerNodalLinearDampingForceField(sofa::core::ObjectFactory* factory)
{
    factory->registerObjects(core::ObjectRegistrationData("Linear damping force applied on the degrees of freedom.")
