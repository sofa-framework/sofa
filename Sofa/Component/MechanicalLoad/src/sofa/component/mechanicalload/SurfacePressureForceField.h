...
public:
    ...
    Data<Real> m_pressureLowerBound; ///< Pressure lower bound force per unit area (active in pulse mode)
    Data<Real> m_pressureSpeed; ///< Continuous pressure application in Pascal per second. Only active in pulse mode
    Data<bool> m_volumeConservationMode; ///< Pressure variation follow the inverse of the volume variation
    Data<bool> m_useTangentStiffness; ///< Whether (non-symmetric) stiffness matrix should be used
    Data<Real> m_defaultVolume; ///< Default Volume
    Data<Deriv> m_mainDirection; ///< Main direction for pressure application
