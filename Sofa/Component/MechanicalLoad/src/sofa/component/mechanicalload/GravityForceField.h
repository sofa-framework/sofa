...
public:
    ...
    /// Check the norm of the gravity
    void checkGravityNorm();

    /// Update gravitational acceleration from the gravity defined in root node
    void setGravityFromRootNode();

protected:
    GravityForceField();
    bool m_isNormNull = false;
};
