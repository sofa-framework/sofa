...
SOFA_HEADER_DEPRECATED("v26.06", "v27.06", "sofa/component/integrationschemes/backward/EulerImplicitIntegrationScheme.h")
...
using EulerImplicitSolver SOFA_ATTRIBUTE_DEPRECATED("v26.06", "v27.06",
    ...
    "sofa::component::integrationschemes::backward::EulerImplicitIntegrationScheme")
    = sofa::component::integrationschemes::backward::EulerImplicitIntegrationScheme;
} // namespace sofa::component::odesolver::backward
