 ...
 */
class SOFA_COMPONENT_ODESOLVER_FORWARD_API EulerExplicitSolver : public sofa::core::behavior::IntegrationScheme
{
public:
    SOFA_CLASS(EulerExplicitSolver, sofa::core::behavior::IntegrationScheme);
