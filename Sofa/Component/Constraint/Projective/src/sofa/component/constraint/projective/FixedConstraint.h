...
extern template class SOFA_COMPONENT_CONSTRAINT_PROJECTIVE_API FixedConstraint<defaulttype::Vec6Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_PROJECTIVE_API FixedConstraint<defaulttype::Rigid3Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_PROJECTIVE_API FixedConstraint<defaulttype::Rigid2Types>;
