...
HermiteSplineConstraint<DataTypes>::HermiteSplineConstraint(core::behavior::MechanicalState<DataTypes>* mstate)
    ...
    , m_tBegin(initData("BeginTime","Begin Time of the motion") )
    , m_tEnd(initData("EndTime","End Time of the motion") )
    , m_x0(initData("X0","first control point") )
    , m_dx0(initData("dX0","first control tangente") )
    , m_x1(initData("X1","second control point") )
    , m_dx1(initData("dX1","sceond control tangente") )
    , m_sx0(initData("SX0","first interpolation vector") )
    , m_sx1(initData("SX1","second interpolation vector") )
