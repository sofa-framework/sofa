...
extern template class SOFA_COMPONENT_CONSTRAINT_PROJECTIVE_API AttachConstraint<defaulttype::Rigid3Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_PROJECTIVE_API AttachConstraint<defaulttype::Rigid2Types>;
#endif
