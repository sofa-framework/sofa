...
PartialLinearMovementProjectiveConstraint<DataTypes>::PartialLinearMovementProjectiveConstraint()
    ...
    , d_linearMovementBetweenNodesInIndices(initData(&d_linearMovementBetweenNodesInIndices, (bool)false, "d_linearMovementBetweenNodesInIndices", "Take into account the linear movement between the constrained points"))
    , d_mainIndice(initData(&d_mainIndice, "d_mainIndice", "The main indice node in the list of constrained nodes, it defines how to apply the linear movement between this constrained nodes "))
    , d_minDepIndice(initData(&d_minDepIndice, "d_minDepIndice", "The indice node in the list of constrained nodes, which is imposed the minimum displacment "))
    , d_maxDepIndice(initData(&d_maxDepIndice, "d_maxDepIndice", "The indice node in the list of constrained nodes, which is imposed the maximum displacment "))
    ...
    , d_movedDirections(initData(&d_movedDirections, "d_movedDirections", "for each direction, 1 if moved, 0 if free") )
