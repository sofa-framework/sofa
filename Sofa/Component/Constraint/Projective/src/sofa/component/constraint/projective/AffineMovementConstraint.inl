...
AffineMovementConstraint<DataTypes>::AffineMovementConstraint()
    ...
    , m_meshIndices( initData("meshIndices","Indices of the mesh") )
    , m_indices( initData("indices","Indices of the constrained points") )
    , m_beginConstraintTime( initData("beginConstraintTime","Begin time of the bilinear constraint") )
    , m_endConstraintTime( initData("endConstraintTime","End time of the bilinear constraint") )
    , m_rotation(  initData("rotation","rotation applied to border points") )
    , m_quaternion( initData("quaternion","quaternion applied to border points") )
    , m_translation(  initData("translation","translation applied to border points") )
    , m_drawConstrainedPoints(  initData("drawConstrainedPoints","draw constrained points") )
