...
//TODO(Paul) C++20: add concept for ContactParams
...
{
public:
    SOFA_CLASS(SOFA_TEMPLATE2(BaseContactLagrangianConstraint,DataTypes,ContactParams), SOFA_TEMPLATE(core::behavior::PairInteractionConstraint,DataTypes));
...
protected:
    ...
    BaseContactLagrangianConstraint(MechanicalState* object1=nullptr, MechanicalState* object2=nullptr);
    virtual ~BaseContactLagrangianConstraint();
...
public:
    ...
    void addContact(const ContactParams& parameters, Deriv norm, Coord P, Coord Q, Real contactDistance, int m1, int m2, Coord Pfree, Coord Qfree, long id=0, PersistentID localid=0);
    void addContact(const ContactParams& parameters, Deriv norm, Coord P, Coord Q, Real contactDistance, int m1, int m2, long id=0, PersistentID localid=0);
    void addContact(const ContactParams& parameters, Deriv norm, Real contactDistance, int m1, int m2, long id=0, PersistentID localid=0);
