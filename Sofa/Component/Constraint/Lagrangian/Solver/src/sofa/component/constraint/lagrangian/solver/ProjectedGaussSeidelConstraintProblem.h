...
{
class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_SOLVER_API ProjectedGaussSeidelConstraintProblem : public BuiltConstraintProblem
{
public:
    SOFA_CLASS(ProjectedGaussSeidelConstraintProblem, BuiltConstraintProblem);
