...
GenericConstraintSolver::GenericConstraintSolver()
    ...
    , schemeCorrection( initData( false, "schemeCorrection", "Apply new scheme where compliance is progressively corrected"))
    , unbuilt(initData( false, "unbuilt", "Compliance is not fully built"))
