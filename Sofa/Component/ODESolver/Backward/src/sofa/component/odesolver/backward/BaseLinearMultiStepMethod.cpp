...
struct ResidualFunction : newton_raphson::BaseNonLinearFunction
{
    ...
    ResidualFunction& setOrder(std::size_t v)
    {
        order = v;
        return *this;
    }

    ResidualFunction& setACoef(const sofa::type::vector<SReal>& v)
    {
        a_coef = v;
        return *this;
    }

    ResidualFunction& setBCoef(const sofa::type::vector<SReal>& v)
    {
        b_coef = v;
        return *this;
    }
    ...
    ResidualFunction& setPosition(const sofa::type::vector<core::MultiVecCoordId>& v)
    {
        position = v;
        return *this;
    }

    ResidualFunction& setVelocity(const sofa::type::vector<core::MultiVecDerivId>& v)
    {
        velocity = v;
        return *this;
    }

    ResidualFunction& setForce(const sofa::type::vector<core::MultiVecDerivId>& v)
    {
        force = v;
        return *this;
    }
