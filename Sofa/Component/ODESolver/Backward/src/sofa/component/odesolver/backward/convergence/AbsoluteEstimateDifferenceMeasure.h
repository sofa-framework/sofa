...
class AbsoluteEstimateDifferenceMeasure : public NewtonRaphsonConvergenceMeasureWithSquaredParameter
{
public:
    explicit AbsoluteEstimateDifferenceMeasure(SReal absoluteEstimateDifferenceThreshold)
        : NewtonRaphsonConvergenceMeasureWithSquaredParameter(absoluteEstimateDifferenceThreshold)
    {}
    
    bool hasConverged() const override
    {
        return squaredAbsoluteDifference < squaredParam;
    }
    ...
    NewtonStatus status() const override
    {
        ...
        return convergedAbsoluteEstimateDifference;
    }
    ...
    {
        return "Absolute successive estimate difference";
    }
