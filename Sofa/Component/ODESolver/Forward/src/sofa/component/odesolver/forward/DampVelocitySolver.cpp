...
DampVelocitySolver::DampVelocitySolver()
    : rate( initData( 0.99, "rate", "Factor used to reduce the velocities. Typically between 0 and 1.") )
    , threshold( initData( 0.0, "threshold", "Threshold under which the velocities are canceled.") )
{}
