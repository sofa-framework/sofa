...
class AugmentedLagrangianResponse : public core::collision::Contact, public ContactIdentifier
{
public:
    SOFA_CLASS(SOFA_TEMPLATE3(AugmentedLagrangianResponse, TCollisionModel1, TCollisionModel2, ResponseDataTypes), core::collision::Contact);
...
protected:
    ...
    constraint::lagrangian::model::AugmentedLagrangianConstraint<sofa::defaulttype::Vec3Types>::SPtr m_constraint;
    ...
    ~AugmentedLagrangianResponse() override;
public:
