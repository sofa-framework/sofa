...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes  >
void AugmentedLagrangianResponse<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::cleanup()
{
    if (m_constraint)
    {
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes  >
void AugmentedLagrangianResponse<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::setDetectionOutputs(OutputVector* o)
{
    ...
    {
        msg_error() << "Disabled AugmentedLagrangianResponse with " << (outputs.size()) << " collision points.";
        return;
    }
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes  >
void AugmentedLagrangianResponse<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::activateMappers()
{
    if (!m_constraint)
    {
        ...
        m_constraint = sofa::core::objectmodel::New<constraint::lagrangian::model::AugmentedLagrangianConstraint<defaulttype::Vec3Types> >(mmodel1, mmodel2);
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes  >
void AugmentedLagrangianResponse<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::createResponse(core::objectmodel::BaseContext* group)
{

    activateMappers();
    const double mu_ = this->d_mu.getValue();
    const double epsilon_ = this->d_epsilon.getValue();
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes  >
void AugmentedLagrangianResponse<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::removeResponse()
{
    if (m_constraint)
    {
        mapper1.resize(0);
...
template < class TCollisionModel1, class TCollisionModel2, class ResponseDataTypes  >
void AugmentedLagrangianResponse<TCollisionModel1,TCollisionModel2,ResponseDataTypes>::setInteractionTags(MechanicalState1* mstate1, MechanicalState2* mstate2)
{
