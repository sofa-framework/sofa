...
#ifndef SOFA_COMPONENT_LINEARSOLVER_DIRECT_EIGENSIMPLICIALLLT_CPP
    extern template class SOFA_COMPONENT_LINEARSOLVER_DIRECT_API EigenSimplicialLLT< SReal >;
    extern template class SOFA_COMPONENT_LINEARSOLVER_DIRECT_API EigenSimplicialLLT< sofa::type::Mat<3,3,SReal> >;
#endif
