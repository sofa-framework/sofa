...
{
    factory->registerObjects(core::ObjectRegistrationData("Linear solver based on a diagonal matrix (i.e. Jacobi preconditioner).")
        .add< JacobiPreconditioner<DiagonalMatrix<SReal>, FullVector<SReal> > >());
}
