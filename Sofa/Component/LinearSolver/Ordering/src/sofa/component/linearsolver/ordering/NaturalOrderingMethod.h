...
class SOFA_COMPONENT_LINEARSOLVER_ORDERING_API NaturalOrderingMethod : public core::behavior::BaseOrderingMethod
{
public:
    SOFA_CLASS(NaturalOrderingMethod, core::behavior::BaseOrderingMethod);
