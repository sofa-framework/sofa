...
BoxROI<DataTypes>::BoxROI()
    : d_alignedBoxes( initData( "box", "List of boxes defined by xmin,ymin,zmin, xmax,ymax,zmax") )
    , d_orientedBoxes( initData( "orientedBox", "List of boxes defined by 3 points (p0, p1, p2) and a depth distance \n"
    ...
    , d_X0( initData( "position", "Rest position coordinates of the degrees of freedom. \n"
    ...
    , d_edges(initData( "edges", "Edge Topology") )
    , d_triangles(initData( "triangles", "Triangle Topology") )
    , d_tetrahedra(initData( "tetrahedra", "Tetrahedron Topology") )
    , d_hexahedra(initData( "hexahedra", "Hexahedron Topology") )
    , d_quad(initData( "quad", "Quad Topology") )
    , d_computeEdges( initData( true,"computeEdges","If true, will compute edge list and index list inside the ROI. (default = true)") )
    , d_computeTriangles( initData( true,"computeTriangles","If true, will compute triangle list and index list inside the ROI. (default = true)") )
    , d_computeTetrahedra( initData( true,"computeTetrahedra","If true, will compute tetrahedra list and index list inside the ROI. (default = true)") )
    , d_computeHexahedra( initData( true,"computeHexahedra","If true, will compute hexahedra list and index list inside the ROI. (default = true)") )
    , d_computeQuad( initData( true,"computeQuad","If true, will compute quad list and index list inside the ROI. (default = true)") )
    , d_strict( initData( true,"strict","If true, an element is inside the box iif all of its nodes are inside. If False, only the center point of the element is checked. (default = true)") )
    , d_indices( initData("indices","Indices of the points contained in the ROI") )
    , d_edgeIndices( initData("edgeIndices","Indices of the edges contained in the ROI") )
    , d_triangleIndices( initData("triangleIndices","Indices of the triangles contained in the ROI") )
    , d_tetrahedronIndices( initData("tetrahedronIndices","Indices of the tetrahedra contained in the ROI") )
    , d_hexahedronIndices( initData("hexahedronIndices","Indices of the hexahedra contained in the ROI") )
    , d_quadIndices( initData("quadIndices","Indices of the quad contained in the ROI") )
    , d_pointsInROI( initData("pointsInROI","Points contained in the ROI") )
    , d_edgesInROI( initData("edgesInROI","Edges contained in the ROI") )
    , d_trianglesInROI( initData("trianglesInROI","Triangles contained in the ROI") )
    , d_tetrahedraInROI( initData("tetrahedraInROI","Tetrahedra contained in the ROI") )
    , d_hexahedraInROI( initData("hexahedraInROI","Hexahedra contained in the ROI") )
    , d_quadInROI( initData("quadInROI","Quad contained in the ROI") )
    , d_nbIndices( initData("nbIndices", "Number of selected indices") )
    , d_drawBoxes( initData(false,"drawBoxes","Draw Boxes. (default = false)") )
    , d_drawPoints( initData(false,"drawPoints","Draw Points. (default = false)") )
    , d_drawEdges( initData(false,"drawEdges","Draw Edges. (default = false)") )
    , d_drawTriangles( initData(false,"drawTriangles","Draw Triangles. (default = false)") )
    , d_drawTetrahedra( initData(false,"drawTetrahedra","Draw Tetrahedra. (default = false)") )
    , d_drawHexahedra( initData(false,"drawHexahedra","Draw Tetrahedra. (default = false)") )
    , d_drawQuads( initData(false,"drawQuads","Draw Quads. (default = false)") )
    , d_drawSize( initData(1.0,"drawSize","rendering size for box and topological elements") )
    , d_doUpdate( initData((bool)true,"doUpdate","If true, updates the selection at the beginning of simulation steps. (default = true)") )
