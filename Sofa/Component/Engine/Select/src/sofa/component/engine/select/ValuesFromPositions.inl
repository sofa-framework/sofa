...
ValuesFromPositions<DataTypes>::ValuesFromPositions()
    : f_inputValues( initData( "inputValues", "Input values") )
    , f_direction( initData( CPos(0,1,0), "direction", "Direction along which the values are interpolated") )
    ...
    , f_values( initData("values","Values of the points contained in the ROI") )
    , f_edgeValues( initData("edgeValues","Values of the edges contained in the ROI") )
    , f_triangleValues( initData("triangleValues","Values of the triangles contained in the ROI") )
    , f_tetrahedronValues( initData("tetrahedronValues","Values of the tetrahedra contained in the ROI") )
    , f_pointVectors( initData("pointVectors","Vectors of the points contained in the ROI") )
    , f_edgeVectors( initData("edgeVectors","Vectors of the edges contained in the ROI") )
    , f_triangleVectors( initData("triangleVectors","Vectors of the triangles contained in the ROI") )
    , f_tetrahedronVectors( initData("tetrahedronVectors","Vectors of the tetrahedra contained in the ROI") )
    , p_fieldType(initData( "fieldType", "field type of output elements"))
    , p_drawVectors(initData( false, "drawVectors", "draw vectors line"))
    , p_vectorLength (initData( (float)10, "drawVectorLength", "vector length visualisation. "))
{
