...
SphereROI<DataTypes>::SphereROI()
    ...
    , direction( initData( "direction", "Edge direction(if edgeAngle > 0)") )
    , normal( initData( "normal", "Normal direction of the triangles (if triAngle > 0)") )
    , edgeAngle( initData( (Real)0, "edgeAngle", "Max angle between the direction of the selected edges and the specified direction") )
    , triAngle( initData( (Real)0, "triAngle", "Max angle between the normal of the selected triangle and the specified normal direction") )
    , f_X0( initData( "position", "Rest position coordinates of the degrees of freedom") )
    , f_edges(initData( "edges", "Edge Topology") )
    , f_triangles(initData( "triangles", "Triangle Topology") )
    , f_quads(initData( "quads", "Quads Topology") )
    , f_tetrahedra(initData( "tetrahedra", "Tetrahedron Topology") )
    , f_computeEdges( initData( true,"computeEdges","If true, will compute edge list and index list inside the ROI.") )
    , f_computeTriangles( initData( true,"computeTriangles","If true, will compute triangle list and index list inside the ROI.") )
    , f_computeQuads( initData( true,"computeQuads","If true, will compute quad list and index list inside the ROI.") )
    , f_computeTetrahedra( initData( true,"computeTetrahedra","If true, will compute tetrahedra list and index list inside the ROI.") )
    , f_indices( initData("indices","Indices of the points contained in the ROI") )
    , f_edgeIndices( initData("edgeIndices","Indices of the edges contained in the ROI") )
    , f_triangleIndices( initData("triangleIndices","Indices of the triangles contained in the ROI") )
    , f_quadIndices( initData("quadIndices","Indices of the quads contained in the ROI") )
    , f_tetrahedronIndices( initData("tetrahedronIndices","Indices of the tetrahedra contained in the ROI") )
    , f_pointsInROI( initData("pointsInROI","Points contained in the ROI") )
    , f_edgesInROI( initData("edgesInROI","Edges contained in the ROI") )
    , f_trianglesInROI( initData("trianglesInROI","Triangles contained in the ROI") )
    , f_quadsInROI( initData("quadsInROI","Quads contained in the ROI") )
    , f_tetrahedraInROI( initData("tetrahedraInROI","Tetrahedra contained in the ROI") )
    ...
    , p_drawEdges( initData(false,"drawEdges","Draw Edges") )
    , p_drawTriangles( initData(false,"drawTriangles","Draw Triangles") )
    , p_drawQuads( initData(false,"drawQuads","Draw Quads") )
    , p_drawTetrahedra( initData(false,"drawTetrahedra","Draw Tetrahedra") )
    , _drawSize( initData(1.0f,"drawSize","rendering size for box and topological elements") )
{
