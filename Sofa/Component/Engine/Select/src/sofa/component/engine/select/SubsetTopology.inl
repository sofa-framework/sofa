...
SubsetTopology<DataTypes>::SubsetTopology()
    : boxes( initData( "box", "Box defined by xmin,ymin,zmin, xmax,ymax,zmax") )
    ...
    , f_quads(initData( "quads", "Quad Topology") )
    , f_tetrahedra(initData( "tetrahedra", "Tetrahedron Topology") )
    , f_hexahedra(initData( "hexahedra", "Hexahedron Topology") )
    , d_tetrahedraInput( initData("tetrahedraInput","Indices of the tetrahedra to keep") )
    ...
    , f_hexahedronIndices( initData("hexahedronIndices","Indices of the hexahedra contained in the ROI") )
    , f_pointsInROI( initData("pointsInROI","Points contained in the ROI") )
    , f_pointsOutROI( initData("pointsOutROI","Points out of the ROI") )
    , f_edgesInROI( initData("edgesInROI","Edges contained in the ROI") )
    , f_edgesOutROI( initData("edgesOutROI","Edges out of the ROI") )
    , f_trianglesInROI( initData("trianglesInROI","Triangles contained in the ROI") )
    , f_trianglesOutROI( initData("trianglesOutROI","Triangles out of the ROI") )
    , f_quadsInROI( initData("quadsInROI","Quads contained in the ROI") )
    , f_quadsOutROI( initData("quadsOutROI","Quads out of the ROI") )
    , f_tetrahedraInROI( initData("tetrahedraInROI","Tetrahedra contained in the ROI") )
    , f_tetrahedraOutROI( initData("tetrahedraOutROI","Tetrahedra out of the ROI") )
    , f_hexahedraInROI( initData("hexahedraInROI","Hexahedra contained in the ROI") )
    , f_hexahedraOutROI( initData("hexahedraOutROI","Hexahedra out of the ROI") )
    , f_nbrborder( initData((unsigned int)0,"nbrborder","If localIndices option is activated, will give the number of vertices on the border of the ROI (being the n first points of each output Topology). ") )
    , p_localIndices( initData(false,"localIndices","If true, will compute local dof indices in topological elements") )
    , p_drawROI( initData(false,"drawROI","Draw ROI") )
    , p_drawPoints( initData(false,"drawPoints","Draw Points") )
    , p_drawEdges( initData(false,"drawEdges","Draw Edges") )
    , p_drawTriangles( initData(false,"drawTriangle","Draw Triangles") )
