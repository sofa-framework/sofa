...
ExtrudeQuadsAndGenerateHexas<DataTypes>::ExtrudeQuadsAndGenerateHexas()
    ...
    , f_scale( initData( Coord(1.0f,1.0f,1.0f), "scale", "Apply a scaling factor to the extruded mesh") )
    , f_thicknessIn( initData( Real (0.0), "thicknessIn", "Thickness of the extruded volume in the opposite direction of the normals") )
    , f_thicknessOut( initData( Real (1.0), "thicknessOut", "Thickness of the extruded volume in the direction of the normals") )
    , f_numberOfSlices( initData( int (1), "numberOfSlices", "Number of slices / steps in the extrusion") )
    , f_flipNormals(initData( bool(false), "flipNormals", "If true, will inverse point order when creating hexa"))
    , f_surfaceVertices( initData( "surfaceVertices", "Position coordinates of the surface") )
    , f_surfaceQuads( initData( "surfaceQuads", "Indices of the quads of the surface to extrude") )
    , f_extrudedVertices( initData( "extrudedVertices", "Coordinates of the extruded vertices") )
    , f_extrudedSurfaceQuads( initData( "extrudedSurfaceQuads", "List of new surface quads generated during the extrusion") )
    , f_extrudedQuads( initData( "extrudedQuads", "List of all quads generated during the extrusion") )
    , f_extrudedHexas( initData( "extrudedHexas", "List of hexahedra generated during the extrusion") )
{
