...
extern template class SOFA_COMPONENT_ENGINE_ANALYZE_API SumEngine<type::Vec1d>;
extern template class SOFA_COMPONENT_ENGINE_ANALYZE_API SumEngine<type::Vec3d>;
#endif
