...
ShapeMatching<DataTypes>::ShapeMatching()
    ...
    , d_affineRatio(initData(&d_affineRatio, (Real)0.0, "d_affineRatio", "Blending between affine and rigid."))
    , d_fixedweight(initData(&d_fixedweight, (Real)1.0, "d_fixedweight", "weight of fixed particles."))
    , d_fixedPosition0(initData(&d_fixedPosition0, "d_fixedPosition0", "rest positions of non mechanical particles."))
    , d_fixedPosition(initData(&d_fixedPosition, "d_fixedPosition", "current (fixed) positions of non mechanical particles."))
