...
ShapeMatching<DataTypes>::ShapeMatching()
    : 	  iterations(initData( (unsigned int)1, "iterations", "Number of iterations."))
    , affineRatio(initData((Real)0.0,"affineRatio","Blending between affine and rigid."))
    , fixedweight(initData((Real)1.0,"fixedweight","weight of fixed particles."))
    , fixedPosition0(initData("fixedPosition0","rest positions of non mechanical particles."))
    , fixedPosition(initData("fixedPosition","current (fixed) positions of non mechanical particles."))
    , position(initData("position","Input positions."))
    , cluster(initData("cluster","Input clusters."))
    , targetPosition(initData("targetPosition","Computed target positions."))
    , topo(nullptr)
