...
public:
    ...
    static SOFA_ATTRIBUTE_DEPRECATED__TOLAMEPARAMETERS() std::pair<Real, Real> toLameParameters(_2DMaterials, Real youngModulus, Real poissonRatio);
    static SOFA_ATTRIBUTE_DEPRECATED__TOLAMEPARAMETERS() std::pair<Real, Real> toLameParameters(_3DMaterials, Real youngModulus, Real poissonRatio);
