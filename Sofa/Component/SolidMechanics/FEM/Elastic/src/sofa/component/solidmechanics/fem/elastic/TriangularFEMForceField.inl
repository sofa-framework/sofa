...
TriangularFEMForceField<DataTypes>::TriangularFEMForceField()
    ...
    , d_hosfordExponant(initData(&d_hosfordExponant, (Real)1.0, "d_hosfordExponant", "Exponant in the Hosford yield criteria"))
    , d_criteriaValue(initData(&d_criteriaValue, (Real)1e15, "d_criteriaValue", "Fracturable threshold used to draw fracturable triangles"))
    , d_showStressValue(initData(&d_showStressValue, true, "d_showStressValue", "Flag activating rendering of stress values as a color in each triangle"))
    ...
    , d_showFracturableTriangles(initData(&d_showFracturableTriangles, false, "d_showFracturableTriangles", "Flag activating rendering of triangles to fracture"))
