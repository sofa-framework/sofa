...
FastTetrahedralCorotationalForceField<DataTypes>::FastTetrahedralCorotationalForceField()
    : d_pointInfo(initData(&d_pointInfo, "d_pointInfo", "Internal point data"))
    , d_edgeInfo(initData(&d_edgeInfo, "d_edgeInfo", "Internal edge data"))
    , d_tetrahedronInfo(initData(&d_tetrahedronInfo, "d_tetrahedronInfo", "Internal tetrahedron data"))
    , _initialPoints(0)
