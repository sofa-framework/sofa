...
FastTetrahedralCorotationalForceField<DataTypes>::FastTetrahedralCorotationalForceField()
    : pointInfo(initData( "pointInfo", "Internal point data"))
    , edgeInfo(initData( "edgeInfo", "Internal edge data"))
    , tetrahedronInfo(initData( "tetrahedronInfo", "Internal tetrahedron data"))
    , _initialPoints(0)
    , f_method(initData(std::string("qr"),"method"," method for rotation computation :\"qr\" (by QR) or \"polar\" or \"polar2\" or \"none\" (Linear elastic) "))
