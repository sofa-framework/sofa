...
TetrahedralCorotationalFEMForceField<DataTypes>::TetrahedralCorotationalFEMForceField()
    : tetrahedronInfo(initData( "tetrahedronInfo", "Internal tetrahedron data"))
    , f_method(initData(std::string("large"),"method","\"small\", \"large\" (by QR) or \"polar\" displacements"))
    , _poissonRatio(core::objectmodel::BaseObject::initData((Real)0.45f,"poissonRatio","FEM Poisson Ratio"))
    , _youngModulus(core::objectmodel::BaseObject::initData((Real)5000,"youngModulus","FEM Young Modulus"))
    , _localStiffnessFactor(core::objectmodel::BaseObject::initData("localStiffnessFactor","Allow specification of different stiffness per element. If there are N element and M values are specified, the youngModulus factor for element i would be localStiffnessFactor[i*M/N]"))
    , _updateStiffnessMatrix(core::objectmodel::BaseObject::initData(false,"updateStiffnessMatrix",""))
    , _assembling(core::objectmodel::BaseObject::initData(false,"computeGlobalMatrix",""))
    , f_drawing(initData(true,"drawing"," draw the forcefield if true"))
    , drawColor1(initData(sofa::type::RGBAColor(0.0f,0.0f,1.0f,1.0f),"drawColor1"," draw color for faces 1"))
    , drawColor2(initData(sofa::type::RGBAColor(0.0f,0.5f,1.0f,1.0f),"drawColor2"," draw color for faces 2"))
    , drawColor3(initData(sofa::type::RGBAColor(0.0f,1.0f,1.0f,1.0f),"drawColor3"," draw color for faces 3"))
    , drawColor4(initData(sofa::type::RGBAColor(0.5f,1.0f,1.0f,1.0f),"drawColor4"," draw color for faces 4"))
