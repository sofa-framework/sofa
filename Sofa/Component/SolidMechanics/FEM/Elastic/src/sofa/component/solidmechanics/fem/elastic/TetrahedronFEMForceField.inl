...
TetrahedronFEMForceField<DataTypes>::TetrahedronFEMForceField()
    ...
    , d_drawHeterogeneousTetra(initData(&d_drawHeterogeneousTetra, false, "d_drawHeterogeneousTetra", "Draw Heterogeneous Tetra in different color"))
    ...
    , l_topology(initLink("topology", "link to the tetrahedron topology container"))
{
    ...
    d_youngModulus.beginEdit()->push_back((Real)5000.);
    d_youngModulus.endEdit();
    d_youngModulus.unset();
