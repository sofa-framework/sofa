...
template <class DataTypes> TriangularBiquadraticSpringsForceField<DataTypes>::TriangularBiquadraticSpringsForceField()
    ...
    , f_compressible(initData(true,"compressible","If additional energy penalizing compressibility should be used"))
    , f_stiffnessMatrixRegularizationWeight(initData((Real)0.4,"matrixRegularization","Regularization of the Stiffnes Matrix (between 0 and 1)"))
    , lambda(0)
    , mu(0)
