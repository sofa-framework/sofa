...
FastTriangularBendingSprings<DataTypes>::FastTriangularBendingSprings(/*double _ks, double _kd*/)
    : d_bendingStiffness(initData((SReal) 1.0,"bendingStiffness","bending stiffness of the material"))
    , d_minDistValidity(initData((SReal) 0.000001,"minDistValidity","Distance under which a spring is not valid"))
    , l_topology(initLink("topology", "link to the topology container"))
    , d_edgeSprings(initData( "edgeInfo", "Internal edge data"))
{
