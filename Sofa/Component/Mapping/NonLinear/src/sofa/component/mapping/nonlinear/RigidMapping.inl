...
RigidMapping<TIn, TOut>::RigidMapping()
    ...
    , d_geometricStiffness(initData(&d_geometricStiffness, 0, "geometricStiffness", "assemble (and use) geometric stiffness (0=no GS, 1=non symmetric, 2=symmetrized)"))
    , m_matrixJ()
    , m_updateJ(false)
{
...
{
    SOFA_UNUSED(mparams);
    unsigned geomStiff = d_geometricStiffness.getValue();
