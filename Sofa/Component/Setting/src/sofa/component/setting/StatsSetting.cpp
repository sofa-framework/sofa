...
StatsSetting::StatsSetting():
        d_dumpState(initData(&d_dumpState, false, "d_dumpState", "Dump state vectors at each time step of the simulation"))
    ...
    , d_exportState(initData(&d_exportState, false, "d_exportState", "Create GNUPLOT files with the positions, velocities and forces of all the simulated objects of the scene"))
