...
ViewerSetting::ViewerSetting():
    resolution(initData( Vec<2,int>(800,600), "resolution", "resolution of the Viewer"))
  ,fullscreen(initData( false, "fullscreen", "Fullscreen mode"))
  ,cameraMode(initData( "cameraMode", "Camera mode"))
  ,objectPickingMethod(initData( "objectPickingMethod","The method used to pick objects"))
{
