...
macro(sofa_add_generic directory name type)
    ...
    if(EXISTS "${CMAKE_CURRENT_LIST_DIR}/${directory}" AND IS_DIRECTORY "${CMAKE_CURRENT_LIST_DIR}/${directory}")
        ...
        set(${name}_OPTION "${option}" CACHE INTERNAL "${name}_OPTION")
...
macro(sofa_project name)
    project(${ARGN})
    string(TOUPPER ${name} PROJECT_OPTION)
    if(PLUGIN_${PROJECT_OPTION})
        set(PROJECT_OPTION "MODULE_${PROJECT_OPTION}")
    elseif(APPLICATION_${PROJECT_OPTION})
        set(PROJECT_OPTION "PLUGIN_${PROJECT_OPTION}")
    elseif(COLLECTION_${PROJECT_OPTION})
        set(PROJECT_OPTION "COLLECTION_${PROJECT_OPTION}")
    elseif(MODULE_${PROJECT_OPTION})
        set(PROJECT_OPTION "APPLICATION_${PROJECT_OPTION}")
    endif()
endmacro()
