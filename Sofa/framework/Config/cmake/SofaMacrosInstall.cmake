    ...
    foreach(target ${ARG_TARGETS}) # Most of the time there is only one target
        ...
        if(target MATCHES "^Sofa")
            ...
            if(IS_INTERFACE_LIBRARY)
                target_compile_definitions(${target} INTERFACE "-DSOFA_BUILD${sofa_target_oldname_upper}")
            else()
        ...
        if(IS_INTERFACE_LIBRARY)
            target_compile_definitions(${target} INTERFACE "-DSOFA_BUILD_${sofa_target_name_upper}")
        else()
