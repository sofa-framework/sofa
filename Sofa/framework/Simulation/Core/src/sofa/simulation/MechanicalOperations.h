...
/// @{
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_INTEGRATEVELOCITY()
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_COMPUTEDFV()
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_COMPUTECONTACTFORCE()
    void computeContactForce(core::MultiVecDerivId result);
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_COMPUTECONTACTDF()
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_COMPUTEFORCE()
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_COMPUTECONTACTACC()
...
/// @{
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_RESETSYSTEM()
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_SETSYSTEMRHVECTOR()
    void setSystemRHVector(core::MultiVecDerivId v, core::behavior::LinearSolver* linearSolver);
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_SETSYSTEMLHVECTOR()
    void setSystemLHVector(core::MultiVecDerivId v, core::behavior::LinearSolver* linearSolver);
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_SOLVESYSTEM()
...
/// @{
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_ADDMBK_TOMATRIX()
    void addMBK_ToMatrix(const sofa::core::behavior::MultiMatrixAccessor* matrix, SReal mFact, SReal bFact, SReal kFact);

    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_MULTIVECTOR2BASEVECTOR()
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_BASEVECTOR2MULTIVECTOR()
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_MULTIVECTORPEQBASEVECTOR()
...
/// @{
    ...
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_PRINT()
    void print( core::ConstMultiVecId v, std::ostream& out );
    SOFA_ATTRIBUTE_DEPRECATED__MECHANICALOPERATIONS_PRINTWITHELAPSEDTIME()
