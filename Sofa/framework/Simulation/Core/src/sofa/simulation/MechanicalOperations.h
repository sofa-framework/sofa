...
/// @{
    ...
    SOFA_ATTRIBUTE_DISABLED_MECHANICALOPERATIONS_SETSYSTEMRHVECTOR() void m_setSystemRHVector(sofa::core::MultiVecDerivId v) = delete;
    SOFA_ATTRIBUTE_DISABLED_MECHANICALOPERATIONS_SETSYSTEMLHVECTOR() void m_setSystemLHVector(sofa::core::MultiVecDerivId v) = delete;
