...
SOFA_ATTRIBUTE_DEPRECATED__SINGLETONSIMULATION() SOFA_SIMULATION_CORE_API Simulation* getSimulation();
SOFA_ATTRIBUTE_DEPRECATED__SINGLETONSIMULATION() SOFA_SIMULATION_CORE_API void setSimulation(Simulation::SPtr simulation);
