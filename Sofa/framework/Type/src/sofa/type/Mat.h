...
template<class real>
SOFA_ATTRIBUTE_DISABLED__NONSQUAREDETERMINANT()
constexpr real determinant(const Mat<2,3,real>& m) noexcept = delete;

/// Generalized-determinant of a 3x2 matrix.
/// Mirko Radi, "About a Determinant of Rectangular 2×n Matrix and its Geometric Interpretation"
template<class real>
SOFA_ATTRIBUTE_DISABLED__NONSQUAREDETERMINANT()
constexpr real determinant(const Mat<3,2,real>& m) noexcept = delete;
