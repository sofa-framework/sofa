...
{
public:
    PointsIndicesSwap(const PointID i1,const PointID i2) : core::topology::TopologyChange(core::topology::POINTSINDICESSWAP)
    {
        index[0]=i1;
        index[1]=i2;
    }
...
public:
    ...
    PointsAdded(const size_t nV,
            const sofa::type::vector< PointID >& indices)
    ...
    const sofa::type::vector< PointID >& getIndexArray() const { return pointIndexArray; }
    const sofa::type::vector< Topology::Point >& getElementArray() const { return pointIndexArray; }

    size_t nVertices;
    sofa::type::vector< PointID > pointIndexArray;
    sofa::type::vector< sofa::type::vector< PointID > > ancestorsList;
...
{
public:
    PointsRemoved(const sofa::type::vector<PointID>& _vArray) : core::topology::TopologyChange(core::topology::POINTSREMOVED),
        removedVertexArray(_vArray)
    { }

    ~PointsRemoved() override;

    const sofa::type::vector<PointID> &getArray() const { return removedVertexArray;	}

    sofa::type::vector<PointID> removedVertexArray;
};
...
public:
    ...
    PointsRenumbering(const sofa::type::vector< PointID >& indices,
            const sofa::type::vector< PointID >& inv_indices)
    ...
    const sofa::type::vector<PointID> &getIndexArray() const { return indexArray; }

    const sofa::type::vector<PointID> &getinv_IndexArray() const { return inv_indexArray; }

    sofa::type::vector<PointID> indexArray;
    sofa::type::vector<PointID> inv_indexArray;
};
...
public:
    ...
    PointsMoved(const sofa::type::vector<PointID>& indices,
            const sofa::type::vector< sofa::type::vector< PointID > >& ancestors,
            const sofa::type::vector< sofa::type::vector< SReal > >& baryCoefs)
    ...
    const sofa::type::vector<PointID> &getIndexArray() const { return indicesList; }

    sofa::type::vector<PointID> indicesList;
    sofa::type::vector< sofa::type::vector< PointID > > ancestorsList;
