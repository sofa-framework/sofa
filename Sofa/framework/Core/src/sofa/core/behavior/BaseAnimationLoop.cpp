...
BaseAnimationLoop::BaseAnimationLoop()
    : m_resetTime(0.)
    , d_computeBoundingBox(initData( !SOFA_NO_UPDATE_BBOX, "computeBoundingBox", "If true, compute the global bounding box of the scene at each time step. Used mostly for rendering."))
{}
