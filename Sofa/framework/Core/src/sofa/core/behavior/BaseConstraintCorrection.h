...
public:
    ...
    virtual void computeResidual(const core::ExecParams* /*params*/, linearalgebra::BaseVector * /*lambda*/) = delete;
...
protected:
    ...
    static SReal correctionFactor(const sofa::core::behavior::BaseIntegrationScheme* solver, const ConstraintOrder& constraintOrder);
