...
MeshLoader::MeshLoader() : BaseLoader()
  , d_positions(initData( "position", "Vertices of the mesh loaded"))
  , d_polylines(initData( "polylines", "Polylines of the mesh loaded"))
  , d_edges(initData( "edges", "Edges of the mesh loaded"))
  , d_triangles(initData( "triangles", "Triangles of the mesh loaded"))
  , d_quads(initData( "quads", "Quads of the mesh loaded"))
  , d_polygons(initData( "polygons", "Polygons of the mesh loaded"))
  , d_highOrderEdgePositions(initData( "highOrderEdgePositions", "High order edge points of the mesh loaded"))
  , d_highOrderTrianglePositions(initData( "highOrderTrianglePositions", "High order triangle points of the mesh loaded"))
  , d_highOrderQuadPositions(initData( "highOrderQuadPositions", "High order quad points of the mesh loaded"))
  , d_tetrahedra(initData( "tetrahedra", "Tetrahedra of the mesh loaded"))
  , d_hexahedra(initData( "hexahedra", "Hexahedra of the mesh loaded"))
  , d_pentahedra(initData( "pentahedra", "Pentahedra of the mesh loaded"))
  , d_highOrderTetrahedronPositions(initData( "highOrderTetrahedronPositions", "High order tetrahedron points of the mesh loaded"))
  , d_highOrderHexahedronPositions(initData( "highOrderHexahedronPositions", "High order hexahedron points of the mesh loaded"))
  , d_pyramids(initData( "pyramids", "Pyramids of the mesh loaded"))
  , d_normals(initData( "normals", "Normals of the mesh loaded"))
  , d_edgesGroups(initData( "edgesGroups", "Groups of Edges"))
  , d_trianglesGroups(initData( "trianglesGroups", "Groups of Triangles"))
  , d_quadsGroups(initData( "quadsGroups", "Groups of Quads"))
  , d_polygonsGroups(initData( "polygonsGroups", "Groups of Polygons"))
  , d_tetrahedraGroups(initData( "tetrahedraGroups", "Groups of Tetrahedra"))
  , d_hexahedraGroups(initData( "hexahedraGroups", "Groups of Hexahedra"))
  , d_pentahedraGroups(initData( "pentahedraGroups", "Groups of Pentahedra"))
  , d_pyramidsGroups(initData( "pyramidsGroups", "Groups of Pyramids"))
  , d_flipNormals(initData( false, "flipNormals", "Flip Normals"))
  , d_triangulate(initData( false, "triangulate", "Divide all polygons into triangles"))
  , d_createSubelements(initData( false, "createSubelements", "Divide all n-D elements into their (n-1)-D boundary elements (e.g. tetrahedra to triangles)"))
  , d_onlyAttachedPoints(initData( false, "onlyAttachedPoints", "Only keep points attached to elements of the mesh"))
  , d_translation(initData( Vec3(), "translation", "Translation of the DOFs"))
  , d_rotation(initData( Vec3(), "rotation", "Rotation of the DOFs"))
  , d_scale(initData( Vec3(1.0, 1.0, 1.0), "scale3d", "Scale of the DOFs in 3 dimensions"))
  , d_transformation(initData( type::Matrix4::s_identity, "transformation", "4x4 Homogeneous matrix to transform the DOFs (when present replace any)"))
