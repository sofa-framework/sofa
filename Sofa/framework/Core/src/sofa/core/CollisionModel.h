...
public:
    ...
    virtual void computeContinuousBoundingTree(SReal dt, ContinuousIntersectionTypeFlag continuousIntersectionFlag = ContinuousIntersectionTypeFlag::Inertia, int maxDepth=0) final {
        //TODO (SPRINT SED 2025): Component state mechamism
        this->doComputeContinuousBoundingTree(dt, continuousIntersectionFlag, maxDepth);
    }
