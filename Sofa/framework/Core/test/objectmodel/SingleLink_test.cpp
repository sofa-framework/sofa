...
{
public:
    SingleLink<sofa::core::objectmodel::BaseComponent, sofa::core::objectmodel::BaseComponent, BaseLink::FLAG_DOUBLELINK|BaseLink::FLAG_STRONGLINK|BaseLink::FLAG_STOREPATH > m_link ;
    sofa::core::objectmodel::BaseComponent::SPtr m_dst ;
    sofa::core::objectmodel::BaseComponent::SPtr m_src ;

    /// Create a link to an object.
    void doSetUp() override
    {
        m_dst = sofa::core::objectmodel::New<sofa::core::objectmodel::BaseComponent>() ;
        m_src = sofa::core::objectmodel::New<sofa::core::objectmodel::BaseComponent>() ;
...
{
    SingleLink<sofa::core::objectmodel::BaseComponent, sofa::core::objectmodel::BaseComponent, BaseLink::FLAG_MULTILINK > smlink ;
    ...
    SingleLink<sofa::core::objectmodel::BaseComponent, sofa::core::objectmodel::BaseComponent, BaseLink::FLAG_NONE > slink ;
...
{
    const auto aBaseObject = sofa::core::objectmodel::New<sofa::core::objectmodel::BaseComponent>();
    using sofa::core::objectmodel::BaseNode;
    const BaseLink::InitLink<sofa::core::objectmodel::BaseComponent> initObjectLink(aBaseObject.get(), "objectlink", "");
    const SingleLink<sofa::core::objectmodel::BaseComponent, sofa::core::objectmodel::BaseComponent, BaseLink::FLAG_NONE > objectLink(initObjectLink) ;
