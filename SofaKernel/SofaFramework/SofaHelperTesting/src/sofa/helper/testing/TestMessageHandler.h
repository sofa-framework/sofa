...
class SOFA_SOFAHELPERTESTING_API MessageAsTestFailure
{
public:
...
class SOFA_SOFAHELPERTESTING_API ExpectMessage
{
public:
...
class SOFA_SOFAHELPERTESTING_API IgnoreMessage
{
public:
...
class SOFA_SOFAHELPERTESTING_API MainGtestMessageHandler
{
public:
