...
struct SOFA_SOFAHELPERTESTING_API NumericTest : public virtual BaseTest
{
    NumericTest() {}
...
extern template struct SOFA_SOFAHELPERTESTING_API sofa::helper::testing::NumericTest<float>;
#endif
#ifdef SOFA_WITH_DOUBLE
extern template struct SOFA_SOFAHELPERTESTING_API sofa::helper::testing::NumericTest<double>;
#endif
