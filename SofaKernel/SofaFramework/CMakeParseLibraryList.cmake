...
# Taken from https://software.lanl.gov/MeshTools/trac/browser/cmake/modules/ParseLibraryList.cmake
...
function(PARSE_LIBRARY_LIST)
    ...
    if((NOT PARSE_ARGS_FOUND)
            OR (NOT PARSE_ARGS_DEBUG)
            OR (NOT PARSE_ARGS_OPT)
            OR (NOT PARSE_ARGS_GENERAL)
            OR (NOT _parse_list))
        _print_usage()
