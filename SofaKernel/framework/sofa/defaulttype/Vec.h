...
typedef Vec<1,SReal> Vector1; ///< alias
typedef Vec<2,SReal> Vector2; ///< alias
typedef Vec<3,SReal> Vector3; ///< alias
typedef Vec<4,SReal> Vector4; ///< alias
typedef Vec<6,SReal> Vector6; ///< alias

typedef Vec<1,SReal> Vec1; ///< alias
typedef Vec<2,SReal> Vec2; ///< alias
typedef Vec<3,SReal> Vec3; ///< alias
typedef Vec<4,SReal> Vec4; ///< alias
typedef Vec<6,SReal> Vec6; ///< alias
