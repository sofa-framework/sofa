...
MeshLoader::MeshLoader() : BaseLoader()
    ...
    , highOrderEdgePositions(initData(&highOrderEdgePositions,"highOrderEdgePositions","High order edge points of the mesh loaded"))
    , highOrderTrianglePositions(initData(&highOrderTrianglePositions,"highOrderTrianglePositions","High order triangle points of the mesh loaded"))
    , highOrderQuadPositions(initData(&highOrderQuadPositions,"highOrderQuadPositions","High order quad points of the mesh loaded"))
    ...
    , highOrderTetrahedronPositions(initData(&highOrderTetrahedronPositions,"highOrderTetrahedronPositions","High order tetrahedron points of the mesh loaded"))
	, highOrderHexahedronPositions(initData(&highOrderHexahedronPositions,"highOrderHexahedronPositions","High order hexahedron points of the mesh loaded"))
