...
extern template class BasicShapesGL_Sphere<helper::fixed_array< float, 3 > >;
extern template class BasicShapesGL_Sphere<helper::fixed_array< double, 3 > >;
extern template class BasicShapesGL_FakeSphere<helper::fixed_array< float, 3 > >;
extern template class BasicShapesGL_FakeSphere<helper::fixed_array< double, 3 > >;
