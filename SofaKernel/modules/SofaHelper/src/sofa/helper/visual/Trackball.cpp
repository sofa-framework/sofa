        ...
        double p2y)
{
    ...
    type::Vector3	p1	((SReal)p1x, (SReal)p1y, (SReal)tb_project_to_sphere(TRACKBALLSIZE, p1x, p1y));
    type::Vector3	p2	((SReal)p2x, (SReal)p2y, (SReal)tb_project_to_sphere(TRACKBALLSIZE, p2x, p2y));

    // Now, we want the cross product of P1 and P2
    type::Vector3	a = cross(p2,p1);

    // Figure out how much to rotate around that axis.
    type::Vector3	d	= p1 - p2;
