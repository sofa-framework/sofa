...
extern template class fixed_array<float, 2>;
extern template class fixed_array<double, 2>;

extern template class fixed_array<float, 3>;
extern template class fixed_array<double, 3>;

extern template class fixed_array<float, 4>;
extern template class fixed_array<double, 4>;

extern template class fixed_array<float, 5>;
extern template class fixed_array<double, 5>;

extern template class fixed_array<float, 6>;
extern template class fixed_array<double, 6>;

extern template class fixed_array<float, 7>;
extern template class fixed_array<double, 7>;
#endif //
