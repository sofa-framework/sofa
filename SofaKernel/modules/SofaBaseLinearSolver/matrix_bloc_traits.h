...
template<std::size_t TN> class bloc_index_func
{
public:
    enum { N = TN };
    static void split(std::size_t& index, std::size_t& modulo)
    {
        modulo = index % N;
        index  = index / N;
    }
...
public:
    enum { N = 1 };
    static void split(std::size_t&, std::size_t&)
    {
    }
};
...
public:
    ...
    static void split_row_index(std::size_t& index, std::size_t& modulo) { bloc_index_func<NL>::split(index, modulo); }
    static void split_col_index(std::size_t& index, std::size_t& modulo) { bloc_index_func<NC>::split(index, modulo); }
...
public:
    ...
    enum { NL = 1 };
    enum { NC = 1 };
    static Real& v(Bloc& b, std::size_t, std::size_t) { return b; }
    static const Real& v(const Bloc& b, std::size_t, std::size_t) { return b; }
...
template <>
class matrix_bloc_traits < std::size_t >
{
public:
    typedef float Bloc;
    typedef float Real;
