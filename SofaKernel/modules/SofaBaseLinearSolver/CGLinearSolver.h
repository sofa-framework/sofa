...
extern template class CGLinearSolver< GraphScatteredMatrix, GraphScatteredVector >;
extern template class CGLinearSolver< FullMatrix<double>, FullVector<double> >;
extern template class CGLinearSolver< SparseMatrix<double>, FullVector<double> >;
extern template class CGLinearSolver< CompressedRowSparseMatrix<double>, FullVector<double> >;
extern template class CGLinearSolver< CompressedRowSparseMatrix<defaulttype::Mat<2,2,double> >, FullVector<double> >;
extern template class CGLinearSolver< CompressedRowSparseMatrix<defaulttype::Mat<3,3,double> >, FullVector<double> >;
extern template class CGLinearSolver< CompressedRowSparseMatrix<defaulttype::Mat<4,4,double> >, FullVector<double> >;
extern template class CGLinearSolver< CompressedRowSparseMatrix<defaulttype::Mat<6,6,double> >, FullVector<double> >;
extern template class CGLinearSolver< CompressedRowSparseMatrix<defaulttype::Mat<8,8,double> >, FullVector<double> >;
