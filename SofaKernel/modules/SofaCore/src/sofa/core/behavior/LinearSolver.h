...
public:
    ...
    ///
    virtual void partial_solve(std::list<sofa::SignedIndex>& /*I_last_Disp*/, std::list<sofa::SignedIndex>& /*I_last_Dforce*/, bool /*NewIn*/) { msg_warning() << "partial_solve is not implemented yet"; }
