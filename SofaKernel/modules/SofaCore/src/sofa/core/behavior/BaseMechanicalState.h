...
public:
    ...
    virtual void vAlloc(const ExecParams* params, VecCoordId v, const std::string& idLabel = {}) = 0;
    /// Allocate a new temporary vector
    virtual void vAlloc(const ExecParams* params, VecDerivId v, const std::string& idLabel = {}) = 0;
    /// Allocate a new temporary vector
    //virtual void vAlloc(MatrixDerivId v) = 0;

    /// Reallocate a new temporary vector
    virtual void vRealloc(const ExecParams* params, VecCoordId v, const std::string& idLabel = {}) = 0;
    /// Reallocate a new temporary vector
    virtual void vRealloc(const ExecParams* params, VecDerivId v, const std::string& idLabel = {}) = 0;
