...
public:
    ...
    virtual void v_alloc(sofa::core::MultiVecCoordId& id, const std::string& idLabel = {}) = 0;
    virtual void v_alloc(sofa::core::MultiVecDerivId& id, const std::string& idLabel = {}) = 0;
    ...
    virtual void v_realloc(sofa::core::MultiVecCoordId& id, bool interactionForceField=false, bool propagate=false, const std::string& idLabel = {}) = 0;
    virtual void v_realloc(sofa::core::MultiVecDerivId& id, bool interactionForceField=false, bool propagate=false, const std::string& idLabel = {}) = 0;
