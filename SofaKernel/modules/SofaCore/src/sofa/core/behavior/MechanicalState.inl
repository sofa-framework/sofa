...
MechanicalState<TDataTypes>::~MechanicalState() {}

template<class TDataTypes>
Size MechanicalState<TDataTypes>::getCoordDimension() const { return defaulttype::DataTypeInfo<Coord>::size(); }

template<class TDataTypes>
Size MechanicalState<TDataTypes>::getDerivDimension() const { return defaulttype::DataTypeInfo<Deriv>::size(); }
