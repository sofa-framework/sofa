...
extern template class Constraint<defaulttype::Vec3Types>;
extern template class Constraint<defaulttype::Vec2Types>;
extern template class Constraint<defaulttype::Vec1Types>;
extern template class Constraint<defaulttype::Rigid3Types>;
extern template class Constraint<defaulttype::Rigid2Types>;
