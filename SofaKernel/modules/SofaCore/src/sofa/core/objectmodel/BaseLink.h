...
public:
    ...
    /// Return the number of changes since creation
    /// This can be used to efficiently detect changes
    SOFA_ATTRIBUTE_DISABLED("2020-03-25 PR#1269", "2021-02-08 PR#1793", "ExecParams are not needed anymore. To upgrade your code please replace getCounter(param) with getCounter().")
