...
public:
    ...
    SOFA_ATTRIBUTE_DEPRECATED__ASPECT_EXECPARAMS("Update your code by using isSet().")
    ...
    SOFA_ATTRIBUTE_DEPRECATED__ASPECT_EXECPARAMS("Update your code by using unset().")
    ...
    SOFA_ATTRIBUTE_DEPRECATED__ASPECT_EXECPARAMS("Update your code by using forceSet().")
    void forceSet(const core::ExecParams*) { forceSet(); }
    void forceSet() { m_isSet = true; }

    /// Return the number of changes since creation
    /// This can be used to efficiently detect changes
    SOFA_ATTRIBUTE_DEPRECATED__ASPECT_EXECPARAMS("Update your code by using getCounter().")
