...
#include <SofaBaseUtils/SuffixMap.h>
...
public:
    ...
    sofa::core::objectmodel::Data<sofabaseutils::SuffixMap> d_suffixMap; ///< standard->custom suffixes pairs (to be used if the plugin is compiled outside of Sofa with a non standard way of differenciating versions), using ! to represent empty suffix
