...
template<class MyReal>
void CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::draw(const core::visual::VisualParams* vparams, index_type index)
{
...
template <class MyReal>
const typename CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::Coord & CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::center(index_type i)const{
    return DataTypes::getCPos((_mstate->read(core::ConstVecCoordId::position())->getValue())[i]);
}

template <class MyReal>
typename CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::Real CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::radius(index_type i) const
{
    return this->d_capsule_radii.getValue()[i];
}

template <class MyReal>
typename CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::Coord CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::point1(index_type i) const
{
    return  center(i) - axis(i) * height(i)/2.0;
}

template <class MyReal>
typename CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::Coord CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::point2(index_type i) const
{
    return  center(i) + axis(i) * height(i)/2.0;
}
...
template<class MyReal>
const typename CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::Coord & CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::velocity(index_type index) const {
...
template<class MyReal>
const sofa::defaulttype::Quaternion CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::orientation(index_type index)const{
    return _mstate->read(core::ConstVecCoordId::position())->getValue()[index].getOrientation();
}

template<class MyReal>
typename CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::Coord CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::axis(index_type index) const {
    Coord ax(0,1,0);
...
template<class MyReal>
typename CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::Real CapsuleCollisionModel<sofa::defaulttype::StdRigidTypes<3,MyReal> >::height(index_type index) const {
