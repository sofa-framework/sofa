...
******************************************************************************/
#ifndef SOFA_COMPONENT_COLLISION_SPHEREMODEL_FWD_H
#define SOFA_COMPONENT_COLLISION_SPHEREMODEL_FWD_H
...
namespace sofa {
    namespace component {
        namespace collision {
            ...
            /// We should probably have to use a forward definition of the Vec3Types
            /// ...
