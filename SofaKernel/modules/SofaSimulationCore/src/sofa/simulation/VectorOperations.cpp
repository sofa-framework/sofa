...
using sofa::simulation::mechanicalvisitor::MechanicalVDotVisitor;

#include <sofa/simulation/mechanicalvisitor/MechanicalVNormVisitor.h>
using sofa::simulation::mechanicalvisitor::MechanicalVNormVisitor;

#include <sofa/simulation/mechanicalvisitor/MechanicalVSizeVisitor.h>
using sofa::simulation::mechanicalvisitor::MechanicalVSizeVisitor;
...
void VectorOperations::v_alloc(sofa::core::MultiVecCoordId& v, const std::string& idLabel)
{
    ...
    executeVisitor( MechanicalVAllocVisitor<core::V_COORD>(params, v, idLabel) );
}

void VectorOperations::v_alloc(sofa::core::MultiVecDerivId& v, const std::string& idLabel)
{
    ...
    //v.assign(id);
    v.setId(avail.states, id);
    executeVisitor(  MechanicalVAllocVisitor<core::V_DERIV>(params, v, idLabel) );
}
...
void VectorOperations::v_realloc(sofa::core::MultiVecCoordId& v, bool interactionForceField, bool propagate, const std::string& idLabel)
{
    if( v.isNull() )
    {
        core::VecCoordId id(core::VecCoordId::V_FIRST_DYNAMIC_INDEX);
    ...
    executeVisitor( MechanicalVReallocVisitor<core::V_COORD>(params, &v, interactionForceField, propagate, idLabel) );
}

void VectorOperations::v_realloc(sofa::core::MultiVecDerivId& v, bool interactionForceField, bool propagate, const std::string& idLabel)
{
    if( v.isNull() )
    {
        core::VecDerivId id(core::VecDerivId::V_FIRST_DYNAMIC_INDEX);
    ...
    executeVisitor( MechanicalVReallocVisitor<core::V_DERIV>(params, &v, interactionForceField, propagate, idLabel) );
}
