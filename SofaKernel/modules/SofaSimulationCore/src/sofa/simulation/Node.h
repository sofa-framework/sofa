...
public:
    ...
    virtual bool addObject(sofa::core::objectmodel::BaseObject::SPtr obj, bool atEnd=true) final;
...
protected:
    ...
    virtual bool doAddObject(sofa::core::objectmodel::BaseObject::SPtr obj, bool atEnd=true);
