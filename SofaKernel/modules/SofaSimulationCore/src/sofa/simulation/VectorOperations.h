...
public:
    ...
    void v_alloc(sofa::core::MultiVecCoordId& v, const std::string& idLabel = {}) override;
    void v_alloc(sofa::core::MultiVecDerivId& v, const std::string& idLabel = {}) override;
    ...
    void v_realloc(sofa::core::MultiVecCoordId& id, bool interactionForceField=false, bool propagate=false, const std::string& idLabel = {}) override;
    void v_realloc(sofa::core::MultiVecDerivId& id, bool interactionForceField=false, bool propagate=false, const std::string& idLabel = {}) override;
