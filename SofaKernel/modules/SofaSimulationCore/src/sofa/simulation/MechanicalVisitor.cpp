...
void MechanicalPickParticlesVisitor::getClosestParticle( core::behavior::BaseMechanicalState*& mstate, sofa::index_type& indexCollisionElement, defaulttype::Vector3& point, SReal& rayLength )
{
    mstate = nullptr;
