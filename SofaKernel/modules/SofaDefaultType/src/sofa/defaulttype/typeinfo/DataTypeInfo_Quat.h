...
{
    static std::string GetTypeName() { std::ostringstream o; o << "Quater<" << DataTypeName<T>::typeName() << ">"; return o.str(); }
    static std::string GetName() { std::ostringstream o; o << "Quat" << DataTypeName<T>::name() ; return o.str(); }
};
