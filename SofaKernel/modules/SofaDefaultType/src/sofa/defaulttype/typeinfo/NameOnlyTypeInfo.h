...
public:
    ...
    virtual sofa::Size size(const void*) const {return -1;}
    ...
    virtual void setIntegerValue(void*, Index , long long) const {return;}
    /// Set the value at \a index of \a data from a scalar value.
    virtual void setScalarValue (void*, Index , double) const {return;}
    /// Set the value at \a index of \a data from a string value.
    virtual void setTextValue(void*, Index , const std::string&) const {return;}
