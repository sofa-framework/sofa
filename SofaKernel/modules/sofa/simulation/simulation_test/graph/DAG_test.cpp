...
struct DAG_test : public BaseTest
{
    ...
    static void traverse_test( NodeSPtr node, std::string treeTraverse, std::string treeTraverseRepeatAll, std::string treeTraverseRepeatOnce, std::string dagTopDown )
    {
...
Expected output: RABCCBAR
    ...
    void traverse_simple_diamond()
    {
        NodeSPtr root = clearScene();
        root->setName("R");
        NodeSPtr A = root->createChild("A");
        NodeSPtr B = root->createChild("B");
        NodeSPtr C = A->createChild("C");
        B->addChild(C);
...
Expected output: RABCDEEDCBAR
    ...
    void traverse_complex()
    {
        ...
        NodeSPtr C = A->createChild("C");
        B->addChild(C);
        NodeSPtr D = C->createChild("D");
        root->addChild(D);
        NodeSPtr E = D->createChild("E");
 ...
 \/ \|
  ...
  F  G
    ...
    void traverse_morecomplex()
    {
        ...
        NodeSPtr A = root->createChild("A");
        NodeSPtr B = root->createChild("B");
        NodeSPtr C = root->createChild("C");
        NodeSPtr D = A->createChild("D");
        B->addChild(D);
        NodeSPtr E = B->createChild("E");
        C->addChild(E);
        NodeSPtr F = D->createChild("F");
        NodeSPtr G = E->createChild("G");
 ...
 \/__/_/_/
  ...
  H
    ...
    void traverse_morecomplex2()
    {
        ...
        NodeSPtr B = root->createChild("B");
        NodeSPtr C = root->createChild("C");
        NodeSPtr D = root->createChild("D");
        NodeSPtr E = root->createChild("E");
        NodeSPtr F = A->createChild("F");
        B->addChild(F);
        C->addChild(F);
        D->addChild(F);
        E->addChild(F);
        NodeSPtr G = F->createChild("G");
        NodeSPtr H = G->createChild("H");
        F->addChild(H);
    ...
    static void getObjectByPath( NodeSPtr node, const std::string& searchpath, const std::string& objpath )
    {
    ...
    void getObject()
    {
        NodeSPtr A = clearScene();
        A->setName("A");

        NodeSPtr B = A->createChild("B");
        NodeSPtr C = A->createChild("C");
        NodeSPtr D = B->createChild("D");
        C->addChild(D);
        NodeSPtr E = D->createChild("E");
