...
OglTexture::OglTexture()
    :textureFilename(initData( (std::string) "", "filename", "Texture Filename"))
    ,textureUnit(initData( (unsigned short) 1, "textureUnit", "Set the texture unit"))
    ,enabled(initData( (bool) true, "enabled", "enabled ?"))
    ,repeat(initData( (bool) false, "repeat", "Repeat Texture ?"))
    ,linearInterpolation(initData( (bool) true, "linearInterpolation", "Interpolate Texture ?"))
    ,generateMipmaps(initData( (bool) true, "generateMipmaps", "Generate mipmaps ?"))
    ,srgbColorspace(initData( (bool) false, "srgbColorspace", "SRGB colorspace ?"))
    ,minLod(initData( (float) -1000, "minLod", "Minimum mipmap lod ?"))
    ,maxLod(initData( (float)  1000, "maxLod", "Maximum mipmap lod ?"))
    ,proceduralTextureWidth(initData( (unsigned int) 0, "proceduralTextureWidth", "Width of procedural Texture"))
    ,proceduralTextureHeight(initData( (unsigned int) 0, "proceduralTextureHeight", "Height of procedural Texture"))
    ,proceduralTextureNbBits(initData( (unsigned int) 1, "proceduralTextureNbBits", "Nb bits per color"))
    ,proceduralTextureData(initData(  "proceduralTextureData", "Data of procedural Texture "))
    ,cubemapFilenamePosX(initData( (std::string) "", "cubemapFilenamePosX", "Texture filename of positive-X cubemap face"))
    ,cubemapFilenamePosY(initData( (std::string) "", "cubemapFilenamePosY", "Texture filename of positive-Y cubemap face"))
    ,cubemapFilenamePosZ(initData( (std::string) "", "cubemapFilenamePosZ", "Texture filename of positive-Z cubemap face"))
    ,cubemapFilenameNegX(initData( (std::string) "", "cubemapFilenameNegX", "Texture filename of negative-X cubemap face"))
    ,cubemapFilenameNegY(initData( (std::string) "", "cubemapFilenameNegY", "Texture filename of negative-Y cubemap face"))
    ,cubemapFilenameNegZ(initData( (std::string) "", "cubemapFilenameNegZ", "Texture filename of negative-Z cubemap face"))
    ,texture(nullptr)
    ,img(nullptr)
{
...
OglTexture2D::OglTexture2D()
    :texture2DFilename(initData( (std::string) "", "texture2DFilename", "Texture2D Filename"))
{
