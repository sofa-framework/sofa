...
{
    return sofa::types::stdtypes::pairwise::stdclamp(v, lo, hi);
}
...
{
    return sofa::types::stdtypes::pairwise::clamp(in,minValue,maxValue);
}

template<class T, class TT = typename T::value_type, size_t TN = T::static_size>
T operator+(const T& l, const T& r)
{
    return sofa::types::stdtypes::pairwise::operator+(l, r);
}
...
{
    return sofa::types::stdtypes::pairwise::operator*(r, f);
}
