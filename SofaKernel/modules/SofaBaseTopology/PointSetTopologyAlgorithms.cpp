...
template class PointSetTopologyAlgorithms<Vec3Types>;
template class PointSetTopologyAlgorithms<Vec2Types>;
template class PointSetTopologyAlgorithms<Vec1Types>;
template class PointSetTopologyAlgorithms<Rigid3Types>;
template class PointSetTopologyAlgorithms<Rigid2Types>;
