...
template< class DataTypes>
void EdgeSetGeometryAlgorithms< DataTypes >::computeLocalFrameEdgeWeights( helper::vector<sofa::defaulttype::index_type>& numEdges, helper::vector<Edge>& vertexEdges, helper::vector<Vec3d>& weights ) const
{
    ...
    for(PointID pointId=0; pointId<pos.size(); pointId++ )
    {
        ...
        // compute E.Et
        for(std::size_t e=0; e<ve.size(); e++ )
        {
