...
public:
    ...
    */
    ...
    void subDivideTetrahedronsWithPlane(sofa::type::vector< sofa::type::vector<Real> >& coefs, sofa::type::vector<EdgeID>& intersectedEdgeID, Coord /*planePos*/, Coord planeNormal);
    ...
    void subDivideRestTetrahedronsWithPlane(sofa::type::vector< sofa::type::vector<Real> >& coefs, sofa::type::vector<EdgeID>& intersectedEdgeID, Coord /*planePos*/, Coord planeNormal);
