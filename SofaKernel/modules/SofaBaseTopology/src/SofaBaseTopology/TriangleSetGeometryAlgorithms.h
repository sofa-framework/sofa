...
public:
    ...
    *
    */
    sofa::type::vector< SReal > computeTriangleBarycoefs(const TriangleID ind_t, const sofa::type::Vec<3,SReal> &p) const;

    /** \brief Computes barycentric coefficients of point p in initial triangle (a,b,c) indexed by ind_t
    *
    */
    sofa::type::vector< SReal > computeRestTriangleBarycoefs(const TriangleID ind_t, const sofa::type::Vec<3, SReal>& p) const;

    /** \brief Computes barycentric coefficients of point p in triangle whose vertices are indexed by (ind_p1,ind_p2,ind_p3)
     *
     */
    sofa::type::vector< SReal > compute3PointsBarycoefs( const sofa::type::Vec<3, SReal> &p,
            PointID ind_p1,
            PointID ind_p2,
            PointID ind_p3,
     ...
     *
     */
    sofa::type::Vec<3, SReal> computeBaryEdgePoint(PointID p0, PointID p1, SReal coord_p) const;
    sofa::type::Vec<3, SReal> computeBaryEdgePoint(Edge e, SReal coord_p) const
    {
     ...
     *
     */
    sofa::type::Vec<3, SReal> computeBaryTrianglePoint(PointID p0, PointID p1, PointID p2, sofa::type::Vec<3, SReal>& coord_p) const;
    sofa::type::Vec<3, SReal> computeBaryTrianglePoint(Triangle& t, sofa::type::Vec<3, SReal>& coord_p) const
    {
     ...
     *
     */
    sofa::type::Vec<3, SReal> computeTriangleNormal(const TriangleID ind_t) const;
    ...
    */
     ...
     *
     */
    sofa::type::Vec<3, SReal> getOppositePoint(PointID ind_p, const Edge& indices, SReal coord_p) const;
    ...
    */
    ...
    void prepareVertexDuplication(const PointID ind_p,
            ...
            const Edge& indices_from, const SReal& coord_from,
            const Edge& indices_to, const SReal& coord_to,
    ...
    bool computeSegmentTriangleIntersection(bool is_entered,
            const sofa::type::Vec<3,SReal>& a,
            const sofa::type::Vec<3,SReal>& b,
            const TriangleID ind_t,
            sofa::type::vector<PointID> &indices,
            SReal &baryCoef, SReal& coord_kmin) const;
    ...
    */
    ...
    bool computeIntersectedPointsList(const PointID last_point,
            ...
            sofa::type::vector< SReal >& coords_list,
    ...
    bool computeIntersectedObjectsList (const PointID last_point,
            const sofa::type::Vec<3,SReal>& a, const sofa::type::Vec<3,SReal>& b,
            TriangleID& ind_ta, TriangleID& ind_tb,
            sofa::type::vector< sofa::core::topology::TopologyElementType>& topoPath_list,
            sofa::type::vector<ElemID>& indices_list,
            sofa::type::vector< sofa::type::Vec<3, SReal> >& coords_list) const;


    /** \brief Get the triangle in a given direction from a point.
     */
    int getTriangleInDirection(PointID p, const sofa::type::Vec<3,SReal>& dir) const;
    ...
    */
     ...
     */
    void RemoveAlongTrianglesList(const sofa::type::Vec<3, SReal>& a,
        const sofa::type::Vec<3, SReal>& b,
     ...
     */
    void InciseAlongLinesList(const sofa::type::vector< sofa::type::Vec<3, SReal> >& input_points,
    ...
    virtual int SplitAlongPath(PointID pa, Coord& a, PointID pb, Coord& b,
        sofa::type::vector< sofa::core::topology::TopologyElementType>& topoPath_list,
        sofa::type::vector<ElemID>& indices_list,
        sofa::type::vector< sofa::type::Vec<3, SReal> >& coords_list,
        sofa::type::vector<EdgeID>& new_edges, SReal epsilonSnapPath = 0.0, SReal epsilonSnapBorder = 0.0);



    /* void SnapAlongPath (sofa::type::vector<TriangleID>& triangles_list, sofa::type::vector<EdgeID>& edges_list,
      sofa::type::vector<SReal>& coords_list, sofa::type::vector<SReal>& points2Snap);*/

    void SnapAlongPath(sofa::type::vector< sofa::core::topology::TopologyElementType>& topoPath_list,
        sofa::type::vector<ElemID>& indices_list, sofa::type::vector< sofa::type::Vec<3, SReal> >& coords_list,
        sofa::type::vector< sofa::type::vector<SReal> >& points2Snap,
        SReal epsilonSnapPath);
