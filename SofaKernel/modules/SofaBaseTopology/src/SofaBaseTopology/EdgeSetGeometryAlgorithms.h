...
public:
    ...
    bool isPointOnEdge(const sofa::type::Vec<3, SReal> &pt, const EdgeID ind_e) const;

    // compute barycentric coefficients
    sofa::type::vector< SReal > compute2PointsBarycoefs(const sofa::type::Vec<3, SReal> &p, PointID ind_p1, PointID ind_p2) const;
    sofa::type::vector< SReal > computeRest2PointsBarycoefs(const sofa::type::Vec<3, SReal> &p, PointID ind_p1, PointID ind_p2) const;
    ...
    */
    sofa::type::vector< SReal > computePointProjectionOnEdge (const EdgeID i, sofa::type::Vec<3,SReal> coord_x, bool& intersected);
