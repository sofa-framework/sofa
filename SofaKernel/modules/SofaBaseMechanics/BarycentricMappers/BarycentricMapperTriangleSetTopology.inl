...
template <class In, class Out>
typename BarycentricMapperTriangleSetTopology<In, Out>::index_type 
BarycentricMapperTriangleSetTopology<In,Out>::addPointInTriangle ( const index_type triangleIndex, const SReal* baryCoords )
{
...
template <class In, class Out>
typename BarycentricMapperTriangleSetTopology<In, Out>::index_type 
BarycentricMapperTriangleSetTopology<In,Out>::createPointInTriangle ( const typename Out::Coord& p, index_type triangleIndex, const typename In::VecCoord* points )
{
    SReal baryCoords[2];
...
template <class In, class Out>
void BarycentricMapperTriangleSetTopology<In,Out>::addPointInElement(const index_type elementIndex, const SReal* baryCoords)
{
