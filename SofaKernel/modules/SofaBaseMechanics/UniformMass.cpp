...
template class UniformMass<Vec3Types,double>;
template class UniformMass<Vec2Types,double>;
template class UniformMass<Vec1Types,double>;
template class UniformMass<Vec6Types,double>;
template class UniformMass<Rigid3Types,Rigid3Mass>;
template class UniformMass<Rigid2Types,Rigid2Mass>;
