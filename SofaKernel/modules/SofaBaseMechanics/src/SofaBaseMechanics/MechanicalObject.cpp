...
void MechanicalObject<defaulttype::Rigid3Types>::draw(const core::visual::VisualParams* vparams)
{
    ...
    if (showObject.getValue())
    {
        ...
        for (size_t i = 0; i < vsize; ++i)
        {
			...
			{
				vparams->drawTool()->drawFrame ( Vector3(), Quat(), Vector3 ( 1,1,1 ), sofa::type::RGBAColor::gray());
			}
			else switch( drawMode.getValue() )
            {
                case 1:
                    vparams->drawTool()->drawFrame ( Vector3(), Quat(), Vector3 ( 1,1,1 ), sofa::type::RGBAColor::green());
                    break;
                case 2:
                    vparams->drawTool()->drawFrame ( Vector3(), Quat(), Vector3 ( 1,1,1 ), sofa::type::RGBAColor::red());
                    break;
                case 3:
                    vparams->drawTool()->drawFrame ( Vector3(), Quat(), Vector3 ( 1,1,1 ), sofa::type::RGBAColor::blue());
                    break;
                case 4:
                    vparams->drawTool()->drawFrame ( Vector3(), Quat(), Vector3 ( 1,1,1 ), sofa::type::RGBAColor::yellow());
                    break;
                case 5:
                    vparams->drawTool()->drawFrame ( Vector3(), Quat(), Vector3 ( 1,1,1 ), sofa::type::RGBAColor::magenta());
                    break;
                case 6:
                    vparams->drawTool()->drawFrame ( Vector3(), Quat(), Vector3 ( 1,1,1 ), sofa::type::RGBAColor::cyan());
                    break;
                default:
