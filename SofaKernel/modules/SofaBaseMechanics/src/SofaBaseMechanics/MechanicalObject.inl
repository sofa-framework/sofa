...
void MechanicalObject<DataTypes>::init()
{
    ...
    Vector3 _translation2 = translation2.getValue();
    Vector3 _rotation2 = rotation2.getValue();
...
{
    Vector3 _scale = scale.getValue();
    Vector3 _translation = translation.getValue();
    Vector3 _rotation = rotation.getValue();
