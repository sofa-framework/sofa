...
extern template class SOFA_SOFABASEMECHANICS_API SubsetMultiMapping< defaulttype::Vec6Types, defaulttype::Vec6Types >;
extern template class SOFA_SOFABASEMECHANICS_API SubsetMultiMapping< defaulttype::Vec3Types, defaulttype::Vec3Types >;
extern template class SOFA_SOFABASEMECHANICS_API SubsetMultiMapping< defaulttype::Vec2Types, defaulttype::Vec2Types >;
extern template class SOFA_SOFABASEMECHANICS_API SubsetMultiMapping< defaulttype::Vec1Types, defaulttype::Vec1Types >;
extern template class SOFA_SOFABASEMECHANICS_API SubsetMultiMapping< defaulttype::Rigid3Types, defaulttype::Rigid3Types >;
extern template class SOFA_SOFABASEMECHANICS_API SubsetMultiMapping< defaulttype::Rigid3Types, defaulttype::Vec3Types >;
