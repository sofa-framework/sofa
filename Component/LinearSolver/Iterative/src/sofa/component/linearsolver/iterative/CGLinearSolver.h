...
extern template class SOFA_COMPONENT_LINEARSOLVER_ITERATIVE_API CGLinearSolver< linearalgebra::eigen::EigenMatrix<Eigen::SparseMatrix<SReal, Eigen::RowMajor> >, linearalgebra::eigen::EigenVector<Eigen::Matrix<SReal, Eigen::Dynamic, 1 > > >;
