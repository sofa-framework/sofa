...
extern template class SOFA_COMPONENT_COLLISION_MODEL_API TSphere<defaulttype::Vec3Types>;
extern template class SOFA_COMPONENT_COLLISION_MODEL_API SphereCollisionModel<defaulttype::Vec3Types>;
