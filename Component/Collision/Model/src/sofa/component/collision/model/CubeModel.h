...
class SOFA_COMPONENT_COLLISION_MODEL_API CubeCollisionModel : public core::CollisionModel
{
public:
...
public:
    ...
    void getBoundingTree ( sofa::type::vector< std::pair< sofa::type::Vector3, sofa::type::Vector3> > &bounding )
    {
