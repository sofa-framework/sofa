...
template<class TDataTypes>
class SOFA_COMPONENT_COLLISION_MODEL_API LineCollisionModel : public core::CollisionModel
{
public :
...
extern template class SOFA_COMPONENT_COLLISION_MODEL_API TLine<sofa::defaulttype::Vec3Types>;
