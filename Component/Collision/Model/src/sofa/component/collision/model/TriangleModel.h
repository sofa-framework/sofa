 ...
 */
template<class TDataTypes>
class SOFA_COMPONENT_COLLISION_MODEL_API TriangleCollisionModel : public core::CollisionModel
{
public:
...
extern template class SOFA_COMPONENT_COLLISION_MODEL_API TTriangle<defaulttype::Vec3Types>;
