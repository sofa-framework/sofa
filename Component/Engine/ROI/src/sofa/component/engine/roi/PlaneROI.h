...
extern template class SOFA_COMPONENT_ENGINE_ROI_API PlaneROI<defaulttype::Vec3Types>;
extern template class SOFA_COMPONENT_ENGINE_ROI_API PlaneROI<defaulttype::Rigid3Types>;
