...
extern template class SOFA_COMPONENT_ENGINE_GEOMETRY_API ShapeMatching<defaulttype::Vec3Types>;
extern template class SOFA_COMPONENT_ENGINE_GEOMETRY_API ShapeMatching<defaulttype::Rigid3Types>;
