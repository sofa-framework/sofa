...
class SOFA_COMPONENT_UTILITY_API MessageHandlerComponent : public core::objectmodel::BaseObject
{
public:
...
class SOFA_COMPONENT_UTILITY_API FileMessageHandlerComponent : public core::objectmodel::BaseObject
{
public:
