...
protected:
    ...
    Data<double> d_radius; ///< Radius of created circles in yz plan
    Data<double> d_radiusFocal; ///< If greater than 0., radius in focal axis of created ellipses
    Data<Vec> d_focalAxis; ///< In case of ellipses
