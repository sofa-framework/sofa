...
#include <sofa/component/constraint/projective/SkeletalMotionConstraint.inl>
...
template class SOFA_COMPONENT_CONSTRAINT_PROJECTIVE_API SkeletalMotionConstraint<defaulttype::Rigid3Types>;
