...
public:
    ...
    Data<Coord> f_point; ///< Target of the projection
...
extern template class SOFA_COMPONENT_CONSTRAINT_PROJECTIVE_API ProjectToPointConstraint<defaulttype::Vec6Types>;
