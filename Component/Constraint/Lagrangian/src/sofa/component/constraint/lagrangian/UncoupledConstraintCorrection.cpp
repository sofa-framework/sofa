...
template<>
SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API void UncoupledConstraintCorrection< defaulttype::Rigid3Types >::init()
{
    Inherit::init();
...
template<>
SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API void UncoupledConstraintCorrection< defaulttype::Rigid3Types >::getComplianceMatrix(linearalgebra::BaseMatrix *m) const
{
    const VecReal& comp = compliance.getValue();
...
template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API UncoupledConstraintCorrection< Vec1Types >;
template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API UncoupledConstraintCorrection< Vec2Types >;
template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API UncoupledConstraintCorrection< Vec3Types >;
template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API UncoupledConstraintCorrection< Rigid3Types >;
