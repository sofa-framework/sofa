...
class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API GenericConstraintProblem : public ConstraintProblem
{
public:
...
class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API GenericConstraintSolver : public ConstraintSolverImpl
{
...
class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API MechanicalGetConstraintResolutionVisitor : public simulation::BaseMechanicalVisitor
{
public:
