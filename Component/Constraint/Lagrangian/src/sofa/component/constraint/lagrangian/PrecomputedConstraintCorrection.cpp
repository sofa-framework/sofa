...
template<>
SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API void PrecomputedConstraintCorrection< defaulttype::Rigid3Types >::rotateConstraints(bool back)
{
...
template<>
SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API void PrecomputedConstraintCorrection<defaulttype::Vec1Types>::rotateConstraints(bool /*back*/)
{
}
...
template<>
SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API void PrecomputedConstraintCorrection<defaulttype::Rigid3Types>::rotateResponse()
{
...
template<>
SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API void PrecomputedConstraintCorrection<defaulttype::Vec1Types>::rotateResponse()
{
}


template<>
SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API void PrecomputedConstraintCorrection<defaulttype::Vec1Types>::draw(const core::visual::VisualParams* )
{
}

template<>
SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API void PrecomputedConstraintCorrection<defaulttype::Rigid3Types>::draw(const core::visual::VisualParams* )
{
}
...
template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API PrecomputedConstraintCorrection<Vec3Types>;
template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API PrecomputedConstraintCorrection<Vec1Types>;
template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API PrecomputedConstraintCorrection<Rigid3Types>;
