...
namespace sofa::component::constraint::lagrangian::bilateralinteractionconstraint
{
...
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API BilateralInteractionConstraint< Vec3Types >;
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API BilateralInteractionConstraint< Rigid3Types >;
#endif
