...
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API PrecomputedConstraintCorrection<defaulttype::Vec3Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API PrecomputedConstraintCorrection<defaulttype::Vec1Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API PrecomputedConstraintCorrection<defaulttype::Rigid3Types>;
