...
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API LinearSolverConstraintCorrection<sofa::defaulttype::Vec3Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API LinearSolverConstraintCorrection<sofa::defaulttype::Vec2Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API LinearSolverConstraintCorrection<sofa::defaulttype::Vec1Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API LinearSolverConstraintCorrection<sofa::defaulttype::Rigid3Types>;
