...
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API UncoupledConstraintCorrection<defaulttype::Vec3Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API UncoupledConstraintCorrection<defaulttype::Vec2Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API UncoupledConstraintCorrection<defaulttype::Vec1Types>;
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API UncoupledConstraintCorrection<defaulttype::Rigid3Types>;
