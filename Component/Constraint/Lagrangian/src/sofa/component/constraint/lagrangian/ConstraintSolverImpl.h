...
class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API ConstraintProblem
{
public:
...
class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API ConstraintSolverImpl : public sofa::core::behavior::ConstraintSolver
{
public:
