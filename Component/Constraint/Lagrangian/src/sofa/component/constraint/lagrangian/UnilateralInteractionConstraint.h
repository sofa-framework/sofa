...
class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API UnilateralConstraintResolutionWithFriction : public core::behavior::ConstraintResolution
{
public:
...
extern template class SOFA_COMPONENT_CONSTRAINT_LAGRANGIAN_API UnilateralInteractionConstraint<defaulttype::Vec3Types>;
