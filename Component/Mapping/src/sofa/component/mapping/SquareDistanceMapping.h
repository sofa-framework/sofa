...
extern template class SOFA_COMPONENT_MAPPING_API SquareDistanceMapping< defaulttype::Vec3Types, defaulttype::Vec1Types >;
extern template class SOFA_COMPONENT_MAPPING_API SquareDistanceMapping< defaulttype::Rigid3Types, defaulttype::Vec1Types >;
