...
template class SOFA_COMPONENT_MAPPING_API SquareDistanceMapping< Vec3Types, Vec1Types >;
template class SOFA_COMPONENT_MAPPING_API SquareDistanceMapping< Rigid3Types, Vec1Types >;
