...
template class SOFA_COMPONENT_MAPPING_API DistanceFromTargetMapping< Vec3Types, Vec1Types >;
template class SOFA_COMPONENT_MAPPING_API DistanceFromTargetMapping< Vec1Types, Vec1Types >;
template class SOFA_COMPONENT_MAPPING_API DistanceFromTargetMapping< Rigid3Types, Vec1Types >;
