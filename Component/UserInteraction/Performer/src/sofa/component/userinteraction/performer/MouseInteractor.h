...
class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API BaseMouseInteractor : public core::BehaviorModel
{
public:
...
extern template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API MouseInteractor<defaulttype::Vec2Types>;
extern template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API MouseInteractor<defaulttype::Vec3Types>;
extern template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API MouseInteractor<defaulttype::Rigid3Types>;
