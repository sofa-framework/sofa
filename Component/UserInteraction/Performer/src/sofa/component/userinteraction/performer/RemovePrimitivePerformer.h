...
class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API RemovePrimitivePerformer: public       TInteractionPerformer<DataTypes>, public RemovePrimitivePerformerConfiguration
{
...
extern template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API RemovePrimitivePerformer<defaulttype::Vec3Types>;
