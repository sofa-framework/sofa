...
template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API MouseInteractor<defaulttype::Vec2Types>;
template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API MouseInteractor<defaulttype::Vec3Types>;
template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API MouseInteractor<defaulttype::Rigid3Types>;
