...
class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API SuturePointPerformer: public TInteractionPerformer<DataTypes>, public SuturePointPerformerConfiguration
{
public:
...
extern template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API  SuturePointPerformer<defaulttype::Vec3Types>;
