...
extern template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API  AttachBodyPerformer<defaulttype::Vec2Types>;
extern template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API  AttachBodyPerformer<defaulttype::Vec3Types>;
