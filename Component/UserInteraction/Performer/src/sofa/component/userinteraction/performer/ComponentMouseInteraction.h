...
class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API ComponentMouseInteraction
{
public:
...
extern template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API TComponentMouseInteraction<defaulttype::Vec2Types>;
extern template class SOFA_COMPONENT_USERINTERACTION_PERFORMER_API TComponentMouseInteraction<defaulttype::Vec3Types>;
