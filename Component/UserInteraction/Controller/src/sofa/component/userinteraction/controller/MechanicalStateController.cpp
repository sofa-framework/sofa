...
template class SOFA_COMPONENT_USERINTERACTION_CONTROLLER_API MechanicalStateController<Vec1Types>;
template class SOFA_COMPONENT_USERINTERACTION_CONTROLLER_API MechanicalStateController<Rigid3Types>;
