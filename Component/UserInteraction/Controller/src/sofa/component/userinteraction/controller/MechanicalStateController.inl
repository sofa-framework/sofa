...
template <>
SOFA_COMPONENT_USERINTERACTION_CONTROLLER_API void MechanicalStateController<defaulttype::Vec1Types>::applyController();

template <>
SOFA_COMPONENT_USERINTERACTION_CONTROLLER_API void MechanicalStateController<defaulttype::Vec1Types>::onMouseEvent(core::objectmodel::MouseEvent *mev);

template <>
SOFA_COMPONENT_USERINTERACTION_CONTROLLER_API void MechanicalStateController<defaulttype::Rigid3Types>::onMouseEvent(core::objectmodel::MouseEvent *mev);
