...
OPTS="-i seqlist -x imlist,null -H 0 -g $RES  -w ${5:-1000} -y ffmpeg,null -F mpeg4 -f ${2:-30} -w ${5:-1000}"
...
echo transcode $OPTS -o ${1:-video-mpeg4.avi} $6
transcode $OPTS -o ${1:-video-mpeg4.avi} $6
ls -l ${1:-video-mpeg4.avi}
