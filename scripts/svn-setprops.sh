...
find $* '(' -name '*.c' -o -name '*.cpp' -o -name '*.cu' -o -name '*.cxx'  -o -name '*.h' -o -name '*.hpp' -o -name '*.inl' -o -name '*.cuh' -o -name '*.txt' -o -name '*.pro' -o -name '*.pri' -o -name '*.cfg' -o -name '*.scn' -o -name '*.xml' -o -name '*.pscn' ')' -exec svn propset svn:eol-style native '{}' ';'
