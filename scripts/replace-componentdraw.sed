...
s/\(void[[:blank:]]\)\([[:blank:]]*\)\(draw[[:blank:]]*\)(\([[:blank:]]*\)\([[:graph:]][[:graph:]]*\)\(.*\))\([[:blank:]]*\);\([[:blank:]]*\)$/\1\2\3(const core::visual::VisualParams*,\5\6);/g
# void draw() --> void draw(const core::visual::VisualParams* vparams)
s/\(void[[:blank:]]\)\([[:blank:]]*\)\(draw[[:blank:]]*\)(\([[:blank:]]*\))\([[:blank:]]*\);\([[:blank:]]*\)$/\1\2\3(const core::visual::VisualParams*);/g

#void Component::draw() --> void Component::draw(const core::visual::VisualParams* vparams)
#void BarycentricMapperMeshTopology<In,Out>::draw(const typename Out::VecCoord& out, const typename In::VecCoord& in ) 
...
s/\(void[[:blank:]][[:blank:]]*\)\([[:graph:]][[:print:]]*\)\(::draw[[:blank:]]*\)(\([[:blank:]]*\)\([[:graph:]][[:graph:]]*\)\(.*\))\([[:blank:]]*\)$/\1\2\3\4(const core::visual::VisualParams* vparams,\5\6\7)/g
s/\(void[[:blank:]][[:blank:]]*\)\([[:graph:]][[:print:]]*\)\(::draw[[:blank:]]*\)(\([[:blank:]]*\))\([[:blank:]]*\)$/\1\2\3\4(const core::visual::VisualParams* vparams)/g
s/\(void[[:blank:]][[:blank:]]*\)\([[:graph:]][[:print:]]*\)\(::draw[[:blank:]]*\)(\([[:blank:]]*\)\([[:graph:]][[:graph:]]*\)\(.*\))\([[:blank:]]*\);\([[:blank:]]*\)$/\1\2\3\4(const core::visual::VisualParams* vparams,\5\6\7);/g
s/\(void[[:blank:]][[:blank:]]*\)\([[:graph:]][[:print:]]*\)\(::draw[[:blank:]]*\)(\([[:blank:]]*\))\([[:blank:]]*\);\([[:blank:]]*\)$/\1\2\3\4(const core::visual::VisualParams* vparams);/g
