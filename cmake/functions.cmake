		...
		if(IS_DIRECTORY ${dependencyDir})
			...
			if(NOT dependencyToUpperName STREQUAL "DEPRECATED")
				if(NOT RECURSIVE) # treat the CMakeLists.txt like a Solution
					...
					file(GLOB_RECURSE dependencyPathes "${dependencyDir}/*CMakeLists.txt") # WARNING: this wildcard expression can catch "example/badCMakeLists.txt" but we need it to catch all subdirs
					if(NOT dependencyPathes STREQUAL "")
						...
						foreach(dependencyPath ${dependencyPathes})
                            ...
                            RegisterProjects(${dependencyProjectName} OPTION "${optionName}" COMPILE_DEFINITIONS "${definitionPrefix}${dependencyToUpperName}" PATH "${dependencyFolder}")
						endforeach()
					endif()
				endif()
			endif()
