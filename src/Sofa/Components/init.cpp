...
SOFA_LINK_CLASS(TriangleLineLagrangianMultiplierContact)
SOFA_LINK_CLASS(TriangleLinePenalityContact)
SOFA_LINK_CLASS(TrianglePenalityContact)
SOFA_LINK_CLASS(TriangleSphereLagrangianMultiplierContact)
SOFA_LINK_CLASS(TriangleSpherePenalityContact)
