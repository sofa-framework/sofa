#ifndef SOFA_COMPONENTS_WRITESTATE_INL
#define SOFA_COMPONENTS_WRITESTATE_INL
...
WriteState<DataTypes>::WriteState(Core::MechanicalModel<DataTypes>*)
...
template<class DataTypes>
void WriteState<DataTypes>::handleEvent(Sofa::Abstract::Event* event)
{
