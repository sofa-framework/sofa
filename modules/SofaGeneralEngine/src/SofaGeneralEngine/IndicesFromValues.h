...
extern template class SOFA_SOFAGENERALENGINE_API IndicesFromValues< type::stdtype::fixed_array<unsigned int, 2> >;
extern template class SOFA_SOFAGENERALENGINE_API IndicesFromValues< type::stdtype::fixed_array<unsigned int, 3> >;
extern template class SOFA_SOFAGENERALENGINE_API IndicesFromValues< type::stdtype::fixed_array<unsigned int, 4> >;
extern template class SOFA_SOFAGENERALENGINE_API IndicesFromValues< type::stdtype::fixed_array<unsigned int, 8> >;
