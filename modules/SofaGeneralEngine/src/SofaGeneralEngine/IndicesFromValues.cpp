...
int IndicesFromValuesClass = core::RegisterObject("Find the indices of a list of values within a larger set of values")
        ...
        .add< IndicesFromValues< type::stdtype::fixed_array<unsigned int, 2> > >()
        .add< IndicesFromValues< type::stdtype::fixed_array<unsigned int, 3> > >()
        .add< IndicesFromValues< type::stdtype::fixed_array<unsigned int, 4> > >()
        .add< IndicesFromValues< type::stdtype::fixed_array<unsigned int, 8> > >()
...
template class SOFA_SOFAGENERALENGINE_API IndicesFromValues< type::stdtype::fixed_array<unsigned int, 2> >;
template class SOFA_SOFAGENERALENGINE_API IndicesFromValues< type::stdtype::fixed_array<unsigned int, 3> >;
template class SOFA_SOFAGENERALENGINE_API IndicesFromValues< type::stdtype::fixed_array<unsigned int, 4> >;
template class SOFA_SOFAGENERALENGINE_API IndicesFromValues< type::stdtype::fixed_array<unsigned int, 8> >;
