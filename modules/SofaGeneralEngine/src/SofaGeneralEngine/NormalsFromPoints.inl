...
void NormalsFromPoints<DataTypes>::doUpdate()
{
    ...
    helper::ReadAccessor<Data< helper::vector< type::stdtype::fixed_array <unsigned int,3> > > > raTriangles = triangles;
    helper::ReadAccessor<Data< helper::vector< type::stdtype::fixed_array <unsigned int,4> > > > raQuads = quads;
