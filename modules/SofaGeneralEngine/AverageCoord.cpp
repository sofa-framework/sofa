...
template class AverageCoord<Vec2Types>;
template class AverageCoord<Rigid2Types>;
template class AverageCoord<Vec3Types>;
template class AverageCoord<Rigid3Types>;
