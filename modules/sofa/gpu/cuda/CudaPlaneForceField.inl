...
template <>
void PlaneForceField<gpu::cuda::CudaVec3dTypes>::addDForce(VecDeriv& df, const VecCoord& dx)
{
    df.resize(dx.size());
...
template <>
void PlaneForceField<gpu::cuda::CudaVec3d1Types>::addDForce(VecDeriv& df, const VecCoord& dx)
{
    df.resize(dx.size());
