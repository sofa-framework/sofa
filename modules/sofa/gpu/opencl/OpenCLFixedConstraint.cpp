...
#ifdef SOFA_DEV
void FixedConstraintOpenCLRigid3f_projectResponseContiguous(unsigned int /*size*/, _device_pointer /*dx*/) {DEBUG_TEXT("no implemented"); exit(0);}
void FixedConstraintOpenCLRigid3f_projectResponseIndexed(unsigned int /*size*/, const _device_pointer /*indice*/, _device_pointer /*dx*/) {DEBUG_TEXT("no implemented"); exit(0);}
#endif // SOFA_DEV
...
#ifdef SOFA_DEV
void FixedConstraintOpenCLRigid3d_projectResponseContiguous(unsigned int /*size*/, _device_pointer /*dx*/) {DEBUG_TEXT("no implemented"); exit(0);}
void FixedConstraintOpenCLRigid3d_projectResponseIndexed(unsigned int /*size*/, const _device_pointer /*indice*/, _device_pointer /*dx*/) {DEBUG_TEXT("no implemented"); exit(0);}
#endif // SOFA_DEV
