...
******************************************************************************/
#define SOFA_COMPONENT_CONSTRAINT_BILATERALINTERACTIONCONSTRAINT_CPP
...
template <>
void BilateralInteractionConstraint<Rigid3dTypes>::applyConstraint(unsigned int &constraintId)
{
    SparseVecDeriv svd1;
    SparseVecDeriv svd2;
...
#ifndef SOFA_DOUBLE
template <>
void BilateralInteractionConstraint<Rigid3fTypes>::applyConstraint(unsigned int &constraintId)
{
    SparseVecDeriv svd1;
    SparseVecDeriv svd2;
...
#ifndef SOFA_FLOAT
template class SOFA_COMPONENT_CONSTRAINT_API BilateralInteractionConstraint<Vec3dTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API BilateralInteractionConstraint<Rigid3dTypes>;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_COMPONENT_CONSTRAINT_API BilateralInteractionConstraint<Vec3fTypes>;
template class SOFA_COMPONENT_CONSTRAINT_API BilateralInteractionConstraint<Rigid3fTypes>;
#endif
