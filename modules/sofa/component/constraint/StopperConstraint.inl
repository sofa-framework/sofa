...
******************************************************************************/
#ifndef SOFA_COMPONENT_CONSTRAINT_STOPPERCONSTRAINT_INL
#define SOFA_COMPONENT_CONSTRAINT_STOPPERCONSTRAINT_INL

#include <sofa/component/constraint/StopperConstraint.h>
...
template<class DataTypes>
void StopperConstraint<DataTypes>::applyConstraint(unsigned int &constraintId)
{
    int tm;
    Coord cx = Coord(1.0);
