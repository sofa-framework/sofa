...
#ifdef SOFA_BUILD_BASE_MASTER_SOLVER
#  define SOFA_BASE_MASTER_SOLVER_API SOFA_EXPORT_DYNAMIC_LIBRARY
#else
#  define SOFA_BASE_MASTER_SOLVER_API SOFA_IMPORT_DYNAMIC_LIBRARY
#endif
