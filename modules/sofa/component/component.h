...
#ifdef SOFA_BUILD_COMPONENT_FEM_INTERPOLATION
#  define SOFA_COMPONENT_FEM_INTERPOLATION_API SOFA_EXPORT_DYNAMIC_LIBRARY
#else
#  define SOFA_COMPONENT_FEM_INTERPOLATION_API SOFA_IMPORT_DYNAMIC_LIBRARY
#endif
