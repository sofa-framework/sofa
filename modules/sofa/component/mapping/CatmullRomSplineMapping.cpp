...
#ifndef SOFA_FLOAT
template class SOFA_COMPONENT_MAPPING_API CatmullRomSplineMapping< Vec3dTypes, Vec3dTypes >;
template class SOFA_COMPONENT_MAPPING_API CatmullRomSplineMapping< Vec3dTypes, ExtVec3fTypes >;
#endif
#ifndef SOFA_DOUBLE
template class SOFA_COMPONENT_MAPPING_API CatmullRomSplineMapping< Vec3fTypes, Vec3fTypes >;
template class SOFA_COMPONENT_MAPPING_API CatmullRomSplineMapping< Vec3fTypes, ExtVec3fTypes >;
#endif
#ifndef SOFA_FLOAT
#ifndef SOFA_DOUBLE
template class SOFA_COMPONENT_MAPPING_API CatmullRomSplineMapping< Vec3dTypes, Vec3fTypes >;
template class SOFA_COMPONENT_MAPPING_API CatmullRomSplineMapping< Vec3fTypes, Vec3dTypes >;
#endif
#endif
