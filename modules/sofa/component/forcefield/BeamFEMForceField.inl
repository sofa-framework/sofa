...
#if 0
template<class DataTypes>
void BeamFEMForceField<DataTypes>::contributeToMatrixDimension(unsigned int * const nbRow, unsigned int * const nbCol)
{
    if (this->mstate)
    {
...
template<class DataTypes>
void BeamFEMForceField<DataTypes>::computeMatrix(sofa::defaulttype::SofaBaseMatrix *mat, double /*m*/, double /*b*/, double /*k*/, unsigned int &offset)
{
...
template<class DataTypes>
void BeamFEMForceField<DataTypes>::computeVector(sofa::defaulttype::SofaBaseVector *vect, unsigned int &offset)
{
...
template<class DataTypes>
void BeamFEMForceField<DataTypes>::matResUpdatePosition(sofa::defaulttype::SofaBaseVector *vect, unsigned int &offset)
{
