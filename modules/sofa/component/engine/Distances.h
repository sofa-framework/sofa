...
#ifndef SOFA_FLOAT
template class SOFA_COMPONENT_ENGINE_API Distances<defaulttype::Vec3dTypes>;
template class SOFA_COMPONENT_ENGINE_API Distances<defaulttype::Rigid3dTypes>;
#endif //SOFA_FLOAT
#ifndef SOFA_DOUBLE
template class SOFA_COMPONENT_ENGINE_API Distances<defaulttype::Vec3fTypes>;
template class SOFA_COMPONENT_ENGINE_API Distances<defaulttype::Rigid3fTypes>;
#endif //SOFA_DOUBLE
#endif
