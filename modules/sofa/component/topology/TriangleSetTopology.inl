...
template<class DataTypes>
TriangleSetTopology<DataTypes>::TriangleSetTopology(MechanicalObject<DataTypes> *obj) : EdgeSetTopology<DataTypes>( obj),f_m_topologyContainer(new Field< TriangleSetTopologyContainer >(new TriangleSetTopologyContainer(this), "Triangle Container"))
