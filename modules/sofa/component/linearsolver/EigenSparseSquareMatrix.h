...
template<>
class EigenSparseSquareMatrix<double> : public defaulttype::BaseMatrix
{
...
public:
    typedef helper::vector<Real> VecDeriv;
    ...
    EigenSparseSquareMatrix(const Matrix& m)
    {
        eigenMatrix = m;
    }
    ...
    friend std::ostream& operator << (std::ostream& out, const EigenSparseSquareMatrix<Real>& v )
    {
        int nx = v.colSize();
        int ny = v.rowSize();
        out << "[";
...
//    template<> inline const char* EigenSparseSquareMatrix<double>::Name() { return "EigenSparseSquareMatrixd"; }
...
template<>
class EigenSparseSquareMatrix<float> : public defaulttype::BaseMatrix
{
...
//    template<> inline const char* EigenSparseSquareMatrix<float>::Name() { return "EigenSparseSquareMatrixd"; }
