...
MeshTetraStuffing::MeshTetraStuffing()
    ...
    , alphaLong(initData(&alphaLong,0.24999,"alphaLong","Minimum alpha values on long edges when snapping points"))
    , alphaShort(initData(&alphaShort,0.42978,"alphaShort","Minimum alpha values on short edges when snapping points"))
