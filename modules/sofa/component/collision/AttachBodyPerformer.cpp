...
bool AttachBodyPerformer<defaulttype::Rigid3fTypes>::start_partial(const BodyPicked& picked)
{
    ...
    if( !mstateCollision ) mstateCollision = static_cast< core::behavior::MechanicalState<Rigid3fTypes>* >( picked.body->getContext()->getMechanicalState() );
...
bool AttachBodyPerformer<defaulttype::Rigid3dTypes>::start_partial(const BodyPicked& picked)
{
    ...
    if( !mstateCollision ) mstateCollision = static_cast< core::behavior::MechanicalState<Rigid3dTypes>* >( picked.body->getContext()->getMechanicalState() );
