...
int MeshIntTool::computeIntersection(TSphere<DataTypes> & e1, Point& e2,double alarmDist,double contactDist, OutputVector* contacts){
    ...
    detection->point[0] = P + e1.r() * detection->normal;
...
template <class TReal>
int MeshIntTool::computeIntersection(TSphere<StdVectorTypes<Vec<3,TReal>,Vec<3,TReal>,TReal> > & e1, Point& e2,double alarmDist,double contactDist, OutputVector* contacts){
    const double myAlarmDist = alarmDist + e1.r();
...
int MeshIntTool::computeIntersection(Line& e2, TSphere<DataTypes>& e1,double alarmDist,double contactDist, OutputVector* contacts){
    ...
    detection->point[1]=P - e1.r() * detection->normal;
    detection->value -= myContactDist;
    return 1;
}
...
template <class TReal>
int MeshIntTool::computeIntersection(Line& e2, TSphere<StdVectorTypes<Vec<3,TReal>,Vec<3,TReal>,TReal> >& e1,double alarmDist,double contactDist, OutputVector* contacts){
    const double myAlarmDist = alarmDist + e1.r();
...
int MeshIntTool::computeIntersection(Triangle& tri, TSphere<DataTypes>& sph,double alarmDist,double contactDist, OutputVector* contacts){
    ...
    if(projectPointOnTriangle(tri.flags(),tri.p1(),tri.p2(),tri.p3(),proj_p)){
        ...
        detection->value = detection->normal.norm();
        detection->normal /= detection->value;
        detection->point[1] = sph_center - sph.r() * detection->normal;
...
template <class TReal>
int MeshIntTool::computeIntersection(Triangle& tri, TSphere<StdVectorTypes<Vec<3,TReal>,Vec<3,TReal>,TReal> >& sph,double alarmDist,double contactDist, OutputVector* contacts){
    const Vector3 sph_center = sph.p();
    Vector3 proj_p = sph_center;
    if(projectPointOnTriangle(tri.flags(),tri.p1(),tri.p2(),tri.p3(),proj_p)){
