...
typedef  sofa::component::mapping::BeamBsplineMapping< sofa::defaulttype::StdRigidTypes<3,double>, sofa::defaulttype::StdVectorTypes< sofa::defaulttype::Vec<3,float>, sofa::defaulttype::Vec<3,float>,float> > BeamBsplineMappingRigid3d_to_3f;
typedef  sofa::component::mapping::BeamBsplineMapping< sofa::defaulttype::StdRigidTypes<3,float>, sofa::defaulttype::StdVectorTypes< sofa::defaulttype::Vec<3,double>, sofa::defaulttype::Vec<3,double>,double> > BeamBsplineMappingRigid3f_to_3d;
...
typedef  sofa::component::mapping::CircumcenterMapping< sofa::defaulttype::StdVectorTypes< sofa::defaulttype::Vec<3,double>, sofa::defaulttype::Vec<3,double>,double>, sofa::defaulttype::StdVectorTypes< sofa::defaulttype::Vec<3,float>, sofa::defaulttype::Vec<3,float>,float> > CircumcenterMapping3d_to_3f;
typedef  sofa::component::mapping::CircumcenterMapping< sofa::defaulttype::StdVectorTypes< sofa::defaulttype::Vec<3,float>, sofa::defaulttype::Vec<3,float>,float>, sofa::defaulttype::StdVectorTypes< sofa::defaulttype::Vec<3,double>, sofa::defaulttype::Vec<3,double>,double> > CircumcenterMapping3f_to_3d;
...
typedef  sofa::component::mapping::DiscreteBeamBsplineMapping< sofa::defaulttype::StdRigidTypes<3,double>, sofa::defaulttype::StdVectorTypes< sofa::defaulttype::Vec<3,float>, sofa::defaulttype::Vec<3,float>,float> > DiscreteBeamBsplineMappingRigid3d_to_3f;
typedef  sofa::component::mapping::DiscreteBeamBsplineMapping< sofa::defaulttype::StdRigidTypes<3,float>, sofa::defaulttype::StdVectorTypes< sofa::defaulttype::Vec<3,double>, sofa::defaulttype::Vec<3,double>,double> > DiscreteBeamBsplineMappingRigid3f_to_3d;
