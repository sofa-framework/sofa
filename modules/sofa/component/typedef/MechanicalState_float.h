...
typedef sofa::component::container::MechanicalObject<sofa::gpu::cuda::CudaVectorTypes<sofa::defaulttype::Vec<2, float>, sofa::defaulttype::Vec<2, float>, float> > MechanicalObjectCuda2f;
...
typedef MechanicalObjectCuda2f MechanicalObjectCuda2;
