...
*/
class SOFA_LOADER_API SceneColladaLoader : public sofa::core::loader::SceneLoader
{
public:
    ...
    struct BoneInfo
    {
    	...
    	aiNode*		mAiNode;
    	GNode::SPtr mGNode;
    	aiMatrix4x4	mParentWorldOffset;
    	aiMatrix4x4	mLocalOffset;

    	BoneInfo(int pParentIndex, aiNode* pAiNode, GNode::SPtr pGNode, const aiMatrix4x4& pParentWorldOffset = aiMatrix4x4()) :
    	mParentIndex(pParentIndex),
    	mIndex(0),
    	mChildIndex(0),
    	mAiNode(pAiNode),
    	mGNode(pGNode),
    	mParentWorldOffset(pParentWorldOffset),
    	mLocalOffset()
    	{
    		if(mAiNode)
    			mLocalOffset = mAiNode->mTransformation;
    	}
    };*/
