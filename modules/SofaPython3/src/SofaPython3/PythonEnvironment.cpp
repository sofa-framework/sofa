...
*/
        ...
        PyRun_SimpleString("import SofaPython3");
...
//        if( !script ) {
//            msg_error("SofaPython3") << "cannot open file:" << filename;
//            PyErr_Print();
//            return false;
//        }
...
//        {
//            PyObject* __tmpfile__ = PyBytes_FromString(filename.c_str());
...
//        if(error) {
//            msg_error("SofaPython3") << "Script (file:" << basename << ") import error";
//            PyErr_Print();
//            return false;
//        }
