...
void TTriangleModel<DataTypes>::updateFromTopology()
{
    ...
    else
    {
        ...
        {
            core::topology::BaseMeshTopology::BaseMeshTopology::Triangle idx = _topology->getTriangle(i);
        ...
        {
            core::topology::BaseMeshTopology::BaseMeshTopology::Quad idx = _topology->getQuad(i);
