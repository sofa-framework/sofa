...
void initSofaMiscFem()
{
    ...
    if (first)
    {
        // msg_deprecated("SofaMiscFem") << "SofaMiscFem is deprecated. It will be removed at v23.06. Use Sofa.Component.SolidMechanics.FEM.Elastic and/or Sofa.Component.SolidMechanics.FEM.HyperElastic instead.";
