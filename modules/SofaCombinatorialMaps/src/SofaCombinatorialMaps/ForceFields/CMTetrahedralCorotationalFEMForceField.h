...
******************************************************************************/
#ifndef SOFACOMBINATORIALMAPS_FORCEFIELD_CMTETRAHEDRALCOROTATIONALFEMFORCEFIELD_H_
#define SOFACOMBINATORIALMAPS_FORCEFIELD_CMTETRAHEDRALCOROTATIONALFEMFORCEFIELD_H_
...
class SOFA_COMBINATORIALMAPS_API CMTetrahedralCorotationalFEMForceField : public core::behavior::ForceField<DataTypes>
{
public:
	...
	using BaseVolume = core::topology::CMapTopology::Volume;
...
public:
	class TetrahedronHandler : public cm_topology::TopologyDataHandler<core::topology::CMapTopology::Volume, TetrahedronInformation>
	{
	public :
		...
		TetrahedronHandler(CMTetrahedralCorotationalFEMForceField<DataTypes>* forcefield,
			...
			: cm_topology::TopologyDataHandler<core::topology::CMapTopology::Volume, TetrahedronInformation>(data)
			,ff(forcefield)
		{

		}

		void applyCreateFunction(TetrahedronInformation &t, core::topology::CMapTopology::Volume,
...
#endif // SOFACOMBINATORIALMAPS_FORCEFIELD_CMTETRAHEDRALCOROTATIONALFEMFORCEFIELD_H_
