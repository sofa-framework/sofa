...
******************************************************************************/
#ifndef SOFACOMBINATORIALMAPS_FORCEFIELD_CMHEXAHEDRONFEMFORCEFIELD_H_
#define SOFACOMBINATORIALMAPS_FORCEFIELD_CMHEXAHEDRONFEMFORCEFIELD_H_
...
*/
template<class DataTypes>
class SOFA_COMBINATORIALMAPS_API CMHexahedronFEMForceField : virtual public core::behavior::ForceField<DataTypes>, public sofa::core::behavior::BaseRotationFinder
{
public:
...
public:
	...
	{
		//core::topology::CMapTopology::HexahedraAroundVertex liste_hexa = _mesh->getHexahedraAroundVertex(nodeIdx);
...
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_COMBINATORIALMAPS_API CMHexahedronFEMForceField<defaulttype::Vec3fTypes>;
#endif
...
#endif // SOFACOMBINATORIALMAPS_FORCEFIELD_CMHEXAHEDRONFEMFORCEFIELD_H_
