...
******************************************************************************/
#ifndef SOFACOMBINATORIALMAPS_BASETOPOLOGY_CMAPTRIANGLESETTOPOLOGYCONTAINER_H_
#define SOFACOMBINATORIALMAPS_BASETOPOLOGY_CMAPTRIANGLESETTOPOLOGYCONTAINER_H_
...
class SOFA_COMBINATORIALMAPS_API CMapTriangleSetTopologyContainer : public TriangleSetTopologyContainer
{
    friend class TriangleSetTopologyModifier;
public:
	SOFA_CLASS(CMapTriangleSetTopologyContainer,TriangleSetTopologyContainer);
	template<typename T>
	...
	CMapTriangleSetTopologyContainer();
	virtual ~CMapTriangleSetTopologyContainer() override;
...
#endif // SOFACOMBINATORIALMAPS_BASETOPOLOGY_CMAPTRIANGLESETTOPOLOGYCONTAINER_H_
