...
******************************************************************************/
#ifndef SOFACOMBINATORIALMAPS_BASETOPOLOGY_TOPOLOGYDATA_INL_
#define SOFACOMBINATORIALMAPS_BASETOPOLOGY_TOPOLOGYDATA_INL_

#include <SofaCombinatorialMaps/BaseTopology/CMTopologyData.h>
#include <SofaCombinatorialMaps/BaseTopology/CMTopologyEngine.inl>
#include <SofaCombinatorialMaps/BaseTopology/CMTopologyDataHandler.inl>
...
template <typename TopologyElementType, typename VecT>
void TopologyDataImpl <TopologyElementType, VecT>::createTopologicalEngine(sofa::core::topology::CMapTopology *_topology, sofa::component::cm_topology::TopologyDataHandler<TopologyElementType,VecT>* _topologyHandler, bool deleteHandler)
{
...
template <typename TopologyElementType, typename VecT>
void TopologyDataImpl <TopologyElementType, VecT>::createTopologicalEngine(sofa::core::topology::CMapTopology *_topology)
{
...
#endif // SOFACOMBINATORIALMAPS_BASETOPOLOGY_TOPOLOGYDATA_INL_
