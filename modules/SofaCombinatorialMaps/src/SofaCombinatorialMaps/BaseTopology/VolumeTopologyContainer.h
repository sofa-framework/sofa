...
******************************************************************************/
#ifndef SOFACOMBINATORIALMAPS_BASETOPOLOGY_VOLUMETOPOLOGYCONTAINER_H_
#define SOFACOMBINATORIALMAPS_BASETOPOLOGY_VOLUMETOPOLOGYCONTAINER_H_
...
class SOFA_COMBINATORIALMAPS_API VolumeTopologyContainer : public core::topology::CMapTopology
{
	friend class VolumeTopologyModifier;
	public:

	SOFA_CLASS(VolumeTopologyContainer, core::topology::CMapTopology);
...
#endif // SOFACOMBINATORIALMAPS_BASETOPOLOGY_VOLUMETOPOLOGYCONTAINER_H_
