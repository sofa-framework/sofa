...
******************************************************************************/
#ifndef SOFACOMBINATORIALMAPS_BASETOPOLOGY_CMAPTETRAHEDRONSETTOPOLOGYCONTAINER_H_
#define SOFACOMBINATORIALMAPS_BASETOPOLOGY_CMAPTETRAHEDRONSETTOPOLOGYCONTAINER_H_
...
class SOFA_COMBINATORIALMAPS_API CMapTetrahedronSetTopologyContainer : public TetrahedronSetTopologyContainer
{
	friend class TriangleSetTopologyModifier;
public:
	SOFA_CLASS(CMapTetrahedronSetTopologyContainer,TetrahedronSetTopologyContainer);
	template<typename T>
	...
	CMapTetrahedronSetTopologyContainer();
	virtual ~CMapTetrahedronSetTopologyContainer() override;
...
#endif // SOFACOMBINATORIALMAPS_BASETOPOLOGY_CMAPTETRAHEDRONSETTOPOLOGYCONTAINER_H_
