...
******************************************************************************/
#ifndef SOFACOMBINATORIALMAPS_BASETOPOLOGY_VOLUMETOPOLOGYMODIFIER_H_
#define SOFACOMBINATORIALMAPS_BASETOPOLOGY_VOLUMETOPOLOGYMODIFIER_H_
...
*/
class SOFA_COMBINATORIALMAPS_API VolumeTopologyModifier : public sofa::core::cm_topology::TopologyModifier
{
public:
	using Map = VolumeTopologyContainer::Map;
	using BaseVertex = core::topology::CMapTopology::Vertex;
	using BaseEdge = core::topology::CMapTopology::Edge;
	using BaseFace = core::topology::CMapTopology::Face;
...
#endif // SOFACOMBINATORIALMAPS_BASETOPOLOGY_VOLUMETOPOLOGYMODIFIER_H_
