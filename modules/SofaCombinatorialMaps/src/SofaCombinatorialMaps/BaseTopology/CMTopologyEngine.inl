...
#include <SofaCombinatorialMaps/BaseTopology/CMTopologyEngine.h>
...
TopologyEngineImpl< VecT>::TopologyEngineImpl(t_topologicalData *_topologicalData,
        core::topology::CMapTopology* _topology,
...
void TopologyEngineImpl< VecT>::doUpdate()
{
	...
	sout << "TopologyEngine::doUpdate" << sendl;
...
template <typename VecT>
void TopologyEngineImpl< VecT>::registerTopology(core::topology::CMapTopology* _topology)
{
    m_topology =  _topology;
