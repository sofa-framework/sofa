...
******************************************************************************/
#ifndef SOFACOMBINATORIALMAPS_BASETOPOLOGY_CMAPHEXAHEDRONSETTOPOLOGYCONTAINER_H_
#define SOFACOMBINATORIALMAPS_BASETOPOLOGY_CMAPHEXAHEDRONSETTOPOLOGYCONTAINER_H_
#include <SofaCombinatorialMaps/config.h>

#include <SofaBaseTopology/HexahedronSetTopologyContainer.h>
#include <SofaCombinatorialMaps/BaseTopology/VolumeTopologyContainer.h>
...
class SOFA_COMBINATORIALMAPS_API CMapHexahedronSetTopologyContainer : public HexahedronSetTopologyContainer
{
	friend class QuadSetTopologyModifier;
public:
	SOFA_CLASS(CMapHexahedronSetTopologyContainer,HexahedronSetTopologyContainer);
	template<typename T>
	using Attribute_T = core::topology::CMapTopology::Attribute_T<T>;
	...
	CMapHexahedronSetTopologyContainer();
	virtual ~CMapHexahedronSetTopologyContainer() override;
...
#endif // SOFACOMBINATORIALMAPS_BASETOPOLOGY_CMAPHEXAHEDRONSETTOPOLOGYCONTAINER_H_
