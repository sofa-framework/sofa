...
******************************************************************************/
#ifndef SOFA_COMPONENT_FORCEFIELD_CMTRIANGULARFEMFORCEFIELD_H
#define SOFA_COMPONENT_FORCEFIELD_CMTRIANGULARFEMFORCEFIELD_H
#include "config.h"
...
#include <SofaCombinatorialMaps/CMTopologyData.inl>
...
class CMTriangularFEMForceField : public core::behavior::ForceField<DataTypes>
{
public:
...
#if defined(SOFA_EXTERN_TEMPLATE) && !defined(SOFA_COMPONENT_FORCEFIELD_CMTRIANGULARFEMFORCEFIELD_CPP)

#ifndef SOFA_FLOAT
extern template class SOFA_MISC_FEM_API CMTriangularFEMForceField<defaulttype::Vec3dTypes>;
#endif

#ifndef SOFA_DOUBLE
extern template class SOFA_MISC_FEM_API CMTriangularFEMForceField<defaulttype::Vec3fTypes>;
#endif

#endif // defined(SOFA_EXTERN_TEMPLATE) && !defined(SOFA_COMPONENT_FORCEFIELD_CMTRIANGULARFEMFORCEFIELD_CPP)
...
#endif // SOFA_COMPONENT_FORCEFIELD_CMTRIANGULARFEMFORCEFIELD_H
