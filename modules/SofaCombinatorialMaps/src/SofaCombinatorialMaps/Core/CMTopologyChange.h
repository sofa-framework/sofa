#ifndef SOFACOMBINATORIALMAPS_CORE_CMTOPOLOGYCHANGE_H_
#define SOFACOMBINATORIALMAPS_CORE_CMTOPOLOGYCHANGE_H_
...
{
	TopologyElemID() : type(TopologyObjectType::VERTEX), index(UINT_MAX) {}
...
struct PointAncestorElem
{
	...
	using Vertex = topology::CMapTopology::Vertex;
	...
	TopologyObjectType type;
	topology::CMapTopology::Vertex index;
...
template<>
struct TopologyChangeElementInfo<topology::CMapTopology::Vertex>
{
	enum { USE_EMOVED          = 1 };
...
template<>
struct TopologyChangeElementInfo<topology::CMapTopology::Edge>
{
	enum { USE_EMOVED          = 0 };
...
template<>
struct TopologyChangeElementInfo<topology::CMapTopology::Face>
{
	enum { USE_EMOVED          = 0 };
	enum { USE_EMOVED_REMOVING = 1 };
	enum { USE_EMOVED_ADDING   = 1 };
...
template<>
struct TopologyChangeElementInfo<topology::CMapTopology::Volume>
{
	enum { USE_EMOVED          = 0 };
	enum { USE_EMOVED_REMOVING = 1 };
	enum { USE_EMOVED_ADDING   = 1 };
...
{
public:
	using Dart		= topology::CMapTopology::Dart;
	using Vertex	= topology::CMapTopology::Vertex;
	using Edge		= topology::CMapTopology::Edge;
	using Face		= topology::CMapTopology::Face;
	using Volume	= topology::CMapTopology::Volume;
...
public:
	sofa::helper::vector< Edge > edgesAroundVertexMoved;
	sofa::helper::vector< topology::CMapTopology::Edge > edgeArray2Moved;
};
...
public:
	...
	const topology::CMapTopology::Face &getFace(const unsigned int i)
	{
		return faceArray[i];
	}
...
#endif // SOFACOMBINATORIALMAPS_CORE_CMTOPOLOGYCHANGE_H_
