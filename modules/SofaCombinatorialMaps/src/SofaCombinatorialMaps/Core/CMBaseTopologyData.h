#ifndef SOFACOMBINATORIALMAPS_CORE_CMBASETOPOLOGYDATA_H_
#define SOFACOMBINATORIALMAPS_CORE_CMBASETOPOLOGYDATA_H_
...
template < class T>
class SOFA_COMBINATORIALMAPS_API BaseTopologyData : public sofa::core::objectmodel::Data < topology::CMapTopology::Attribute_T<T> >
{
public:
	using Attribute = topology::CMapTopology::Attribute_T<T>;
	using DataAttribute = sofa::core::objectmodel::Data<Attribute>;
	using index_type = topology::CMapTopology::index_type;
...
#endif // SOFACOMBINATORIALMAPS_CORE_CMBASETOPOLOGYDATA_H_
