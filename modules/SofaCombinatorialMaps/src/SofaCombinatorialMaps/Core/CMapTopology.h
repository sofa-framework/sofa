...
******************************************************************************/
#ifndef SOFACOMBINATORIALMAPS_CORE_CMAPTOPOLOGY_H_
#define SOFACOMBINATORIALMAPS_CORE_CMAPTOPOLOGY_H_
...
class SOFA_COMBINATORIALMAPS_API CMapTopology : public virtual core::objectmodel::BaseObject
{
public:
	SOFA_CLASS(CMapTopology,core::objectmodel::BaseObject);
...
protected:
	...
	SingleLink< CMapTopology, core::State< Vec3Types >, BaseLink::FLAG_STOREPATH | BaseLink::FLAG_STRONGLINK > mech_state_;
...
#endif // SOFACOMBINATORIALMAPS_CORE_CMAPTOPOLOGY_H_
