#ifndef SOFACOMBINATORIALMAPS_CORE_CMTOPOLOGYELEMENTHANDLER_H_
#define SOFACOMBINATORIALMAPS_CORE_CMTOPOLOGYELEMENTHANDLER_H_
...
#endif // SOFACOMBINATORIALMAPS_CORE_CMTOPOLOGYELEMENTHANDLER_H_
