...
public:
    ...
    bool testValidity(Sphere&, const type::Vector3&) { return true; }
    bool testValidity(Point&, const type::Vector3&);
    bool testValidity(Line&, const type::Vector3&);
    bool testValidity(Triangle&, const type::Vector3&);
