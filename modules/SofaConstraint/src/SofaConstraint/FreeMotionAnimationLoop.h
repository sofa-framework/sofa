...
public:
    ...
    Data<bool> d_isParallel; ///<If true, executes free motion and collision detection in parallel
    Data<bool> d_solveODEConcurrently; ///<If true, executes all free motions in parallel
