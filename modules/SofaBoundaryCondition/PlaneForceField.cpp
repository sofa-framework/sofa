...
;
template class PlaneForceField<Vec3Types>;
template class PlaneForceField<Vec2Types>;
template class PlaneForceField<Vec1Types>;
template class PlaneForceField<Vec6Types>;
template class PlaneForceField<Rigid3Types>;
