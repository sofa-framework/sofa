...
protected:
    ...
    void interpolatePosition(Real cT, typename boost::disable_if<std::is_same<MyCoord, defaulttype::RigidCoord<3, Real> >, VecCoord>::type& x);
    template <class MyCoord>
    void interpolatePosition(Real cT, typename boost::enable_if<std::is_same<MyCoord, defaulttype::RigidCoord<3, Real> >, VecCoord>::type& x);
