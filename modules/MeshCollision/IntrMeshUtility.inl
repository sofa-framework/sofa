#include <MeshCollision/IntrMeshUtility.h>
#include <BaseCollision/IntrUtility3.inl>
...
typename IntrUtil<TTriangle<DataType> >::Real IntrUtil<TTriangle<DataType> >::project(Vec<3,Real> & pt,const TTriangle<DataType> & tri){
    Real s,t;
