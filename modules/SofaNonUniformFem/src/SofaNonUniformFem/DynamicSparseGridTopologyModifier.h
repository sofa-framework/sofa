...
public:
    ...
    */
    void removeHexahedraProcess(const sofa::helper::vector<index_type>&indices, const bool removeIsolatedItems = false) override;
    ...
    */
    virtual void renumberAttributes( const sofa::helper::vector<index_type> &hexahedra );
