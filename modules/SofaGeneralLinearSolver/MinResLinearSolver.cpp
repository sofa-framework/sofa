...
template class MinResLinearSolver< GraphScatteredMatrix, GraphScatteredVector >;
template class MinResLinearSolver< FullMatrix<double>, FullVector<double> >;
template class MinResLinearSolver< SparseMatrix<double>, FullVector<double> >;
template class MinResLinearSolver< CompressedRowSparseMatrix<double>, FullVector<double> >;
template class MinResLinearSolver< CompressedRowSparseMatrix<Mat<2,2,double> >, FullVector<double> >;
template class MinResLinearSolver< CompressedRowSparseMatrix<Mat<3,3,double> >, FullVector<double> >;
template class MinResLinearSolver< CompressedRowSparseMatrix<Mat<4,4,double> >, FullVector<double> >;
template class MinResLinearSolver< CompressedRowSparseMatrix<Mat<6,6,double> >, FullVector<double> >;
template class MinResLinearSolver< CompressedRowSparseMatrix<Mat<8,8,double> >, FullVector<double> >;
