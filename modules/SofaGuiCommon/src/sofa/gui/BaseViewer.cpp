...
bool BaseViewer::load()
{
    if (groot)
    {
        ...
        if (!currentCamera)
        {
            ...
            currentCamera->setName(sofa::core::NameHelper::getInstance().resolveName(currentCamera->getClassName(), {}));
        ...
        if (!visualStyle)
        {
            ...
            visualStyle->setName(sofa::core::NameHelper::getInstance().resolveName(visualStyle->getClassName(), {}));
