...
public:
    ...
    virtual void getView(sofa::type::Vector3& pos, sofa::defaulttype::Quat& ori) const;
    virtual void setView(const sofa::type::Vector3& pos, const sofa::defaulttype::Quat &ori);
    virtual void moveView(const sofa::type::Vector3& pos, const sofa::defaulttype::Quat &ori);
