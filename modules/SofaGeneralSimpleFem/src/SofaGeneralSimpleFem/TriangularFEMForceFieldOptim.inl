...
template< class DataTypes>
void TriangularFEMForceFieldOptim<DataTypes>::createTriangleInfo(Index triangleIndex, TriangleInfo& ti, const Triangle& t, const sofa::helper::vector<Index>&, const sofa::helper::vector<double>&)
{
    initTriangleInfo(triangleIndex, ti, t, mstate->read(core::ConstVecCoordId::restPosition())->getValue());
}

template< class DataTypes>
void TriangularFEMForceFieldOptim<DataTypes>::createTriangleState(Index triangleIndex, TriangleState& ti, const Triangle& t, const sofa::helper::vector<Index>&, const sofa::helper::vector<double>&)
{
