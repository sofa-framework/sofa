...
index_type SubsetTopologicalMapping::getFromIndex(index_type ind)
{
    return ind;
}

index_type SubsetTopologicalMapping::getGlobIndex(index_type ind)
{
    if (handleHexahedra.getValue())
    {
...
void SubsetTopologicalMapping::updateTopologicalMappingTopDown()
{
    ...
    while( itBegin != itEnd )
    {
        ...
        case core::topology::POINTSREMOVED:
        {
            ...
            sofa::helper::vector<index_type> tab = pRem->getArray();
            if (samePoints.getValue())
            {
            ...
            {
                sofa::helper::vector<index_type> tab2;
        ...
        case core::topology::POINTSRENUMBERING:
        {
            ...
            const sofa::helper::vector<index_type> &tab = pRenumber->getIndexArray();
            const sofa::helper::vector<index_type> &inv_tab = pRenumber->getinv_IndexArray();
            if (samePoints.getValue())
            {
            ...
            {
                sofa::helper::vector<index_type> tab2;
                sofa::helper::vector<index_type> inv_tab2;
        ...
        case core::topology::EDGESREMOVED:
        {
            ...
            sofa::helper::vector<index_type> tab = eRem->getArray();
        ...
        case core::topology::TRIANGLESREMOVED:
        {
            ...
            sofa::helper::vector<index_type> tab = tRem->getArray();
