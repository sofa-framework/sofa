...
public:
    ...
    void apply (const core::MechanicalParams* /* mparams = core::GetDefaultMechanicalParamsInstance() */, core::MultiVecCoordId /* outPos */, core::ConstMultiVecCoordId /* inPos */) override
    {
    }

    void applyJ(const core::MechanicalParams* /* mparams = core::GetDefaultMechanicalParamsInstance() */, core::MultiVecDerivId /* outVel */, core::ConstMultiVecDerivId /* inVel */) override
    {
    }

    void applyJT(const core::MechanicalParams* /* mparams = core::GetDefaultMechanicalParamsInstance() */, core::MultiVecDerivId /* inForce */, core::ConstMultiVecDerivId /* outForce */) override
    {
    }
    ...
    void computeAccFromMapping(const core::MechanicalParams* /*mparams = core::GetDefaultMechanicalParamsInstance() */, core::MultiVecDerivId /* outAcc */, core::ConstMultiVecDerivId /* inVel */, core::ConstMultiVecDerivId /* inAcc */) override
    {
    }
