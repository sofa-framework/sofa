...
\begin{figure}[htpb]
	\centering
		\includegraphics[width=0.9\textwidth]{GUI/Modeler.png}
...
To quickly test a simple scene, you can use the presets. You can build automatically a deformable object in a grid, or using a tetrahedric mesh, or rigid objects, that can be simulated, or not (floors, or walls are not simulated for instance).
