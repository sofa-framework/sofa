...
\begin{figure}[ht]
    \centering
        \includegraphics[width=0.85\textwidth]{BW_Topology_Family_Tree}
...
\begin{figure}[ht]
    \centering
        \includegraphics[width=0.6\textwidth]{Sub_Shell_Diagram}
...
\begin{figure}[ht]
    \centering
        \includegraphics[width=0.7\textwidth]{Handling_Changes}
...
\begin{figure}[ht]
 \centering
 \includegraphics[width=0.65\linewidth]{Order_Notifications}
...
\begin{figure}[ht]
    \centering
        \includegraphics[width=0.8\textwidth]{7_Steps_Cutting_Algorithm}
...
\begin{figure}[ht]
    \centering
        \includegraphics[width=1.0\textwidth]{Combining_Topologies}
...
\begin{figure*}
 \centering
 \includegraphics[width=1.0\linewidth]{TopoMap_example_1}
...
\begin{figure*}
 \centering
 \includegraphics[width=1.0\linewidth]{TopoMap_example_2}
...
\begin{figure*}
 \centering
 \includegraphics[width=1.0\linewidth]{TopoMap_example_3}
...
\begin{figure*}
 \centering
 \includegraphics[width=1.0\linewidth]{TopoMap_example_4}
...
\begin{figure*}
 \centering
 \includegraphics[width=1.0\linewidth]{TopoMap_example_5}
...
\begin{figure*}
 \centering
 \includegraphics[width=0.9\linewidth]{cylinder_example}
...
<Node name="root" dt="0.05" showBehaviorModels="1" showCollisionModels="0" 
      showMappings="0" showForceFields="0" showBoundingTree="0" gravity="0 0 0">

	<Object type="CollisionPipeline" verbose="0" />
	<Object type="BruteForceDetection" name="N2" />
	<Object type="CollisionResponse" response="default" />
	<Object type="ProximityIntersection" name="Proximity" alarmDistance="0.8" 
	        contactDistance="0.5" />
	...
	<Node name="TT">
		...
		<Object type="TetrahedronSetTopology" name="topo_Volume" 
		        filename="Topology/cylinder.msh" scale="1" />
		...
		<Node name="T">
			...
			<Object type="Tetra2TriangleTopologicalMapping" object1="../../topo_Volume" 
			        object2="topo_Surface"/>
			<Object type="TriangularFEMForceField" name="FEM" youngModulus="10" 
              poissonRatio="0.3" method="large" /> 
			<Object type="TriangularBendingSprings" name="FEM-Bend" stiffness="300" 
			        damping="1.0"/>		    		  
...
void totoForceField<DataTypes>::handleTopologyChange()
{
    ...
    sofa::core::componentmodel::topology::BaseTopology *topology =
static_cast< sofa::core::componentmodel::topology::BaseTopology* >
(getContext()->getMainTopology());

    std::list< const sofa::core::componentmodel::topology::TopologyChange* >
::const_iterator itBegin = topology->firstChange();

    std::list< const sofa::core::componentmodel::topology::TopologyChange*>
::const_iterator itEnd = topology->lastChange();
...
At any time, it is possible to access the topology container (so as to get some neighborhood information) with the following lines of code :

	\begin{verbatim} 
	
EdgeSetTopology<DataTypes> *_mesh = ff->getTriangularTopology();

EdgeSetTopologyContainer *container =
_mesh->getEdgeSetTopologyContainer();
