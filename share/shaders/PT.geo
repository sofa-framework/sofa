/*****************************************************************************
 * PROJECTED TETRAHEDRA: GEOMETRY SHADER
 *	Tetrahedra are represented with GL_LINES_ADJACENCY_EXT
 * 	Inputs:  the coordinates of the vertices in gl_Position[4]
 *		 the scalar field into field[4]
 *	Outputs: gl_Position, the position of the vertices in image space
 *		 dataFragment, information used for the compositing
