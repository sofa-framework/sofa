#ifndef SOFA_COMPONENTS_BARYCENTRICPENALITYCONTACT_H
#define SOFA_COMPONENTS_BARYCENTRICPENALITYCONTACT_H
...
class BarycentricPenalityContact : public Collision::Contact, public Abstract::VisualModel
{
public:
...
protected:
    ...
    PenalityContactForceField<Vec3Types>* ff;
