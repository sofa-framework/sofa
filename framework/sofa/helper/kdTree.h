...
public:
    ...
    void getNClosest(distanceSet &cl, const Coord &x, const VecCoord& positions, const unsigned int n);  ///< get a order set of n distance/index pairs between positions and x
