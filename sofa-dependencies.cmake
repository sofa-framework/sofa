...
RegisterDependencies("eigen" OPTION SOFA-EXTERNAL_HAVE_EIGEN2 COMPILE_DEFINITIONS SOFA_HAVE_EIGEN2 PATH "${SOFA_EXTLIBS_DIR}/eigen-3.2.0")
...
if(WIN32)
	...
	if(CMAKE_CL_64)
		file(GLOB sharedObjects "${SOFA_SRC_DIR}/bin/dll_x64/*.dll")
	else()
