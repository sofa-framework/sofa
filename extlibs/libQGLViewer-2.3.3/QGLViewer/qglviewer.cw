  ...
  <customwidget>
   <class>QGLViewer</class>
    ...
    <pixmap>
     ...
     <slot access="public"> setAddKeyFrameKeyboardModifiers(Qt::KeyboardModifiers modifiers) </slot>
     ...
     <slot access="public"> setHandlerKeyboardModifiers(MouseHandler handler, Qt::KeyboardModifiers modifiers) </slot>
     ...
     <slot access="public"> setMouseBinding(int state, ClickAction action, bool doubleClick, Qt::MouseButtons buttonsBefore) </slot>
     <slot access="public"> setMouseBinding(int state, MouseHandler handler, MouseAction action, bool withConstraint) </slot>
     <slot access="public"> setMouseBindingDescription(int state, QString description, bool doubleClick, Qt::MouseButtons buttonsBefore) </slot>
     ...
     <slot access="public"> setPlayPathKeyboardModifiers(Qt::KeyboardModifiers modifiers) </slot>
     ...
     <slot access="public"> setWheelBinding(Qt::KeyboardModifiers modifiers, MouseHandler handler, MouseAction action, bool withConstraint) </slot>
     <slot access="public"> showEntireScene() </slot>
     <slot access="public"> snapshotToClipboard() </slot>
