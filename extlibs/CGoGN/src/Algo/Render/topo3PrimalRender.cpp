...
Topo3PrimalRender::Topo3PrimalRender():
	m_nbDarts(0),
	m_nbRel2(0),
...
void Topo3PrimalRender::setDartWidth(float dw)
{
	m_topo_dart_width = dw;
}

void Topo3PrimalRender::setRelationWidth(float pw)
{
	m_topo_relation_width = pw;
}

void Topo3PrimalRender::setDartColor(Dart d, float r, float g, float b)
{
	float RGB[6];
...
void Topo3PrimalRender::setAllDartsColor(float r, float g, float b)
{
	m_vbo2->bind();
...
void Topo3PrimalRender::drawRelation2()
{
	if (m_nbRel2==0)
		return;
...
void Topo3PrimalRender::drawTopo()
{
	drawDarts();
	drawRelation2();
}
...
void Topo3PrimalRender::overdrawDart(Dart d, float width, float r, float g, float b)
{
...
void Topo3PrimalRender::pushColors()
{
...
void Topo3PrimalRender::popColors()
{
	m_vbo2->bind();
	void* colorBuffer = glMapBufferARB(GL_ARRAY_BUFFER, GL_READ_WRITE);
...
Dart Topo3PrimalRender::colToDart(float* color)
{
...
void Topo3PrimalRender::dartToCol(Dart d, float& r, float& g, float& b)
{
...
Dart Topo3PrimalRender::pickColor(unsigned int x, unsigned int y)
{
...
void Topo3PrimalRender::svgout2D(const std::string& filename, const glm::mat4& model, const glm::mat4& proj)
{
...
void Topo3PrimalRender::toSVG(Utils::SVG::SVGOut& svg)
{
	// alpha2
