...
******************************************************************************/
#ifndef SOFA_GUI_EDITORVIEWER_QTVIEWER_H
#define SOFA_GUI_EDITORVIEWER_QTVIEWER_H
...
class SOFA_SOFAGUIQT_API EditorViewer :public QGLViewer,   public sofa::gui::qt::viewer::OglModelSofaViewer
{
...
private:
    ...
    bool m_dragging;
    bool m_draginit;
    /** Activation of the navigation throw the resolution levels */
    bool m_navigating;
...
public:
    ...
    static EditorViewer* create(EditorViewer*, sofa::gui::BaseViewerArgument& arg)
    {
        ...
        return viewerArg ?
                new EditorViewer(viewerArg->getParentWidget(), viewerArg->getName().c_str(), viewerArg->getNbMSAASamples() ) :
                new EditorViewer(NULL, pArg->getName().c_str(), pArg->getNbMSAASamples() )
                ;
    }

    static const char* viewerName()  { return "EditorViewer"; }

    static const char* acceleratedName()  { return "&EditorViewer"; }

    virtual void drawColourPicking (ColourPickingVisitor::ColourCode code);

    EditorViewer( QWidget* parent, const char* name="", const unsigned int nbMSAASamples = 1 );
    ~EditorViewer();
