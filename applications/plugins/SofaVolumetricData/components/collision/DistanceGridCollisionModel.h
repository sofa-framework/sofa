...
class SOFA_VOLUMETRICDATA_API RigidDistanceGridCollisionModel;

class SOFA_VOLUMETRICDATA_API RigidDistanceGridCollisionElement : public core::TCollisionElementIterator<RigidDistanceGridCollisionModel>
{
public:
...
class SOFA_VOLUMETRICDATA_API RigidDistanceGridCollisionModel : public core::CollisionModel
{
public:
...
class SOFA_VOLUMETRICDATA_API FFDDistanceGridCollisionModel : public core::CollisionModel
{
public:
    ...
    class SOFA_VOLUMETRICDATA_API DeformedCube
    {
    public:
        DistanceGrid* grid;
...
extern template class SOFA_VOLUMETRICDATA_API ContactMapper<FFDDistanceGridCollisionModel, sofa::defaulttype::Vec3Types>;
extern template class SOFA_VOLUMETRICDATA_API ContactMapper<RigidDistanceGridCollisionModel, sofa::defaulttype::Vec3Types>;

#  ifdef _MSC_VER
// Manual declaration of non-specialized members, to avoid warnings from MSVC.
extern template SOFA_VOLUMETRICDATA_API void BarycentricContactMapper<FFDDistanceGridCollisionModel, defaulttype::Vec3Types>::cleanup();
extern template SOFA_VOLUMETRICDATA_API core::behavior::MechanicalState<defaulttype::Vec3Types>* BarycentricContactMapper<FFDDistanceGridCollisionModel, defaulttype::Vec3Types>::createMapping(const char*);
extern template SOFA_VOLUMETRICDATA_API void RigidContactMapper<RigidDistanceGridCollisionModel, defaulttype::Vec3Types>::cleanup();
extern template SOFA_VOLUMETRICDATA_API core::behavior::MechanicalState<defaulttype::Vec3Types>* RigidContactMapper<RigidDistanceGridCollisionModel, defaulttype::Vec3Types>::createMapping(const char*);
#  endif
#endif
