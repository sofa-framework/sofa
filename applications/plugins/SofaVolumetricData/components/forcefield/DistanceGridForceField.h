...
#ifndef SOFA_FLOAT
extern template class SOFA_VOLUMETRICDATA_API DistanceGridForceField<defaulttype::Vec3dTypes>;
//extern template class SOFA_VOLUMETRICDATA_API DistanceGridForceField<defaulttype::Vec2dTypes>;
//extern template class SOFA_VOLUMETRICDATA_API DistanceGridForceField<defaulttype::Vec1dTypes>;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_VOLUMETRICDATA_API DistanceGridForceField<defaulttype::Vec3fTypes>;
//extern template class SOFA_VOLUMETRICDATA_API DistanceGridForceField<defaulttype::Vec2fTypes>;
//extern template class SOFA_VOLUMETRICDATA_API DistanceGridForceField<defaulttype::Vec1fTypes>;
#endif
#endif
