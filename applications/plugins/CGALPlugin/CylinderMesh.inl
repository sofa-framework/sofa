...
//std::cout << "1/lim = " << 1.0/lim << std::endl;
//    helper::WriteAccessor< Data< VecCoord > > points = m_points;
...
//        {
//            ++count1;
////std::cout << "point[" << i << "]: y=0" << std::endl;
//            continue;
//        }
//        double tg = x/y;
//        if(x > 0 && y > 0 && tg <= lim)
//        {
//std::cout << "point[" << i << "]:<=alpha" << std::endl;
...
//            continue;
//        }
////        if(x > 0 && y > 0 && tg > lim && tg < 1.0/lim)
////        {
//////std::cout << "point[" << i << "]:>alpha < pi/2-alpha" << std::endl;
...
////            continue;
////        }
////        std::cout << "point[" << i << "]:others" << std::endl;
//
...
//
//    }
//    std::cout << "y=0: " << count1 << std::endl;
//    std::cout << "<=alpha: " << count2 << std::endl;
//}
