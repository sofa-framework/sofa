...
namespace sofa
{
	...
	namespace defaulttype
	{
		...
		template<> struct DataTypeName< helper::vector<sofa::type::Vec3d> > { static const char* name() { return "vector<Vec3d>"; } };
        template<> struct DataTypeName< helper::vector<sofa::type::Vec2d> > { static const char* name() { return "vector<Vec2d>"; } };
		template<> struct DataTypeName< helper::vector<double> > { static const char* name() { return "vector<double>"; } };
        template<> struct DataTypeName< helper::vector<sofa::type::Vec3f> > { static const char* name() { return "vector<Vec3f>"; } };
        template<> struct DataTypeName< helper::vector<sofa::type::Vec2f> > { static const char* name() { return "vector<Vec2f>"; } };
...
.add< DataExchange< sofa::helper::vector<sofa::type::Vec3d> > >(true)
.add< DataExchange< sofa::helper::vector<sofa::type::Vec2d> > >()
.add< DataExchange< sofa::helper::vector<double> > >()
.add< DataExchange< sofa::type::Vec3d > >()
.add< DataExchange< double > >()

.add< DataExchange< sofa::helper::vector<sofa::type::Vec3f> > >()
.add< DataExchange< sofa::helper::vector<sofa::type::Vec2f> > >()
...
template class SOFA_MULTITHREADING_PLUGIN_API DataExchange< sofa::helper::vector<sofa::type::Vec3d> >;
template class SOFA_MULTITHREADING_PLUGIN_API DataExchange< sofa::helper::vector<sofa::type::Vec2d> >;
...
template class SOFA_MULTITHREADING_PLUGIN_API DataExchange< sofa::helper::vector<sofa::type::Vec3f> >;
template class SOFA_MULTITHREADING_PLUGIN_API DataExchange< sofa::helper::vector<sofa::type::Vec2f> >;
