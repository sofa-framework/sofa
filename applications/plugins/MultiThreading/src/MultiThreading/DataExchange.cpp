...
namespace sofa
{
	...
	namespace defaulttype
	{
		...
		template<> struct DataTypeName< type::vector<sofa::defaulttype::Vec3d> > { static const char* name() { return "vector<Vec3d>"; } };
		template<> struct DataTypeName< type::vector<sofa::defaulttype::Vec2d> > { static const char* name() { return "vector<Vec2d>"; } };
		...
		template<> struct DataTypeName< type::vector<sofa::defaulttype::Vec2f> > { static const char* name() { return "vector<Vec2f>"; } };
...
.add< DataExchange< sofa::type::vector<sofa::defaulttype::Vec3d> > >(true)
.add< DataExchange< sofa::type::vector<sofa::defaulttype::Vec2d> > >()
...
.add< DataExchange< sofa::type::vector<sofa::defaulttype::Vec2f> > >()
...
template class SOFA_MULTITHREADING_PLUGIN_API DataExchange< sofa::type::vector<sofa::defaulttype::Vec3d> >;
template class SOFA_MULTITHREADING_PLUGIN_API DataExchange< sofa::type::vector<sofa::defaulttype::Vec2d> >;
...
template class SOFA_MULTITHREADING_PLUGIN_API DataExchange< sofa::type::vector<sofa::defaulttype::Vec2f> >;
