...
public:
    ...
    sofa::core::objectmodel::Data<sofa::helper::vector<sofa::type::Vec3f> > trackedMarkers; ///< Position of received known markers
    sofa::core::objectmodel::Data<sofa::helper::vector<sofa::type::Vec3f> > otherMarkers; ///< Position of received unknown markers
...
protected:
    ...
    sofa::type::stdtype::fixed_array<unsigned char,4> serverVersion; // sending app's version [major.minor.build.revision]
    sofa::type::stdtype::fixed_array<unsigned char,4> natNetVersion; // sending app's NatNet version [major.minor.build.revision]
