...
public:
    ...
    virtual void projectResponse(const sofa::core::MechanicalParams* mparams, DataVecDeriv& dx) ///< project dx to constrained space
    {
    ...
    virtual void projectVelocity(const sofa::core::MechanicalParams* /* mparams */, DataVecDeriv& /* v */) ///< project dx to constrained space (dx models a velocity) override
    {
