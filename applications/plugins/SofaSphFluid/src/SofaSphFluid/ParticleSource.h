...
public:
    ...
    class PSPointHandler : public sofa::component::topology::TopologyDataEngine<core::topology::BaseMeshTopology::Point, VecIndex >
    {
    public:
        ...
        PSPointHandler(ParticleSource<DataTypes>* _ps, sofa::component::topology::PointSubsetData<VecIndex >* _data)
            : sofa::component::topology::TopologyDataEngine<core::topology::BaseMeshTopology::Point, VecIndex >(_data), ps(_ps) {}
