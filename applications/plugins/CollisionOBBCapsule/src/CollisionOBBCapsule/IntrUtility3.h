...
extern template struct COLLISIONOBB_API IntrUtil<SReal>;

extern template struct COLLISIONOBB_API IntrUtil<TOBB<defaulttype::Rigid3Types> >;
extern template class COLLISIONOBB_API FindContactSet<TOBB<defaulttype::Rigid3Types> >;
extern template class COLLISIONOBB_API IntrAxis<TOBB<defaulttype::Rigid3Types> >;
extern template class COLLISIONOBB_API IntrConfiguration<SReal>;
extern template struct COLLISIONOBB_API IntrConfigManager<SReal>;
extern template struct COLLISIONOBB_API IntrConfigManager<TOBB<defaulttype::Rigid3Types> >;
extern template COLLISIONOBB_API void ClipConvexPolygonAgainstPlane(const type::Vec3&, SReal, int&,type::Vec3*);
extern template COLLISIONOBB_API type::Vec3 GetPointFromIndex (int, const MyBox<SReal>& );
extern template COLLISIONOBB_API type::Vec<3,defaulttype::Rigid3Types::Real> getPointFromIndex (int, const TOBB<defaulttype::Rigid3Types>& );
extern template class COLLISIONOBB_API CapIntrConfiguration<SReal>;
