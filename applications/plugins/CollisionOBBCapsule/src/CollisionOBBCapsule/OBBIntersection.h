...
#include <CollisionOBB/MeshIntTool.h>
...
class COLLISIONOBB_API RigidDiscreteIntersection : public core::collision::BaseIntersector
{
...
class COLLISIONOBB_API RigidMeshDiscreteIntersection : public core::collision::BaseIntersector
{
    typedef DiscreteIntersection::OutputVector OutputVector;
