...
class COLLISIONOBB_API IntrAxis<TTriangle<TDataTypes1>,TOBB<TDataTypes2> >
{
public:
...
extern template struct COLLISIONOBB_API IntrUtil<TTriangle<defaulttype::Vec3Types> >;
extern template class COLLISIONOBB_API FindContactSet<TTriangle<defaulttype::Vec3Types>,TOBB<defaulttype::Rigid3Types> >;
extern template class COLLISIONOBB_API IntrAxis<TTriangle<defaulttype::Vec3Types>,TOBB<defaulttype::Rigid3Types> >;
extern template struct COLLISIONOBB_API IntrConfigManager<TTriangle<defaulttype::Vec3Types> >;
