...
******************************************************************************/
#pragma once
#include <CollisionOBB/config.h>

#include <sofa/core/collision/Intersection.h>
#include <CollisionOBB/OBBModel.h>
#include <CollisionOBB/CapsuleModel.h>
#include <CollisionOBB/RigidCapsuleModel.h>
#include <SofaMeshCollision/TriangleModel.h>
#include <SofaMeshCollision/PointModel.h>
#include <SofaMeshCollision/LineModel.h>
#include <CollisionOBB/IntrTriangleOBB.h>
...
class COLLISIONOBB_API MeshIntTool
{
public:
    ...
    template <class DataTypes>
    static int doCapPointInt(TCapsule<DataTypes>& cap, const type::Vector3& q,SReal alarmDist,SReal contactDist,OutputVector* contacts);
    ...
    ////!\ CAUTION : uninitialized fields detection->elem and detection->id
    template <class DataTypes>
    static int doCapLineInt(TCapsule<DataTypes>& cap,const type::Vector3 & q1,const type::Vector3 & q2,SReal alarmDist,SReal contactDist,OutputVector* contacts,bool ignore_p1 = false,bool ignore_p2 = false);

    ////!\ CAUTION : uninitialized fields detection->elem and detection->id and detection->value
    static int doCapLineInt(const type::Vector3 & p1,const type::Vector3 & p2,SReal cap_rad,
                         const type::Vector3 & q1, const type::Vector3 & q2,SReal alarmDist,SReal contactDist,OutputVector* contacts,bool ignore_p1 = false,bool ignore_p2 = false);
    ...
    static int doIntersectionTrianglePoint(SReal dist2, int flags, const type::Vector3& p1, const type::Vector3& p2, const type::Vector3& p3,const type::Vector3& q, OutputVector* contacts,bool swapElems = false);
    ...
    static int projectPointOnTriangle(int flags, const type::Vector3& p1, const type::Vector3& p2, const type::Vector3& p3,type::Vector3& to_be_projected);

    //returns barycentric coords in alpha and beta so that to_be_projected = (1 - alpha - beta) * p1 + alpha * p2 + beta * p3
    static void triangleBaryCoords(const type::Vector3& to_be_projected,const type::Vector3& p1, const type::Vector3& p2, const type::Vector3& p3,SReal & alpha,SReal & beta);
};
...
extern template COLLISIONOBB_API int MeshIntTool::computeIntersection(TCapsule<sofa::defaulttype::Vec3Types>& cap, Point& pnt,SReal alarmDist,SReal contactDist,OutputVector* contacts);
extern template COLLISIONOBB_API int MeshIntTool::doCapPointInt(TCapsule<sofa::defaulttype::Vec3Types>& cap, const sofa::type::Vector3& q,SReal alarmDist,SReal contactDist,OutputVector* contacts);
extern template COLLISIONOBB_API int MeshIntTool::computeIntersection(TCapsule<sofa::defaulttype::Vec3Types>& cap, Line& lin,SReal alarmDist,SReal contactDist,OutputVector* contacts);
extern template COLLISIONOBB_API int MeshIntTool::doCapLineInt(TCapsule<sofa::defaulttype::Vec3Types>& cap,const sofa::type::Vector3 & q1,const sofa::type::Vector3 & q2,SReal alarmDist,SReal contactDist,OutputVector* contacts,bool ignore_p1,bool ignore_p2);
extern template COLLISIONOBB_API int MeshIntTool::computeIntersection(TCapsule<sofa::defaulttype::Vec3Types>& cap, Triangle& tri,SReal alarmDist,SReal contactDist,OutputVector* contacts);

extern template COLLISIONOBB_API int MeshIntTool::computeIntersection(TCapsule<sofa::defaulttype::Rigid3Types>& cap, Point& pnt,SReal alarmDist,SReal contactDist,OutputVector* contacts);
extern template COLLISIONOBB_API int MeshIntTool::doCapPointInt(TCapsule<sofa::defaulttype::Rigid3Types>& cap, const sofa::type::Vector3& q,SReal alarmDist,SReal contactDist,OutputVector* contacts);
extern template COLLISIONOBB_API int MeshIntTool::computeIntersection(TCapsule<sofa::defaulttype::Rigid3Types>& cap, Line& lin,SReal alarmDist,SReal contactDist,OutputVector* contacts);
extern template COLLISIONOBB_API int MeshIntTool::doCapLineInt(TCapsule<sofa::defaulttype::Rigid3Types>& cap,const sofa::type::Vector3 & q1,const sofa::type::Vector3 & q2,SReal alarmDist,SReal contactDist,OutputVector* contacts,bool ignore_p1,bool ignore_p2);
extern template COLLISIONOBB_API int MeshIntTool::computeIntersection(TCapsule<sofa::defaulttype::Rigid3Types>& cap, Triangle& tri,SReal alarmDist,SReal contactDist,OutputVector* contacts);
#endif
