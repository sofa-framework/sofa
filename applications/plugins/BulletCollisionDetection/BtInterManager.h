...
//template <>
//void correctContactPoint0<BulletConvexHullModel>(SReal margin,sofa::core::collision::DetectionOutput & dec_out){
//    std::cout<<"margin "<<margin<<std::endl;
//    dec_out.point[0] -= dec_out.normal * margin;
//}

//template <>
//void correctContactPoint1<BulletConvexHullModel>(SReal margin,sofa::core::collision::DetectionOutput & dec_out){
//    std::cout<<"margin "<<margin<<std::endl;
//    dec_out.point[1] += dec_out.normal * margin;
//}

//template <>
//void correctContactPoint1<BulletOBBModel>(SReal margin,sofa::core::collision::DetectionOutput & dec_out){
//    dec_out.point[1] += dec_out.normal * margin;
//}

//template <>
//void correctContactPoint0<BulletOBBModel>(SReal margin,sofa::core::collision::DetectionOutput & dec_out){
//    dec_out.point[0] -= dec_out.normal * margin;
//}


//template <>
//void correctContactPoint0<BulletCapsuleModel>(SReal margin,sofa::core::collision::DetectionOutput & dec_out){
//}

//template <>
//void correctContactPoint1<BulletCapsuleModel>(SReal margin,sofa::core::collision::DetectionOutput & dec_out){
//}
...
//template <class I>//CModel1 and CModel2 are CollisionModels inheriting from BulletCollisionModel
//class BtMemberInterManager<BulletOBBModel,BulletOBBModel,I> : public BtInterManager<I>{
//public:
//    virtual void fillContacts(core::CollisionModel * cm1_base, core::CollisionModel * cm2_base,const btPersistentManifold & contPts,I & intersectionMethod,
//                              sofa::core::collision::DetectionOutputVector *& contacts,bool swapContPts = false)const{
//        BulletOBBModel * cm1 = static_cast<BulletOBBModel*>(cm1_base);
//        BulletOBBModel * cm2 = static_cast<BulletOBBModel*>(cm2_base);
...
//        sofa::core::collision::TDetectionOutputVector<BulletOBBModel,BulletOBBModel>& cast_contacts = *(static_cast<sofa::core::collision::TDetectionOutputVector<BulletOBBModel,BulletOBBModel>*>(contacts));
...
//            for(int j = 0 ; j < contPts.getNumContacts() ; ++j){
//                const btManifoldPoint& manpt = contPts.getContactPoint(j);
//                BulletOBBModel::Element e1(cm1,manpt.m_index1);
//                BulletOBBModel::Element e2(cm2,manpt.m_index0);
...
//                sofa::core::collision::DetectionOutput & dec_out = cast_contacts[i];
//                dec_out.id = getId(e1,e2);
//                dec_out.elem = std::pair<BulletOBBModel::Element,BulletOBBModel::Element>(e1,e2);
...
////                btVector3 pointA(manpt.getPositionWorldOnA());
////                pointA += manpt.
////                manpt.getPositionWorldOnA()

//                dec_out.point[1].set(manpt.m_localPointA[0],manpt.m_localPointA[1],manpt.m_localPointA[2]);
//                dec_out.value = fabs(manpt.m_distance1) - intersectionMethod.getContactDistance();
//                dec_out.normal.set(manpt.m_normalWorldOnB[0],manpt.m_normalWorldOnB[1],manpt.m_normalWorldOnB[2]);
//                //dec_out.point[0] = dec_out.point[1] - dec_out.value * dec_out.normal;
//                dec_out.point[0].set(manpt.m_localPointB[0],manpt.m_localPointB[1],manpt.m_localPointB[2]);

////                dec_out.point[0] = e1.generalCoordinates(dec_out.point[0]);
////                dec_out.point[1] = e2.generalCoordinates(dec_out.point[1]);
...
//        for(int j = 0 ; j < contPts.getNumContacts() ; ++j){
//            const btManifoldPoint& manpt = contPts.getContactPoint(j);
//            BulletOBBModel::Element e1(cm1,manpt.m_index0);
//            BulletOBBModel::Element e2(cm2,manpt.m_index1);
...
//            //dec_out.point[1].set(manpt.m_localPointB[0],manpt.m_localPointB[1],manpt.m_localPointB[2]);
//            dec_out.point[1].set(manpt.m_positionWorldOnB[0],manpt.m_positionWorldOnB[1],manpt.m_positionWorldOnB[2]);
//            dec_out.value = fabs(manpt.m_distance1) - intersectionMethod.getContactDistance();;
//            //std::cout<<"dist "<<manpt.m_distance1<<std::endl;
//            dec_out.normal.set(-manpt.m_normalWorldOnB[0],-manpt.m_normalWorldOnB[1],-manpt.m_normalWorldOnB[2]);
...
//template <class I>//CModel1 and CModel2 are CollisionModels inheriting from BulletCollisionModel
//class BtMemberInterManager<BulletConvexHullModel,BulletConvexHullModel,I> : public BtInterManager<I>{
//public:
//    virtual void fillContacts(core::CollisionModel * cm1_base, core::CollisionModel * cm2_base,const btPersistentManifold & contPts,I & intersectionMethod,
//                              sofa::core::collision::DetectionOutputVector *& contacts,bool swapContPts = false)const{
//        static int _id = 0;
...
//        BulletConvexHullModel * cm1 = static_cast<BulletConvexHullModel*>(cm1_base);
//        BulletConvexHullModel * cm2 = static_cast<BulletConvexHullModel*>(cm2_base);
...
//        sofa::core::collision::TDetectionOutputVector<BulletConvexHullModel,BulletConvexHullModel>& cast_contacts = *(static_cast<sofa::core::collision::TDetectionOutputVector<BulletConvexHullModel,BulletConvexHullModel>*>(contacts));
...
//            for(int j = 0 ; j < contPts.getNumContacts() ; ++j){
//                const btManifoldPoint& manpt = contPts.getContactPoint(j);
////                typename BulletConvexHullModel::Element e1(cm1,0);
////                typename BulletConvexHullModel::Element e2(cm2,0);
//                typename BulletConvexHullModel::Element e1(cm1,manpt.m_index1);
//                typename BulletConvexHullModel::Element e2(cm2,manpt.m_index0);
////                typename CModel1::Element e1(cm1,manpt);
////                typename CModel2::Element e2(cm2,manpt.m_index0);

//                sofa::core::collision::DetectionOutput & dec_out = cast_contacts[i];
//                dec_out.id = _id;//getId(e1,e2);
//                dec_out.elem = std::pair<BulletConvexHullModel::Element,BulletConvexHullModel::Element>(e1,e2);
//                //manpt.M
////                std::cout<<"world 1 "<<std::endl;
////                display(manpt.m_positionWorldOnA);
////                std::cout<<"world 2 "<<std::endl;
...
//                dec_out.point[0] -= dec_out.normal * cm1->getBtCollisionObject()->getCollisionShape()->getMargin();
//                dec_out.point[1] += dec_out.normal * cm2->getBtCollisionObject()->getCollisionShape()->getMargin();
...
////            typename BulletConvexHullModel::Element e1(cm1,0);
////            typename BulletConvexHullModel::Element e2(cm2,0);
//            typename BulletConvexHullModel::Element e1(cm1,manpt.m_index0);
//            typename BulletConvexHullModel::Element e2(cm2,manpt.m_index1);

//            sofa::core::collision::DetectionOutput & dec_out = cast_contacts[i];
//            dec_out.id = _id;//getId(e1,e2);

//            std::cout<<"======the famous id===== "<<dec_out.id<<std::endl;
//            dec_out.elem = std::pair<BulletConvexHullModel::Element,BulletConvexHullModel::Element>(e1,e2);
////            std::cout<<"world 1 "<<std::endl;
////            display(manpt.m_positionWorldOnA);
////            std::cout<<"world 2 "<<std::endl;
...
//            dec_out.value = (dec_out.point[0] - dec_out.point[1]).norm() - intersectionMethod.getContactDistance();
//            std::cout<<"value distance "<<dec_out.value<<std::endl;
////            std::cout<<cm1->name.getValue()<<" infos"<<std::endl;
//            std::cout<<"point 0"<<std::endl;
//            display(dec_out.point[0]);
////            std::cout<<cm2->name.getValue()<<" infos"<<std::endl;
...
//class BtIntersectorMap {
//    typedef std::map<std::pair<helper::TypeInfo, helper::TypeInfo>, BtElementIntersector*> InternalMap;
