...
static PyObject * _Compliant_getLambda(PyObject * /*self*/, PyObject * args)
{
    ...
    CompliantImplicitSolver* solver = get_arg<CompliantImplicitSolver>( pySolver);
    if (!solver)
    {
    ...
    BaseMechanicalState* mstate = get_arg<BaseMechanicalState>( pyState );
    if (!mstate)
    {
...
static PyObject * _Compliant_propagateLambdas(PyObject * /*self*/, PyObject * args)
{
    ...
    BaseContext* context = get_arg<BaseContext>( pyNode );
    if (!context)
    {
