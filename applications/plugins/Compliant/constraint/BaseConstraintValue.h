...
class SOFA_Compliant_API BaseConstraintValue : public core::objectmodel::BaseObject
{
  ...
  public:
    ...
    /// @param n nb constraint blocks
    /// @param dim nb lines per constraint
    virtual void filterConstraints( type::vector<bool>*& /*activateMask*/, const core::MultiVecCoordId& /*posId*/, unsigned /*n*/, unsigned /*dim*/ ) { /*all constraints are active by default*/ }
