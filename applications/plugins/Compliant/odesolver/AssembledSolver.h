...
protected:
    ...
    /// temporary multivecs
    core::behavior::MultiVecDeriv _fk; ///< the forces generated by stiffnesses
    core::behavior::MultiVecDeriv _fc; ///< the forces generated by compliances // note that we do not need fc explicitly but the visitor computing the forces would be more complicated
