        ...
        sofa::type::Vec<6,SReal> includedBox)
{
    ...
    component::integrationscheme::backward::EulerImplicitIntegrationScheme::SPtr solver = modeling::addNew<component::odesolver::backward::EulerImplicitIntegrationScheme>(SquareNode,"EulerImplicitIntegrationScheme");
