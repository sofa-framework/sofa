...
//    struct DataTypeInfo< sofa::defaulttype::StdAffine<N, real>::Coord > : public FixedArrayTypeInfo< sofa::defaulttype::AffineCoord<N, real>, sofa::defaulttype::StdAffine<N, real>::Coord::total_size >
//      {
