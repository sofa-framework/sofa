...
public:
    ...
    typedef typename DeformationGradientType::Deriv DeformationGradientDeriv;
...
//                cerr<<"static StrainVec getStrainVec, f = "<< f << endl;
    ...
    static void apply( const DeformationGradient& F, Strain& strain, MaterialFrame* rotation=NULL)
    ...
    static void mult( const DeformationGradientDeriv& F, StrainDeriv& strain , const MaterialFrame* rotation=NULL)
    ...
    static void addMultTranspose( DeformationGradientDeriv& dF , const DeformationGradient& F, const StrainDeriv& s, const StrainEnergyVec& integ, const MaterialFrame* rotation=NULL)
