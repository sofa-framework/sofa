...
******************************************************************************/
#ifndef FLEXIBLE_PrincipalStrechesJacobianBlock_H
#define FLEXIBLE_PrincipalStrechesJacobianBlock_H
...
#define U221(type)  PrincipalStrechesStrainTypes<2,2,0,type>
#define U331(type)  PrincipalStrechesStrainTypes<3,3,0,type>
...
/** Template class used to implement one jacobian block for PrincipalStrechesMapping */
template<class TIn, class TOut>
class PrincipalStrechesJacobianBlock : public BaseJacobianBlock<TIn,TOut>
{
public:
    ...
    */
    ...
    {
        result.getStrain() += computeSVD( data.getF(), _U, _V );
...
#endif // FLEXIBLE_PrincipalStrechesJacobianBlock_H
