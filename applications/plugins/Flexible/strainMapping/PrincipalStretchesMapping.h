...
//    Data<bool> f_SSPDStabilization;
    ...
    virtual void reinit()
    {
        ...
        {
            this->jacobian[i].init( asStrain.getValue(), threshold.getValue()/*, f_SSPDStabilization.getValue()*/ );
        }
        Inherit::reinit();
    }
...
//        , f_SSPDStabilization(initData(&f_SSPDStabilization,false,"SSPDStabilization","project geometric stiffness sub-matrices to their nearest symetric semi-positive definite matrices"))
    {
    }
