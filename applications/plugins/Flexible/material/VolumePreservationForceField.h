...
public:
    ...
    virtual SReal getPotentialEnergy( const core::MechanicalParams* /*mparams*/, const typename Inherit::DataVecCoord& x ) const override
    {
        SReal e = 0;
...
protected:
    ...
    virtual void addForce(const core::MechanicalParams* /*mparams*/, typename Inherit::DataVecDeriv& _f , const typename Inherit::DataVecCoord& _x , const typename Inherit::DataVecDeriv& _v) override
    {
