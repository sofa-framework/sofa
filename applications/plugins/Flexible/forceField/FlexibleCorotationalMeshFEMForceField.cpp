...
******************************************************************************/
#define __FlexibleCorotationalMeshFEMForceField_CPP
...
SOFA_DECL_CLASS(FlexibleCorotationalMeshFEMForceField)
...
template class SOFA_Flexible_API FlexibleCorotationalMeshFEMForceField< Vec3Types >;
