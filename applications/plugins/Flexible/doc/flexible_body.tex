...
\begin{abstract}
This plugin provides a unified approach to the simulation of deformable solids using a three-level kinematic structure: control nodes, deformation gradients, strains, and new mappings between these.
...
\section{Three-level Continuum Mechanics}
