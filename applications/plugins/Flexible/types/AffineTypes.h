...
public:
    ...
    static const size_type VSize = spatial_dimensions +  spatial_dimensions * spatial_dimensions;  // number of entries
        ...
        void setRigid(const Coord& c, unsigned method = 0 )
        {
            switch( method )
            {
                ...
                case 2: // approximation
                {
                    ...
                    for(size_type i=0; i<spatial_dimensions; i++) W[i][i] = 0.0;
                    for(size_type i=0; i<spatial_dimensions; i++)
                    {
