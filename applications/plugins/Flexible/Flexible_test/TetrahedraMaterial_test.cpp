...
struct TetrahedraMaterial_test : public Sofa_test<typename Vec3Types::Real>
{
    ...
    typedef HookeForceFieldSPtr (TetrahedraMaterial_test<DataTypes>::*LinearElasticityFF)(simulation::NodeSPtr,double,double,double);
    ...
    { 
       ...
       // Get child nodes
       simulation::NodeSPtr triangleNode = tractionStruct.root->getChild("Triangles");
