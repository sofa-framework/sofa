...
#include <Flexible/deformationMapping/SurfaceMapping.h>
...
using mapping::SurfaceMapping;


/**  Test suite for SurfaceMapping.
  */
template <typename _TestedMapping>
struct SurfaceMappingTest : public Mapping_test<_TestedMapping>
{
    ...
    bool test( )
    {
        ...
        SReal expectedSurface = (3.+sqrt(3)) / 2.;
        for(int i=0; i<Nout; i++ )
            expectedChildCoords[i] = expectedSurface;
...
using testing::Types;
typedef Types<
SurfaceMapping<defaulttype::Vec3Types,defaulttype::Vec1Types>
> DataTypes; // the types to instanciate.

// Test suite for all the instanciations
TYPED_TEST_CASE(SurfaceMappingTest, DataTypes);

TYPED_TEST( SurfaceMappingTest, test_auto )
{
