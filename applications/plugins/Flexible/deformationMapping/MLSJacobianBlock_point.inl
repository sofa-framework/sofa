...
public:
    ...
    enum { bdim = MLSInfo<InCoord>::bdim };
    ...
    void init( const InCoord& InPos, const OutCoord& /*OutPos*/, const SpatialCoord& SPos, const MaterialToSpatial& /*M*/, const Real& w, const Gradient& /*dw*/, const Hessian& /*ddw*/, const  MatSym<bdim,Real>& MomentInv, const Vec<dim, MatSym<bdim,Real> >& /*dMoment*/)
    {
        Pt = w * dot(MLSInfo<InCoord>::getBasis(InPos), MomentInv*MLSInfo<InCoord>::getBasis(SPos));
        C=(SPos-InPos)*Pt;
    }
