...
******************************************************************************/
#ifndef SOFA_COMPONENT_MAPPING_JointRigidMapping_H
#define SOFA_COMPONENT_MAPPING_JointRigidMapping_H
...
class JointRigidMappingInternalData
{
public:
};
...
class SOFA_Flexible_API JointRigidMapping : public core::Mapping<TIn, TOut>
{
public:
    SOFA_CLASS(SOFA_TEMPLATE2(JointRigidMapping,TIn,TOut), SOFA_TEMPLATE2(core::Mapping,TIn,TOut));
...
protected:
    JointRigidMapping();
    virtual ~JointRigidMapping();

    SparseMatrixEigen jacobian;                           ///< Jacobian of the mapping
    vector< defaulttype::BaseMatrix* > baseMatrices;      ///< Jacobian of the mapping, in a vector

    // source index, rigid offset
    typedef std::pair<unsigned int, InCoord> source_type;
...
#if defined(SOFA_EXTERN_TEMPLATE) && !defined(SOFA_COMPONENT_MAPPING_JointRigidMapping_CPP)
#ifndef SOFA_FLOAT
extern template class SOFA_RIGID_API JointRigidMapping< Rigid3dTypes, Rigid3dTypes >;
#endif
#ifndef SOFA_DOUBLE
extern template class SOFA_RIGID_API JointRigidMapping< Rigid3fTypes, Rigid3fTypes >;
#endif
