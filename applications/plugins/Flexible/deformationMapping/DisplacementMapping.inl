...
******************************************************************************/
#ifndef SOFA_COMPONENT_MAPPING_DisplacementMapping_INL
#define SOFA_COMPONENT_MAPPING_DisplacementMapping_INL

#include "../deformationMapping/DisplacementMapping.h"
...
template <class TIn, class TOut>
void DisplacementMapping<TIn, TOut>::init()
{
...
template <class TIn, class TOut>
void DisplacementMapping<TIn, TOut>::apply(const core::MechanicalParams * /*mparams*/ , Data<OutVecCoord>& dOut, const Data<InVecCoord>& dIn)
{
    ...
    assert(  Nout == Nin  );
    assert( in.size() >= reference.getValue().size() );
...
template <class TIn, class TOut>
void DisplacementMapping<TIn, TOut>::applyJ(const core::MechanicalParams * /*mparams*/ , Data<OutVecDeriv>& dOut, const Data<InVecDeriv>& dIn)
{
...
template <class TIn, class TOut>
void DisplacementMapping<TIn, TOut>::applyJT(const core::MechanicalParams * /*mparams*/ , Data<InVecDeriv>& dIn, const Data<OutVecDeriv>& dOut)
{
    if( jacobian.rowSize() > 0 )
...
template <class TIn, class TOut>
void DisplacementMapping<TIn, TOut>::applyJT(const core::ConstraintParams*, Data<InMatrixDeriv>& , const Data<OutMatrixDeriv>& )
{
    //    cerr<<"DisplacementMapping<TIn, TOut>::applyJT does nothing " << endl;
}


template <class TIn, class TOut>
const sofa::defaulttype::BaseMatrix* DisplacementMapping<TIn, TOut>::getJ()
{
    return &jacobian;
}

template <class TIn, class TOut>
const vector<sofa::defaulttype::BaseMatrix*>* DisplacementMapping<TIn, TOut>::getJs()
{
    return &baseMatrices;
}
