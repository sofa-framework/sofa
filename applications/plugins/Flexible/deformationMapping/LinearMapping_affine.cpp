...
template class SOFA_Flexible_API BaseDeformationMappingT< defaulttype::LinearJacobianBlock< Affine3Types, Vec3Types > >;
template class SOFA_Flexible_API BaseDeformationMappingT< defaulttype::LinearJacobianBlock< Affine3Types, ExtVec3fTypes > >;
template class SOFA_Flexible_API BaseDeformationMappingT< defaulttype::LinearJacobianBlock< Affine3Types, F331Types > >;
template class SOFA_Flexible_API BaseDeformationMappingT< defaulttype::LinearJacobianBlock< Affine3Types, F332Types > >;
template class SOFA_Flexible_API BaseDeformationMappingT< defaulttype::LinearJacobianBlock< Affine3Types, F321Types > >;
template class SOFA_Flexible_API BaseDeformationMappingT< defaulttype::LinearJacobianBlock< Affine3Types, F311Types > >;
template class SOFA_Flexible_API BaseDeformationMappingT< defaulttype::LinearJacobianBlock< Affine3Types, Affine3Types > >;
