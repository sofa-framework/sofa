...
struct SOFA_SOFAPYTHON_API Python_test_data
{
...
void SOFA_SOFAPYTHON_API PrintTo(const sofa::Python_test_data& d, ::std::ostream* os);

/// utility to build a static list of Python_test_data
struct SOFA_SOFAPYTHON_API Python_test_list
{
...
class SOFA_SOFAPYTHON_API Python_test : public ::testing::TestWithParam<Python_test_data> {
...
class SOFA_SOFAPYTHON_API Python_scene_test : public Python_test {
