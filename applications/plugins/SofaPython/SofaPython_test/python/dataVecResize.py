...
class VerifController(SofaTest.Controller):
    ...
    def onEndAnimationStep(self, dt):
        ...
        # non resizable boolean Data

        self.fc.fixAll = True
        self.fc.fixAll = ""
        self.ASSERT(self.fc.fixAll == True, "test14")


        # non resizable scalar Data

        self.dof.showObjectScale = 9
        self.dof.showObjectScale = ""
        self.ASSERT(self.dof.showObjectScale == 9, "test15")
