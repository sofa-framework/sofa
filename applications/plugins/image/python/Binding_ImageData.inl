...
extern "C" PyObject * EVALUATOR(BOUNDNAME,getPtrs)(PyObject * self, PyObject * /*args*/)
{
    ...
    PyTuple_SetItem( shape, 0, PyLong_FromSsize_t( dim[3] ) ); // x
    PyTuple_SetItem( shape, 1, PyLong_FromSsize_t( dim[2] ) ); // y
    PyTuple_SetItem( shape, 2, PyLong_FromSsize_t( dim[1] ) ); // z
    PyTuple_SetItem( shape, 3, PyLong_FromSsize_t( dim[0] ) ); // s
