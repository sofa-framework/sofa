...
extern "C" {
    ...
    bool SOFACUDA_CORE_API CudaSortGPUAvailable(unsigned int size, bool withData = true);
    bool SOFACUDA_CORE_API CudaSortGPU(void* keys, void* data, unsigned int size, int bits);
