...
extern "C"
{
    void SOFACUDA_CORE_API copy_vectorf(int dim,const void * a, void * b);
    void SOFACUDA_CORE_API vector_vector_peqf(int dim,float f,const void * a,void * b);
    void SOFACUDA_CORE_API sub_vector_vectorf(int dim,const void * a, const void * b, void * r);
    void SOFACUDA_CORE_API permute_vectorf(int dim,const void * a, const void * perm, void * b);

#ifdef SOFA_GPU_CUDA_DOUBLE
    void SOFACUDA_CORE_API copy_vectord(int dim,const void * a, void * b);
    void SOFACUDA_CORE_API vector_vector_peqd(int dim,double f,const void * a,void * b);
    void SOFACUDA_CORE_API sub_vector_vectord(int dim,const void * a, const void * b, void * r);
    void SOFACUDA_CORE_API permute_vectord(int dim,const void * a, const void * perm, void * b);
#endif
}
...
extern template class SOFACUDA_CORE_API CudaBaseVector< float >;
#ifdef SOFA_GPU_CUDA_DOUBLE
extern template class SOFACUDA_CORE_API CudaBaseVector< double >;
#endif
