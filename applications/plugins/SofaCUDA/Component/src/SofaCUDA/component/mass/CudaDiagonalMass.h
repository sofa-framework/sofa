...
extern template class SOFACUDA_COMPONENT_API component::mass::DiagonalMass<CudaVec3fTypes>;
#ifdef SOFA_GPU_CUDA_DOUBLE
extern template class SOFACUDA_COMPONENT_API component::mass::DiagonalMass<CudaVec3dTypes>;
#endif
#endif
