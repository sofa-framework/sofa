...
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec3fTypes>;
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec2fTypes>;
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec2fTypes, sofa::gpu::cuda::CudaVec3fTypes>;
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1fTypes>;
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1fTypes, sofa::gpu::cuda::CudaVec2fTypes>;
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1fTypes, sofa::gpu::cuda::CudaVec3fTypes>;

#ifdef SOFA_GPU_CUDA_DOUBLE
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec3dTypes>;
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec2dTypes>;
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec2dTypes, sofa::gpu::cuda::CudaVec3dTypes>;
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1dTypes>;
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1dTypes, sofa::gpu::cuda::CudaVec2dTypes>;
extern template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1dTypes, sofa::gpu::cuda::CudaVec3dTypes>;
