...
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec3fTypes>;
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec2fTypes>;
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec2fTypes, sofa::gpu::cuda::CudaVec3fTypes>;
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1fTypes>;
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1fTypes, sofa::gpu::cuda::CudaVec2fTypes>;
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1fTypes, sofa::gpu::cuda::CudaVec3fTypes>;

#ifdef SOFA_GPU_CUDA_DOUBLE
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec3dTypes>;
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec2dTypes>;
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec2dTypes, sofa::gpu::cuda::CudaVec3dTypes>;
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1dTypes>;
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1dTypes, sofa::gpu::cuda::CudaVec2dTypes>;
template class SOFACUDA_COMPONENT_API MeshMatrixMass<sofa::gpu::cuda::CudaVec1dTypes, sofa::gpu::cuda::CudaVec3dTypes>;
