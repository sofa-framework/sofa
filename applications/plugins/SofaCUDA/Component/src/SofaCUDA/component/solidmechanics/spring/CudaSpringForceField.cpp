...
template class SOFACUDA_COMPONENT_API PairInteractionForceField<sofa::gpu::cuda::CudaVec3fTypes>;
template class SOFACUDA_COMPONENT_API PairInteractionForceField<sofa::gpu::cuda::CudaVec3f1Types>;

#ifdef SOFA_GPU_CUDA_DOUBLE
template class SOFACUDA_COMPONENT_API PairInteractionForceField<sofa::gpu::cuda::CudaVec3dTypes>;
template class SOFACUDA_COMPONENT_API PairInteractionForceField<sofa::gpu::cuda::CudaVec3d1Types>;
...
template class SOFACUDA_COMPONENT_API SpringForceField<sofa::gpu::cuda::CudaVec3fTypes>;
template class SOFACUDA_COMPONENT_API MeshSpringForceField<sofa::gpu::cuda::CudaVec3fTypes>;

template class SOFACUDA_COMPONENT_API SpringForceField<sofa::gpu::cuda::CudaVec3f1Types>;
template class SOFACUDA_COMPONENT_API MeshSpringForceField<sofa::gpu::cuda::CudaVec3f1Types>;


#ifdef SOFA_GPU_CUDA_DOUBLE
template class SOFACUDA_COMPONENT_API SpringForceField<sofa::gpu::cuda::CudaVec3dTypes>;
template class SOFACUDA_COMPONENT_API MeshSpringForceField<sofa::gpu::cuda::CudaVec3dTypes>;

template class SOFACUDA_COMPONENT_API SpringForceField<sofa::gpu::cuda::CudaVec3d1Types>;
template class SOFACUDA_COMPONENT_API MeshSpringForceField<sofa::gpu::cuda::CudaVec3d1Types>;
#endif // SOFA_GPU_CUDA_DOUBLE
