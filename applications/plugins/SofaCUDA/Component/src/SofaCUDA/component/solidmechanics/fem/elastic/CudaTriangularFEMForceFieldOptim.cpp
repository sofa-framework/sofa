...
template class SOFACUDA_COMPONENT_API TriangularFEMForceFieldOptim<sofa::gpu::cuda::CudaVec3fTypes>;
#ifdef SOFA_GPU_CUDA_DOUBLE
template class SOFACUDA_COMPONENT_API TriangularFEMForceFieldOptim<sofa::gpu::cuda::CudaVec3dTypes>;
