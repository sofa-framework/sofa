...
template class SOFACUDA_COMPONENT_API UncoupledConstraintCorrection< CudaVec3fTypes >;
template class SOFACUDA_COMPONENT_API UncoupledConstraintCorrection< CudaVec3f1Types >;

#ifdef SOFA_GPU_CUDA_DOUBLE
template class SOFACUDA_COMPONENT_API UncoupledConstraintCorrection< CudaVec3dTypes >;
template class SOFACUDA_COMPONENT_API UncoupledConstraintCorrection< CudaVec3d1Types >;
#endif
