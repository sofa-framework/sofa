...
// CudaVec3fTypes
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< CudaVec3fTypes, CudaVec3fTypes>;
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< CudaVec3fTypes, CudaVec3f1Types>;
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< CudaVec3fTypes, Vec3Types>;
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< Vec3Types, CudaVec3fTypes>;

// CudaVec3f1Types
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< CudaVec3f1Types, CudaVec3f1Types>;
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< CudaVec3f1Types, CudaVec3fTypes>;
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< CudaVec3f1Types, Vec3Types>;
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< Vec3dTypes, CudaVec3f1Types>;


#ifdef SOFA_GPU_CUDA_DOUBLE
// CudaVec3dTypes
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< CudaVec3dTypes, CudaVec3dTypes>;
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< CudaVec3dTypes, CudaVec3fTypes>;
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< CudaVec3dTypes, Vec3Types>;

extern template class SOFACUDA_COMPONENT_API  IdentityMapping< CudaVec3fTypes, CudaVec3dTypes>;
extern template class SOFACUDA_COMPONENT_API  IdentityMapping< Vec3Types, CudaVec3dTypes>;
