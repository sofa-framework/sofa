...
namespace sofa::component::mapping::linear
{
    ...
    template class SOFACUDA_COMPONENT_API SubsetMultiMapping< CudaVec3Types, CudaVec3Types >;
    template class SOFACUDA_COMPONENT_API SubsetMultiMapping< CudaVec1Types, CudaVec1Types >;
    template class SOFACUDA_COMPONENT_API SubsetMultiMapping< CudaRigid3Types, CudaRigid3Types >;
    template class SOFACUDA_COMPONENT_API SubsetMultiMapping< CudaRigid3Types, CudaVec3Types >;

#ifdef SOFA_GPU_CUDA_DOUBLE
    template class SOFACUDA_COMPONENT_API SubsetMultiMapping< CudaVec3dTypes, CudaVec3dTypes >;
    template class SOFACUDA_COMPONENT_API SubsetMultiMapping< CudaVec1dTypes, CudaVec1dTypes >;
    template class SOFACUDA_COMPONENT_API SubsetMultiMapping< CudaRigid3dTypes, CudaRigid3dTypes >;
    template class SOFACUDA_COMPONENT_API SubsetMultiMapping< CudaRigid3dTypes, CudaVec3dTypes >;
#endif
