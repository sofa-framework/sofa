...
template class SOFACUDA_COMPONENT_API NearestPointROI<gpu::cuda::CudaVec3fTypes>;
template class SOFACUDA_COMPONENT_API NearestPointROI<gpu::cuda::CudaVec3f1Types>;
#ifdef SOFA_GPU_CUDA_DOUBLE
template class SOFACUDA_COMPONENT_API NearestPointROI<gpu::cuda::CudaVec3dTypes>;
template class SOFACUDA_COMPONENT_API NearestPointROI<gpu::cuda::CudaVec3d1Types>;
