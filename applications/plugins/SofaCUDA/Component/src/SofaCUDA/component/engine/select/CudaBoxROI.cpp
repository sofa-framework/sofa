...
{
template class SOFACUDA_COMPONENT_API boxroi::BoxROI<gpu::cuda::CudaVec2fTypes>;
template class SOFACUDA_COMPONENT_API boxroi::BoxROI<gpu::cuda::CudaVec3fTypes>;
template class SOFACUDA_COMPONENT_API boxroi::BoxROI<gpu::cuda::CudaVec3f1Types>;
template class SOFACUDA_COMPONENT_API boxroi::BoxROI<gpu::cuda::CudaRigid3fTypes>;
#ifdef SOFA_GPU_CUDA_DOUBLE
template class SOFACUDA_COMPONENT_API boxroi::BoxROI<gpu::cuda::CudaVec2dTypes>;
template class SOFACUDA_COMPONENT_API boxroi::BoxROI<gpu::cuda::CudaVec3dTypes>;
template class SOFACUDA_COMPONENT_API boxroi::BoxROI<gpu::cuda::CudaVec3d1Types>;
