...
namespace sofa::component::mechanicalload
{
    ...
    template <> SOFACUDA_COMPONENT_API
    ...
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaVec3Types>;
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaVec2Types>;
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaVec1Types>;
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaVec6Types>;
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaRigid3Types>;
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaRigid2Types>;
    ...
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaVec3dTypes>;
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaVec2dTypes>;
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaVec1dTypes>;
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaVec6dTypes>;
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaRigid3dTypes>;
    template class SOFACUDA_COMPONENT_API ConstantForceField<CudaRigid2dTypes>;
#endif
} // namespace sofa::component::mechanicalload
