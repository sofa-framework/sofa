...
public:
    ...
    //static void getNodeRotations(Main* m, sofa::gpu::cuda::CudaRotationMatrix<TReal> * diag, int offset);
};
...
#define CudaHexahedronFEMForceField_DeclMethods(T) \
    ...
    template<> void HexahedronFEMForceField< T >::getRotations(defaulttype::BaseMatrix* rotations, int offset); \
