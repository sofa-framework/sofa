...
#include "CudaTriangularFEMForceField.h"
...
extern "C"
{
void TriangularFEMForceFieldCuda3f_addForce(unsigned int size, void* f, const void* x, const void* v,
    void* triangleState, const void* triangleInfo,
    unsigned int nbTriangles,
    const void* gpuTriangleInfo,
    float gamma, float mu);

void TriangularFEMForceFieldCuda3f_addDForce(unsigned int size, void* f, const void* dx, float kFactor,
...
template <>
void TriangularFEMForceField<gpu::cuda::CudaVec3fTypes>::addForce(const core::MechanicalParams* /*mparams*/, DataVecDeriv& d_f, const DataVecCoord& d_x, const DataVecDeriv& d_v)
{
    ...
    //TriangularFEMForceFieldCuda3f_addForce(x.size(), f.deviceWrite(), x.deviceRead(), v.deviceRead(),
...
void TriangularFEMForceField<gpu::cuda::CudaVec3fTypes>::addDForce(const core::MechanicalParams* mparams, DataVecDeriv& d_df, const DataVecDeriv& d_dx)
{
    ...
    //TriangularFEMForceFieldCuda3f_addDForce(dx.size(), df.deviceWrite(), dx.deviceRead(), kFactor,
    //    triState.deviceRead(), 
    //    triInfo.deviceRead(), 
    //    nbTriangles,
    //    gpuTriangleInfo.deviceRead(),
