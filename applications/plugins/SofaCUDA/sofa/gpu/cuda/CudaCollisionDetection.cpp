...
CudaCollisionDetection::Test* CudaCollisionDetection::createTest(core::CollisionModel* model1, core::CollisionModel* model2)
{
    if (CudaRigidDistanceGridCollisionModel* rigid1 = dynamic_cast<CudaRigidDistanceGridCollisionModel*>(model1))
    {
        ...
        else if (SphereCollisionModel<gpu::cuda::CudaVec3Types>* sphere2 = dynamic_cast<SphereCollisionModel<gpu::cuda::CudaVec3Types>*>(model2))
    ...
    else if (SphereCollisionModel<gpu::cuda::CudaVec3Types>* sphere1 = dynamic_cast<SphereCollisionModel<gpu::cuda::CudaVec3Types>*>(model1))
    {
        if (CudaRigidDistanceGridCollisionModel* rigid2 = dynamic_cast<CudaRigidDistanceGridCollisionModel*>(model2))
...
CudaCollisionDetection::SphereRigidTest::SphereRigidTest(SphereCollisionModel<gpu::cuda::CudaVec3Types> *model1, CudaRigidDistanceGridCollisionModel* model2 )
    : model1(model1), model2(model2)
{
