...
template<>
class TDetectionOutputVector<sofa::component::collision::geometry::SphereCollisionModel<gpu::cuda::CudaVec3Types>,sofa::gpu::cuda::CudaRigidDistanceGridCollisionModel> : public GPUDetectionOutputVector
{
};
...
public:
    ...
    {
    public:
        sofa::component::collision::geometry::SphereCollisionModel<gpu::cuda::CudaVec3Types>* model1;
        CudaRigidDistanceGridCollisionModel* model2;
        SphereRigidTest(sofa::component::collision::geometry::SphereCollisionModel<gpu::cuda::CudaVec3Types> *model1, CudaRigidDistanceGridCollisionModel* model2);
        bool useGPU() { return true; }
        /// Returns how many tests are required
        virtual int init();
        /// Fill the info to send to the graphics card
