...
template <>
SReal UniformMass<gpu::cuda::CudaRigid3fTypes,sofa::defaulttype::RigidMass<3,float> >::getElementMass(sofa::index_type) const
{
...
template <>
SReal UniformMass<gpu::cuda::CudaRigid3dTypes,sofa::defaulttype::RigidMass<3,double> >::getElementMass(sofa::index_type) const
{
    return (SReal)(d_vertexMass.getValue().mass);
}
